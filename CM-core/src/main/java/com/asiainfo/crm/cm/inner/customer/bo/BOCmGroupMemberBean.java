...
public class BOCmGroupMemberBean extends DataContainer implements DataContainerInterface,IBOCmGroupMemberValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmGroupMember";
  ...
  public BOCmGroupMemberBean() throws AIException{
      super(S_TYPE);
  }
