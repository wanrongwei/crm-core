...
public class BOCmGsScheduleInfoBean extends DataContainer implements DataContainerInterface,IBOCmGsScheduleInfoValue{

  private static String  m_boName = "com.asiainfo.crm.cm.common.bo.BOCmGsScheduleInfo";
  ...
  public BOCmGsScheduleInfoBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initSchoolAreaCode(String value){
     this.initProperty(S_SchoolAreaCode,value);
  }
  public  void setSchoolAreaCode(String value){
     this.set(S_SchoolAreaCode,value);
  }
  public  void setSchoolAreaCodeNull(){
     this.set(S_SchoolAreaCode,null);
  }

  public String getSchoolAreaCode(){
       return DataType.getAsString(this.get(S_SchoolAreaCode));
  
  }
  public String getSchoolAreaCodeInitialValue(){
        return DataType.getAsString(this.getOldObj(S_SchoolAreaCode));
      }
  ...
  public void initPromoteType(int value){
     this.initProperty(S_PromoteType,new Integer(value));
  }
  public  void setPromoteType(int value){
     this.set(S_PromoteType,new Integer(value));
  }
  public  void setPromoteTypeNull(){
     this.set(S_PromoteType,null);
  }

  public int getPromoteType(){
        return DataType.getAsInt(this.get(S_PromoteType));
  
  }
  public int getPromoteTypeInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_PromoteType));
      }
  ...
  public void initIsFreshman(int value){
     this.initProperty(S_IsFreshman,new Integer(value));
  }
  public  void setIsFreshman(int value){
     this.set(S_IsFreshman,new Integer(value));
  }
  public  void setIsFreshmanNull(){
     this.set(S_IsFreshman,null);
  }

  public int getIsFreshman(){
        return DataType.getAsInt(this.get(S_IsFreshman));
  
  }
  public int getIsFreshmanInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_IsFreshman));
      }

  public void initInstId(long value){
     this.initProperty(S_InstId,new Long(value));
  }
  public  void setInstId(long value){
     this.set(S_InstId,new Long(value));
  }
  public  void setInstIdNull(){
     this.set(S_InstId,null);
  }

  public long getInstId(){
        return DataType.getAsLong(this.get(S_InstId));
  
  }
  public long getInstIdInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_InstId));
      }
