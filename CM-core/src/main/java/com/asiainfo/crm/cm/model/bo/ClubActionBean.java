...
public class ClubActionBean extends DataContainer implements DataContainerInterface,IClubActionValue{

  private static String  m_boName = "com.asiainfo.crm.cm.model.bo.ClubAction";
  ...
  public ClubActionBean() throws AIException{
      super(S_TYPE);
  }
