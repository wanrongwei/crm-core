...
public class BOCmGroupContractBean extends DataContainer implements DataContainerInterface,IBOCmGroupContractValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmGroupContract";
  ...
  public BOCmGroupContractBean() throws AIException{
      super(S_TYPE);
  }
