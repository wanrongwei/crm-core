...
public class BOCmClubBean extends DataContainer implements DataContainerInterface,IBOCmClubValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.club.bo.BOCmClub";
  ...
  public BOCmClubBean() throws AIException{
      super(S_TYPE);
  }
