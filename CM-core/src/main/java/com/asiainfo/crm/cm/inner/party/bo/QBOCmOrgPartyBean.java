...
public class QBOCmOrgPartyBean extends DataContainer implements DataContainerInterface,IQBOCmOrgPartyValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.party.bo.QBOCmOrgParty";
  ...
  public QBOCmOrgPartyBean() throws AIException{
      super(S_TYPE);
  }
