...
public class BOCmPsPublicDealHBean extends DataContainer implements DataContainerInterface,IBOCmPsPublicDealHValue{

  private static String  m_boName = "com.asiainfo.crm.cm.common.bo.BOCmPsPublicDealH";
  ...
  public BOCmPsPublicDealHBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initEntityType(long value){
     this.initProperty(S_EntityType,new Long(value));
  }
  public  void setEntityType(long value){
     this.set(S_EntityType,new Long(value));
  }
  ...
  public long getEntityType(){
        return DataType.getAsLong(this.get(S_EntityType));
  
  }
  public long getEntityTypeInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_EntityType));
      }

  public void initExecAction(long value){
     this.initProperty(S_ExecAction,new Long(value));
  }
  public  void setExecAction(long value){
     this.set(S_ExecAction,new Long(value));
  }
  public  void setExecActionNull(){
     this.set(S_ExecAction,null);
  }

  public long getExecAction(){
        return DataType.getAsLong(this.get(S_ExecAction));
  
  }
  public long getExecActionInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_ExecAction));
      }
