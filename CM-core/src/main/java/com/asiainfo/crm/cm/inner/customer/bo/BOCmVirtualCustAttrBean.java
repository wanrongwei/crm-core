...
public class BOCmVirtualCustAttrBean extends DataContainer implements DataContainerInterface,IBOCmVirtualCustAttrValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmVirtualCustAttr";
  ...
  public BOCmVirtualCustAttrBean() throws AIException{
      super(S_TYPE);
  }
