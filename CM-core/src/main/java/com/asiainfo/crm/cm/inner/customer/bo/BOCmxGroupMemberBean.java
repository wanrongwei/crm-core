...
public class BOCmxGroupMemberBean extends DataContainer implements DataContainerInterface,IBOCmxGroupMemberValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmxGroupMember";
  ...
  public BOCmxGroupMemberBean() throws AIException{
      super(S_TYPE);
  }
