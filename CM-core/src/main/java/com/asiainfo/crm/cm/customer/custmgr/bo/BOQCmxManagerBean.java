...
public class BOQCmxManagerBean extends DataContainer implements DataContainerInterface,IBOQCmxManagerValue{

  private static String  m_boName = "com.asiainfo.crm.customer.custmgr.bo.BOQCmxManager";
  ...
  public BOQCmxManagerBean() throws AIException{
      super(S_TYPE);
  }
