...
public class BOCmGroupManagerBean extends DataContainer implements DataContainerInterface,IBOCmGroupManagerValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmGroupManager";
  ...
  public BOCmGroupManagerBean() throws AIException{
      super(S_TYPE);
  }
