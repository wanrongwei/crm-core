...
public class BOCmPsBusiRecBean extends DataContainer implements DataContainerInterface,IBOCmPsBusiRecValue{

  private static String  m_boName = "com.asiainfo.crm.cm.exe.tf.bo.BOCmPsBusiRec";
  ...
  public BOCmPsBusiRecBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initRelObjectType(String value){
     this.initProperty(S_RelObjectType,value);
  }
  public  void setRelObjectType(String value){
     this.set(S_RelObjectType,value);
  }
  ...
  public String getRelObjectType(){
       return DataType.getAsString(this.get(S_RelObjectType));
  
  }
  public String getRelObjectTypeInitialValue(){
        return DataType.getAsString(this.getOldObj(S_RelObjectType));
      }

  public void initRelObjectDetail(String value){
     this.initProperty(S_RelObjectDetail,value);
  }
  public  void setRelObjectDetail(String value){
     this.set(S_RelObjectDetail,value);
  }
  public  void setRelObjectDetailNull(){
     this.set(S_RelObjectDetail,null);
  }

  public String getRelObjectDetail(){
       return DataType.getAsString(this.get(S_RelObjectDetail));
  
  }
  public String getRelObjectDetailInitialValue(){
        return DataType.getAsString(this.getOldObj(S_RelObjectDetail));
      }
