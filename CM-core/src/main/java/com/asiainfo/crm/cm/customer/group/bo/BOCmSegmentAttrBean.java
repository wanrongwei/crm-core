...
public class BOCmSegmentAttrBean extends DataContainer implements DataContainerInterface,IBOCmSegmentAttrValue{

  private static String  m_boName = "com.asiainfo.crm.cm.customer.group.bo.BOCmSegmentAttr";
  ...
  public BOCmSegmentAttrBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initSegmentAttrType(long value){
     this.initProperty(S_SegmentAttrType,new Long(value));
  }
  public  void setSegmentAttrType(long value){
     this.set(S_SegmentAttrType,new Long(value));
  }
  ...
  public long getSegmentAttrType(){
        return DataType.getAsLong(this.get(S_SegmentAttrType));
  
  }
  public long getSegmentAttrTypeInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_SegmentAttrType));
      }
