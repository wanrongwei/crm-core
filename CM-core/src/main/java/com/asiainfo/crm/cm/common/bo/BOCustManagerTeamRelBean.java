...
public class BOCustManagerTeamRelBean extends DataContainer implements DataContainerInterface,IBOCustManagerTeamRelValue{

  private static String  m_boName = "com.asiainfo.crm.cm.common.bo.BOCustManagerTeamRel";
  ...
  public BOCustManagerTeamRelBean() throws AIException{
      super(S_TYPE);
  }
