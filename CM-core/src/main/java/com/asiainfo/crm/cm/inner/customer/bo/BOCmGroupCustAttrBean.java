...
public class BOCmGroupCustAttrBean extends DataContainer implements DataContainerInterface,IBOCmGroupCustAttrValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmGroupCustAttr";
  ...
  public BOCmGroupCustAttrBean() throws AIException{
      super(S_TYPE);
  }
