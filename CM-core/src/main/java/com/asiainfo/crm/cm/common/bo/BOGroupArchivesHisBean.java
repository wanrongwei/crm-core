...
public class BOGroupArchivesHisBean extends DataContainer implements DataContainerInterface,IBOGroupArchivesHisValue{

  private static String  m_boName = "com.asiainfo.crm.cm.common.bo.BOGroupArchivesHis";
  ...
  public BOGroupArchivesHisBean() throws AIException{
      super(S_TYPE);
  }
