...
public class BOCmxGroupPrepayBlackInfoBean extends DataContainer implements DataContainerInterface,IBOCmxGroupPrepayBlackInfoValue{

  private static String  m_boName = "com.asiainfo.crm.cm.customer.group.bo.BOCmxGroupPrepayBlackInfo";
  ...
  public BOCmxGroupPrepayBlackInfoBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initBlackId(long value){
     this.initProperty(S_BlackId,new Long(value));
  }
  public  void setBlackId(long value){
     this.set(S_BlackId,new Long(value));
  }
  public  void setBlackIdNull(){
     this.set(S_BlackId,null);
  }

  public long getBlackId(){
        return DataType.getAsLong(this.get(S_BlackId));
  
  }
  public long getBlackIdInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_BlackId));
      }
  ...
  public void initBlackDesc(String value){
     this.initProperty(S_BlackDesc,value);
  }
  public  void setBlackDesc(String value){
     this.set(S_BlackDesc,value);
  }
  public  void setBlackDescNull(){
     this.set(S_BlackDesc,null);
  }

  public String getBlackDesc(){
       return DataType.getAsString(this.get(S_BlackDesc));
  
  }
  public String getBlackDescInitialValue(){
        return DataType.getAsString(this.getOldObj(S_BlackDesc));
      }
