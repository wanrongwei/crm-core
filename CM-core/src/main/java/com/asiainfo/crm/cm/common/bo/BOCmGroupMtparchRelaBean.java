...
public class BOCmGroupMtparchRelaBean extends DataContainer implements DataContainerInterface,IBOCmGroupMtparchRelaValue{

  private static String  m_boName = "com.asiainfo.crm.cm.common.bo.BOCmGroupMtparchRela";
  ...
  public BOCmGroupMtparchRelaBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initIsRegionOrg(int value){
     this.initProperty(S_IsRegionOrg,new Integer(value));
  }
  public  void setIsRegionOrg(int value){
     this.set(S_IsRegionOrg,new Integer(value));
  }
  ...
  public int getIsRegionOrg(){
        return DataType.getAsInt(this.get(S_IsRegionOrg));
  
  }
  public int getIsRegionOrgInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_IsRegionOrg));
      }
