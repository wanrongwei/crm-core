...
public class BOCmGroupCustMgrRelBean extends DataContainer implements DataContainerInterface,IBOCmGroupCustMgrRelValue{

  private static String  m_boName = "com.asiainfo.crm.cm.customer.group.bo.BOCmGroupCustMgrRel";
  ...
  public BOCmGroupCustMgrRelBean() throws AIException{
      super(S_TYPE);
  }
