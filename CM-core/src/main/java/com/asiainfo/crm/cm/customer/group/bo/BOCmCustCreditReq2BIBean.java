...
public class BOCmCustCreditReq2BIBean extends DataContainer implements DataContainerInterface,IBOCmCustCreditReq2BIValue{

  private static String  m_boName = "com.asiainfo.crm.cm.customer.group.bo.BOCmCustCreditReq2BI";
  ...
  public BOCmCustCreditReq2BIBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initDealNum(int value){
     this.initProperty(S_DealNum,new Integer(value));
  }
  public  void setDealNum(int value){
     this.set(S_DealNum,new Integer(value));
  }
  public  void setDealNumNull(){
     this.set(S_DealNum,null);
  }

  public int getDealNum(){
        return DataType.getAsInt(this.get(S_DealNum));
  
  }
  public int getDealNumInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_DealNum));
      }
  ...
  public void initDealState(int value){
     this.initProperty(S_DealState,new Integer(value));
  }
  public  void setDealState(int value){
     this.set(S_DealState,new Integer(value));
  }
  public  void setDealStateNull(){
     this.set(S_DealState,null);
  }

  public int getDealState(){
        return DataType.getAsInt(this.get(S_DealState));
  
  }
  public int getDealStateInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_DealState));
      }
  ...
  public void initRequestReasion(String value){
     this.initProperty(S_RequestReasion,value);
  }
  public  void setRequestReasion(String value){
     this.set(S_RequestReasion,value);
  }
  public  void setRequestReasionNull(){
     this.set(S_RequestReasion,null);
  }

  public String getRequestReasion(){
       return DataType.getAsString(this.get(S_RequestReasion));
  
  }
  public String getRequestReasionInitialValue(){
        return DataType.getAsString(this.getOldObj(S_RequestReasion));
      }
  ...
  public void initValidMode(int value){
     this.initProperty(S_ValidMode,new Integer(value));
  }
  public  void setValidMode(int value){
     this.set(S_ValidMode,new Integer(value));
  }
  public  void setValidModeNull(){
     this.set(S_ValidMode,null);
  }

  public int getValidMode(){
        return DataType.getAsInt(this.get(S_ValidMode));
  
  }
  public int getValidModeInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_ValidMode));
      }
