...
public class BOCmSpecialListBean extends DataContainer implements DataContainerInterface,IBOCmSpecialListValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.evaluation.bo.BOCmSpecialList";
  ...
  public BOCmSpecialListBean() throws AIException{
      super(S_TYPE);
  }
