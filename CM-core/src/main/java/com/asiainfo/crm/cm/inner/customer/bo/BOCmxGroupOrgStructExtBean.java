...
public class BOCmxGroupOrgStructExtBean extends DataContainer implements DataContainerInterface,IBOCmxGroupOrgStructExtValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmxGroupOrgStructExt";
  ...
  public BOCmxGroupOrgStructExtBean() throws AIException{
      super(S_TYPE);
  }
