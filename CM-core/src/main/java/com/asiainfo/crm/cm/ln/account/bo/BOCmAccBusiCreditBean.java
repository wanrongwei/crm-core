...
public class BOCmAccBusiCreditBean extends DataContainer implements DataContainerInterface,IBOCmAccBusiCreditValue{

  private static String  m_boName = "com.asiainfo.crm.cm.ln.account.bo.BOCmAccBusiCredit";
  ...
  public BOCmAccBusiCreditBean() throws AIException{
      super(S_TYPE);
  }
