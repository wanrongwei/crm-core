...
public class BOCmClubServiceAdjustBean extends DataContainer implements DataContainerInterface,IBOCmClubServiceAdjustValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.club.bo.BOCmClubServiceAdjust";
  ...
  public BOCmClubServiceAdjustBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initTempValue(int value){
     this.initProperty(S_TempValue,new Integer(value));
  }
  public  void setTempValue(int value){
     this.set(S_TempValue,new Integer(value));
  }
  public  void setTempValueNull(){
     this.set(S_TempValue,null);
  }

  public int getTempValue(){
        return DataType.getAsInt(this.get(S_TempValue));
  
  }
  public int getTempValueInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_TempValue));
      }
