...
public interface IQBOCmxCustomerRelValue extends DataStructInterface{
  ...
  public final static  String S_UserCreateDate = "USER_CREATE_DATE";
...
public  void setUserCreateDate(Timestamp value);
