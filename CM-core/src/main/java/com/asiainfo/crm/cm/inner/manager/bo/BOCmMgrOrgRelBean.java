...
public class BOCmMgrOrgRelBean extends DataContainer implements DataContainerInterface,IBOCmMgrOrgRelValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.manager.bo.BOCmMgrOrgRel";
  ...
  public BOCmMgrOrgRelBean() throws AIException{
      super(S_TYPE);
  }
