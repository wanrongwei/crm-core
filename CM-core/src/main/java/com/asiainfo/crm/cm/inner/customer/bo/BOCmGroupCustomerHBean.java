...
public class BOCmGroupCustomerHBean extends DataContainer implements DataContainerInterface,IBOCmGroupCustomerHValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmGroupCustomerH";
  ...
  public BOCmGroupCustomerHBean() throws AIException{
      super(S_TYPE);
  }
