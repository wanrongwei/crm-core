...
public class BOCMPartyAcctRelBean extends DataContainer implements DataContainerInterface,IBOCMPartyAcctRelValue{

  private static String  m_boName = "com.asiainfo.crm.cm.common.bo.BOCMPartyAcctRel";
  ...
  public BOCMPartyAcctRelBean() throws AIException{
      super(S_TYPE);
  }
