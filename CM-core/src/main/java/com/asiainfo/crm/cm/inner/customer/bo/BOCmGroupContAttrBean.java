...
public class BOCmGroupContAttrBean extends DataContainer implements DataContainerInterface,IBOCmGroupContAttrValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmGroupContAttr";
  ...
  public BOCmGroupContAttrBean() throws AIException{
      super(S_TYPE);
  }
