...
public class QBOCmRegionGroupInfoBean extends DataContainer implements DataContainerInterface,IQBOCmRegionGroupInfoValue{

  private static String  m_boName = "com.asiainfo.crm.cm.customer.group.bo.QBOCmRegionGroupInfo";
  ...
  public QBOCmRegionGroupInfoBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initDName(String value){
     this.initProperty(S_DName,value);
  }
  public  void setDName(String value){
     this.set(S_DName,value);
  }
  public  void setDNameNull(){
     this.set(S_DName,null);
  }

  public String getDName(){
       return DataType.getAsString(this.get(S_DName));
  
  }
  public String getDNameInitialValue(){
        return DataType.getAsString(this.getOldObj(S_DName));
      }
