...
public class BOCmxGroupCreditPointBean extends DataContainer implements DataContainerInterface,IBOCmxGroupCreditPointValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmxGroupCreditPoint";
  ...
  public BOCmxGroupCreditPointBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initPoints(double value){
     this.initProperty(S_Points,new Double(value));
  }
  public  void setPoints(double value){
     this.set(S_Points,new Double(value));
  }
  ...
  public double getPoints(){
        return DataType.getAsDouble(this.get(S_Points));
  
  }
  public double getPointsInitialValue(){
        return DataType.getAsDouble(this.getOldObj(S_Points));
      }

  public void initManagerSel(String value){
     this.initProperty(S_ManagerSel,value);
  }
  public  void setManagerSel(String value){
     this.set(S_ManagerSel,value);
  }
  ...
  public String getManagerSel(){
       return DataType.getAsString(this.get(S_ManagerSel));
  
  }
  public String getManagerSelInitialValue(){
        return DataType.getAsString(this.getOldObj(S_ManagerSel));
      }
  ...
  public void initManager(String value){
     this.initProperty(S_Manager,value);
  }
  public  void setManager(String value){
     this.set(S_Manager,value);
  }
  public  void setManagerNull(){
     this.set(S_Manager,null);
  }

  public String getManager(){
       return DataType.getAsString(this.get(S_Manager));
  
  }
  public String getManagerInitialValue(){
        return DataType.getAsString(this.getOldObj(S_Manager));
      }
  ...
  public void initManagerQry(String value){
     this.initProperty(S_ManagerQry,value);
  }
  public  void setManagerQry(String value){
     this.set(S_ManagerQry,value);
  }
  public  void setManagerQryNull(){
     this.set(S_ManagerQry,null);
  }

  public String getManagerQry(){
       return DataType.getAsString(this.get(S_ManagerQry));
  
  }
  public String getManagerQryInitialValue(){
        return DataType.getAsString(this.getOldObj(S_ManagerQry));
      }
  ...
  public void initPointType(int value){
     this.initProperty(S_PointType,new Integer(value));
  }
  public  void setPointType(int value){
     this.set(S_PointType,new Integer(value));
  }
  ...
  public int getPointType(){
        return DataType.getAsInt(this.get(S_PointType));
  
  }
  public int getPointTypeInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_PointType));
      }
  ...
  public void initExt1(double value){
     this.initProperty(S_Ext1,new Double(value));
  }
  public  void setExt1(double value){
     this.set(S_Ext1,new Double(value));
  }
  ...
  public double getExt1(){
        return DataType.getAsDouble(this.get(S_Ext1));
  
  }
  public double getExt1InitialValue(){
        return DataType.getAsDouble(this.getOldObj(S_Ext1));
      }
