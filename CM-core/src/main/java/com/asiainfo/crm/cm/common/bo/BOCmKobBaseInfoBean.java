...
public class BOCmKobBaseInfoBean extends DataContainer implements DataContainerInterface,IBOCmKobBaseInfoValue{

  private static String  m_boName = "com.asiainfo.crm.cm.common.bo.BOCmKobBaseInfo";
  ...
  public BOCmKobBaseInfoBean() throws AIException{
      super(S_TYPE);
  }
