...
public class ClubServiceBean extends DataContainer implements DataContainerInterface,IClubServiceValue{

  private static String  m_boName = "com.asiainfo.crm.cm.model.bo.ClubService";
  ...
  public ClubServiceBean() throws AIException{
      super(S_TYPE);
  }
