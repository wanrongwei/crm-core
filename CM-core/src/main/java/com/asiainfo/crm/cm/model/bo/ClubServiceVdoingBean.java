...
public class ClubServiceVdoingBean extends DataContainer implements DataContainerInterface,IClubServiceVdoingValue{

  private static String  m_boName = "com.asiainfo.crm.cm.model.bo.ClubServiceVdoing";
  ...
  public ClubServiceVdoingBean() throws AIException{
      super(S_TYPE);
  }
