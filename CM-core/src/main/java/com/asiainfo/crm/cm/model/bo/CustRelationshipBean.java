...
public class CustRelationshipBean extends DataContainer implements DataContainerInterface,ICustRelationshipValue{

  private static String  m_boName = "com.asiainfo.crm.cm.model.bo.CustRelationship";
  ...
  public final static  String S_CustRelLevel = "CUST_REL_LEVEL";
  ...
  public final static  String S_RelationType = "RELATION_TYPE";
  ...
  public CustRelationshipBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initCustRelLevel(int value){
     this.initProperty(S_CustRelLevel,new Integer(value));
  }
  public  void setCustRelLevel(int value){
     this.set(S_CustRelLevel,new Integer(value));
  }
  public  void setCustRelLevelNull(){
     this.set(S_CustRelLevel,null);
  }

  public int getCustRelLevel(){
        return DataType.getAsInt(this.get(S_CustRelLevel));
  
  }
  public int getCustRelLevelInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_CustRelLevel));
      }
  ...
  public void initRelationType(int value){
     this.initProperty(S_RelationType,new Integer(value));
  }
  public  void setRelationType(int value){
     this.set(S_RelationType,new Integer(value));
  }
  public  void setRelationTypeNull(){
     this.set(S_RelationType,null);
  }

  public int getRelationType(){
        return DataType.getAsInt(this.get(S_RelationType));
  
  }
  public int getRelationTypeInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_RelationType));
      }
