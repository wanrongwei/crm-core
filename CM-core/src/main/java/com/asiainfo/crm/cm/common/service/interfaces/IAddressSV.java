...
public interface IAddressSV {
	 ...
	 * 2015-10-15     yangjh           v1.0.0               修改原因<br>
	 */
	public  long  saveAddress4hu(AddressResult address)throws Exception;
	/**
	 * HU保存地址
	 * @Function saveAddress4Hu
	 * @Description 
	 *
	 * @param address
	 * @return
	 ...
	 */
	public  long  saveAddress4Hu(address4Hu address)throws Exception;
	/**
	 * 根据地址ID查询地址信息(HU)
	 * @Function getAddressById4Hu
	 * @Description 
	 *
	 * @param addressId
	 * @return
