...
public class BOCmGroupCustContractBean extends DataContainer implements DataContainerInterface,IBOCmGroupCustContractValue{

  private static String  m_boName = "com.asiainfo.crm.cm.customer.group.bo.BOCmGroupCustContract";
  ...
  public final static  String S_ContractAgent = "CONTRACT_AGENT";
  ...
  public final static  String S_AssociationBillingNumber = "ASSOCIATION_BILLING_NUMBER";
  ...
  public BOCmGroupCustContractBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initThirdDeputyType(int value){
     this.initProperty(S_ThirdDeputyType,new Integer(value));
  }
  public  void setThirdDeputyType(int value){
     this.set(S_ThirdDeputyType,new Integer(value));
  }
  public  void setThirdDeputyTypeNull(){
     this.set(S_ThirdDeputyType,null);
  }

  public int getThirdDeputyType(){
        return DataType.getAsInt(this.get(S_ThirdDeputyType));
  
  }
  public int getThirdDeputyTypeInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_ThirdDeputyType));
      }
  ...
  public void initContractAgent(String value){
     this.initProperty(S_ContractAgent,value);
  }
  public  void setContractAgent(String value){
     this.set(S_ContractAgent,value);
  }
  public  void setContractAgentNull(){
     this.set(S_ContractAgent,null);
  }

  public String getContractAgent(){
       return DataType.getAsString(this.get(S_ContractAgent));
  
  }
  public String getContractAgentInitialValue(){
        return DataType.getAsString(this.getOldObj(S_ContractAgent));
      }
  ...
  public void initFirstDeputyType(int value){
     this.initProperty(S_FirstDeputyType,new Integer(value));
  }
  public  void setFirstDeputyType(int value){
     this.set(S_FirstDeputyType,new Integer(value));
  }
  public  void setFirstDeputyTypeNull(){
     this.set(S_FirstDeputyType,null);
  }

  public int getFirstDeputyType(){
        return DataType.getAsInt(this.get(S_FirstDeputyType));
  
  }
  public int getFirstDeputyTypeInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_FirstDeputyType));
      }
  ...
  public void initAssociationBillingNumber(String value){
     this.initProperty(S_AssociationBillingNumber,value);
  }
  public  void setAssociationBillingNumber(String value){
     this.set(S_AssociationBillingNumber,value);
  }
  public  void setAssociationBillingNumberNull(){
     this.set(S_AssociationBillingNumber,null);
  }

  public String getAssociationBillingNumber(){
       return DataType.getAsString(this.get(S_AssociationBillingNumber));
  
  }
  public String getAssociationBillingNumberInitialValue(){
        return DataType.getAsString(this.getOldObj(S_AssociationBillingNumber));
      }
  ...
  public void initContractStatus(int value){
     this.initProperty(S_ContractStatus,new Integer(value));
  }
  public  void setContractStatus(int value){
     this.set(S_ContractStatus,new Integer(value));
  }
  ...
  public int getContractStatus(){
        return DataType.getAsInt(this.get(S_ContractStatus));
  
  }
  public int getContractStatusInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_ContractStatus));
      }
  ...
  public void initContractSource(int value){
     this.initProperty(S_ContractSource,new Integer(value));
  }
  public  void setContractSource(int value){
     this.set(S_ContractSource,new Integer(value));
  }
  ...
  public int getContractSource(){
        return DataType.getAsInt(this.get(S_ContractSource));
  
  }
  public int getContractSourceInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_ContractSource));
      }
  ...
  public void initContractLevel(int value){
     this.initProperty(S_ContractLevel,new Integer(value));
  }
  public  void setContractLevel(int value){
     this.set(S_ContractLevel,new Integer(value));
  }
  ...
  public int getContractLevel(){
        return DataType.getAsInt(this.get(S_ContractLevel));
  
  }
  public int getContractLevelInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_ContractLevel));
      }
  ...
  public void initSecondDeputyType(int value){
     this.initProperty(S_SecondDeputyType,new Integer(value));
  }
  public  void setSecondDeputyType(int value){
     this.set(S_SecondDeputyType,new Integer(value));
  }
  public  void setSecondDeputyTypeNull(){
     this.set(S_SecondDeputyType,null);
  }

  public int getSecondDeputyType(){
        return DataType.getAsInt(this.get(S_SecondDeputyType));
  
  }
  public int getSecondDeputyTypeInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_SecondDeputyType));
      }
