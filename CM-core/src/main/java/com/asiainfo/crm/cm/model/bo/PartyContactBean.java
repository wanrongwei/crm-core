...
public class PartyContactBean extends DataContainer implements DataContainerInterface,IPartyContactValue{

  private static String  m_boName = "com.asiainfo.crm.cm.model.bo.PartyContact";
  ...
  public PartyContactBean() throws AIException{
      super(S_TYPE);
  }
