...
public class PushCEventThread implements Runnable{
	...
	public PushCEventThread(String eventCode,Event event,long custId,String billId,long entityId) {
	...
	private String transEvent2String(Event event) throws  Exception{
