...
public class BOCmCustRequestTaskBean extends DataContainer implements DataContainerInterface,IBOCmCustRequestTaskValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmCustRequestTask";
  ...
  public BOCmCustRequestTaskBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initRequestType(long value){
     this.initProperty(S_RequestType,new Long(value));
  }
  public  void setRequestType(long value){
     this.set(S_RequestType,new Long(value));
  }
  ...
  public long getRequestType(){
        return DataType.getAsLong(this.get(S_RequestType));
  
  }
  public long getRequestTypeInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_RequestType));
      }
