...
public class BOCmSpecialListHisBean extends DataContainer implements DataContainerInterface,IBOCmSpecialListHisValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.club.bo.BOCmSpecialListHis";
  ...
  public BOCmSpecialListHisBean() throws AIException{
      super(S_TYPE);
  }
