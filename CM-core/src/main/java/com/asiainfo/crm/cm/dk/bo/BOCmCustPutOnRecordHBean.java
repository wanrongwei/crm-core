...
public class BOCmCustPutOnRecordHBean extends DataContainer implements DataContainerInterface,IBOCmCustPutOnRecordHValue{

  private static String  m_boName = "com.asiainfo.crm.cm.dk.bo.BOCmCustPutOnRecordH";
  ...
  public BOCmCustPutOnRecordHBean() throws AIException{
      super(S_TYPE);
  }
