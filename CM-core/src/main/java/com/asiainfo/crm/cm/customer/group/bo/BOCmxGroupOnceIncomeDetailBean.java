...
public class BOCmxGroupOnceIncomeDetailBean extends DataContainer implements DataContainerInterface,IBOCmxGroupOnceIncomeDetailValue{

  private static String  m_boName = "com.asiainfo.crm.cm.customer.group.bo.BOCmxGroupOnceIncomeDetail";
  ...
  public BOCmxGroupOnceIncomeDetailBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initFee(double value){
     this.initProperty(S_Fee,new Double(value));
  }
  public  void setFee(double value){
     this.set(S_Fee,new Double(value));
  }
  ...
  public double getFee(){
        return DataType.getAsDouble(this.get(S_Fee));
  
  }
  public double getFeeInitialValue(){
        return DataType.getAsDouble(this.getOldObj(S_Fee));
      }
