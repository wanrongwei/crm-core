...
public class BOCmFamilyMemberBean extends DataContainer implements DataContainerInterface,IBOCmFamilyMemberValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmFamilyMember";
  ...
  public BOCmFamilyMemberBean() throws AIException{
      super(S_TYPE);
  }
