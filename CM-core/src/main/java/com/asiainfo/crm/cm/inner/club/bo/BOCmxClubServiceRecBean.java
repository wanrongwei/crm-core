...
public class BOCmxClubServiceRecBean extends DataContainer implements DataContainerInterface,IBOCmxClubServiceRecValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.club.bo.BOCmxClubServiceRec";
  ...
  public BOCmxClubServiceRecBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initTrainAirportName(String value){
     this.initProperty(S_TrainAirportName,value);
  }
  public  void setTrainAirportName(String value){
     this.set(S_TrainAirportName,value);
  }
  public  void setTrainAirportNameNull(){
     this.set(S_TrainAirportName,null);
  }

  public String getTrainAirportName(){
       return DataType.getAsString(this.get(S_TrainAirportName));
  
  }
  public String getTrainAirportNameInitialValue(){
        return DataType.getAsString(this.getOldObj(S_TrainAirportName));
      }
  ...
  public void initBelongCity(String value){
     this.initProperty(S_BelongCity,value);
  }
  public  void setBelongCity(String value){
     this.set(S_BelongCity,value);
  }
  public  void setBelongCityNull(){
     this.set(S_BelongCity,null);
  }

  public String getBelongCity(){
       return DataType.getAsString(this.get(S_BelongCity));
  
  }
  public String getBelongCityInitialValue(){
        return DataType.getAsString(this.getOldObj(S_BelongCity));
      }

  public void initClassesNo(String value){
     this.initProperty(S_ClassesNo,value);
  }
  public  void setClassesNo(String value){
     this.set(S_ClassesNo,value);
  }
  public  void setClassesNoNull(){
     this.set(S_ClassesNo,null);
  }

  public String getClassesNo(){
       return DataType.getAsString(this.get(S_ClassesNo));
  
  }
  public String getClassesNoInitialValue(){
        return DataType.getAsString(this.getOldObj(S_ClassesNo));
      }
