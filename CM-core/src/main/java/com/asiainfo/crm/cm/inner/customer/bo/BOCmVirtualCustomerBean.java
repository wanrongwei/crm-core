...
public class BOCmVirtualCustomerBean extends DataContainer implements DataContainerInterface,IBOCmVirtualCustomerValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmVirtualCustomer";
  ...
  public BOCmVirtualCustomerBean() throws AIException{
      super(S_TYPE);
  }
