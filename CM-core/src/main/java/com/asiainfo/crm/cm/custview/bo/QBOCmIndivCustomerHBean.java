...
public class QBOCmIndivCustomerHBean extends DataContainer implements DataContainerInterface,IQBOCmIndivCustomerHValue{

  private static String  m_boName = "com.asiainfo.crm.cm.custview.bo.QBOCmIndivCustomerH";
  ...
  public QBOCmIndivCustomerHBean() throws AIException{
      super(S_TYPE);
  }
