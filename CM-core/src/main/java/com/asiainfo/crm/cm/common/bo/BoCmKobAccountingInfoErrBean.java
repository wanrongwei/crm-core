...
public class BoCmKobAccountingInfoErrBean extends DataContainer implements DataContainerInterface,IBoCmKobAccountingInfoErrValue{

  private static String  m_boName = "com.asiainfo.crm.cm.common.bo.BoCmKobAccountingInfoErr";
  ...
  public BoCmKobAccountingInfoErrBean() throws AIException{
      super(S_TYPE);
  }
