...
public class BOCmKobTTInfoErrBean extends DataContainer implements DataContainerInterface,IBOCmKobTTInfoErrValue{

  private static String  m_boName = "com.asiainfo.crm.cm.common.bo.BOCmKobTTInfoErr";
  ...
  public BOCmKobTTInfoErrBean() throws AIException{
      super(S_TYPE);
  }
