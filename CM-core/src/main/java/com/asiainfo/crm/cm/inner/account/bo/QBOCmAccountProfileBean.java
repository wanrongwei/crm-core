...
public class QBOCmAccountProfileBean extends DataContainer implements DataContainerInterface,IQBOCmAccountProfileValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.account.bo.QBOCmAccountProfile";
  ...
  public QBOCmAccountProfileBean() throws AIException{
      super(S_TYPE);
  }
