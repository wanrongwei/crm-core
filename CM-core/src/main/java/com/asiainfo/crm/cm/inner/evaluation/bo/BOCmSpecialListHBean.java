...
public class BOCmSpecialListHBean extends DataContainer implements DataContainerInterface,IBOCmSpecialListHValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.evaluation.bo.BOCmSpecialListH";
  ...
  public BOCmSpecialListHBean() throws AIException{
      super(S_TYPE);
  }
