...
public class BOCmPartnerBusiTypeDtlBean extends DataContainer implements DataContainerInterface,IBOCmPartnerBusiTypeDtlValue{

  private static String  m_boName = "com.asiainfo.crm.cm.cp.bo.BOCmPartnerBusiTypeDtl";
  ...
  public final static  String S_TypeDtlName = "TYPE_DTL_NAME";
  ...
  public BOCmPartnerBusiTypeDtlBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initTypeDtlName(String value){
     this.initProperty(S_TypeDtlName,value);
  }
  public  void setTypeDtlName(String value){
     this.set(S_TypeDtlName,value);
  }
  public  void setTypeDtlNameNull(){
     this.set(S_TypeDtlName,null);
  }

  public String getTypeDtlName(){
       return DataType.getAsString(this.get(S_TypeDtlName));
  
  }
  public String getTypeDtlNameInitialValue(){
        return DataType.getAsString(this.getOldObj(S_TypeDtlName));
      }
