...
public class BOCmCmxAcctPaymentAttrBean extends DataContainer implements DataContainerInterface,IBOCmCmxAcctPaymentAttrValue{

  private static String  m_boName = "com.asiainfo.crm.cm.ln.account.bo.BOCmCmxAcctPaymentAttr";
  ...
  public BOCmCmxAcctPaymentAttrBean() throws AIException{
      super(S_TYPE);
  }
