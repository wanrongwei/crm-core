...
public class BOCmCustPreferChannelBean extends DataContainer implements DataContainerInterface,IBOCmCustPreferChannelValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmCustPreferChannel";
  ...
  public BOCmCustPreferChannelBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initPerferType(long value){
     this.initProperty(S_PerferType,new Long(value));
  }
  public  void setPerferType(long value){
     this.set(S_PerferType,new Long(value));
  }
  ...
  public long getPerferType(){
        return DataType.getAsLong(this.get(S_PerferType));
  
  }
  public long getPerferTypeInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_PerferType));
      }
  ...
  public void initPrior(long value){
     this.initProperty(S_Prior,new Long(value));
  }
  public  void setPrior(long value){
     this.set(S_Prior,new Long(value));
  }
  ...
  public long getPrior(){
        return DataType.getAsLong(this.get(S_Prior));
  
  }
  public long getPriorInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_Prior));
      }
