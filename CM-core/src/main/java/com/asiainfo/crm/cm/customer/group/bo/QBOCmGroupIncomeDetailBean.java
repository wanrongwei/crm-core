...
public class QBOCmGroupIncomeDetailBean extends DataContainer implements DataContainerInterface,IQBOCmGroupIncomeDetailValue{

  private static String  m_boName = "com.asiainfo.crm.cm.customer.group.bo.QBOCmGroupIncomeDetail";
  ...
  public QBOCmGroupIncomeDetailBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initRealnewincome(double value){
     this.initProperty(S_Realnewincome,new Double(value));
  }
  public  void setRealnewincome(double value){
     this.set(S_Realnewincome,new Double(value));
  }
  public  void setRealnewincomeNull(){
     this.set(S_Realnewincome,null);
  }

  public double getRealnewincome(){
        return DataType.getAsDouble(this.get(S_Realnewincome));
  
  }
  public double getRealnewincomeInitialValue(){
        return DataType.getAsDouble(this.getOldObj(S_Realnewincome));
      }

  public void initIncomeStatus(long value){
     this.initProperty(S_IncomeStatus,new Long(value));
  }
  public  void setIncomeStatus(long value){
     this.set(S_IncomeStatus,new Long(value));
  }
  ...
  public long getIncomeStatus(){
        return DataType.getAsLong(this.get(S_IncomeStatus));
  
  }
  public long getIncomeStatusInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_IncomeStatus));
      }
  ...
  public void initRealincome(double value){
     this.initProperty(S_Realincome,new Double(value));
  }
  public  void setRealincome(double value){
     this.set(S_Realincome,new Double(value));
  }
  public  void setRealincomeNull(){
     this.set(S_Realincome,null);
  }

  public double getRealincome(){
        return DataType.getAsDouble(this.get(S_Realincome));
  
  }
  public double getRealincomeInitialValue(){
        return DataType.getAsDouble(this.getOldObj(S_Realincome));
      }
  ...
  public void initPayCycType(long value){
     this.initProperty(S_PayCycType,new Long(value));
  }
  public  void setPayCycType(long value){
     this.set(S_PayCycType,new Long(value));
  }
  ...
  public long getPayCycType(){
        return DataType.getAsLong(this.get(S_PayCycType));
  
  }
  public long getPayCycTypeInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_PayCycType));
      }
  ...
  public void initReceivingUnitsType(long value){
     this.initProperty(S_ReceivingUnitsType,new Long(value));
  }
  public  void setReceivingUnitsType(long value){
     this.set(S_ReceivingUnitsType,new Long(value));
  }
  ...
  public long getReceivingUnitsType(){
        return DataType.getAsLong(this.get(S_ReceivingUnitsType));
  
  }
  public long getReceivingUnitsTypeInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_ReceivingUnitsType));
      }
