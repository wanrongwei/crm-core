...
public class IRaccOperBean extends DataContainer implements DataContainerInterface,IIRaccOperValue{

  private static String  m_boName = "com.asiainfo.crm.cm.zg.bo.IRaccOper";
  ...
  public IRaccOperBean() throws AIException{
      super(S_TYPE);
  }
