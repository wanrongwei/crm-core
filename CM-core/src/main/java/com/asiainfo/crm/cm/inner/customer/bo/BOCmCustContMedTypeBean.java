...
public class BOCmCustContMedTypeBean extends DataContainer implements DataContainerInterface,IBOCmCustContMedTypeValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmCustContMedType";
  ...
  public BOCmCustContMedTypeBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initUseType(long value){
     this.initProperty(S_UseType,new Long(value));
  }
  public  void setUseType(long value){
     this.set(S_UseType,new Long(value));
  }
  ...
  public long getUseType(){
        return DataType.getAsLong(this.get(S_UseType));
  
  }
  public long getUseTypeInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_UseType));
      }
