...
public class BOCmKobBaseInfoErrBean extends DataContainer implements DataContainerInterface,IBOCmKobBaseInfoErrValue{

  private static String  m_boName = "com.asiainfo.crm.cm.common.bo.BOCmKobBaseInfoErr";
  ...
  public BOCmKobBaseInfoErrBean() throws AIException{
      super(S_TYPE);
  }
