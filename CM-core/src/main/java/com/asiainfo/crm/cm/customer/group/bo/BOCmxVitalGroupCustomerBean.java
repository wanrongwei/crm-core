...
public class BOCmxVitalGroupCustomerBean extends DataContainer implements DataContainerInterface,IBOCmxVitalGroupCustomerValue{

  private static String  m_boName = "com.asiainfo.crm.cm.customer.group.bo.BOCmxVitalGroupCustomer";
  ...
  public BOCmxVitalGroupCustomerBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initGroupSource(int value){
     this.initProperty(S_GroupSource,new Integer(value));
  }
  public  void setGroupSource(int value){
     this.set(S_GroupSource,new Integer(value));
  }
  ...
  public int getGroupSource(){
        return DataType.getAsInt(this.get(S_GroupSource));
  
  }
  public int getGroupSourceInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_GroupSource));
      }
  ...
  public void initIsImportant(int value){
     this.initProperty(S_IsImportant,new Integer(value));
  }
  public  void setIsImportant(int value){
     this.set(S_IsImportant,new Integer(value));
  }
  ...
  public int getIsImportant(){
        return DataType.getAsInt(this.get(S_IsImportant));
  
  }
  public int getIsImportantInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_IsImportant));
      }
