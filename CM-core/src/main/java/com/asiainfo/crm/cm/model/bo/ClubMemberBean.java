...
public class ClubMemberBean extends DataContainer implements DataContainerInterface,IClubMemberValue{

  private static String  m_boName = "com.asiainfo.crm.cm.model.bo.ClubMember";
  ...
  public ClubMemberBean() throws AIException{
      super(S_TYPE);
  }
