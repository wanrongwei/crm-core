...
public class BOCmContactMediumRelBean extends DataContainer implements DataContainerInterface,IBOCmContactMediumRelValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmContactMediumRel";
  ...
  public BOCmContactMediumRelBean() throws AIException{
      super(S_TYPE);
  }
