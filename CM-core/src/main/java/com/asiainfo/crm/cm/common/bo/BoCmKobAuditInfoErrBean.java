...
public class BoCmKobAuditInfoErrBean extends DataContainer implements DataContainerInterface,IBoCmKobAuditInfoErrValue{

  private static String  m_boName = "com.asiainfo.crm.cm.common.bo.BoCmKobAuditInfoErr";
  ...
  public BoCmKobAuditInfoErrBean() throws AIException{
      super(S_TYPE);
  }
