...
public class BOCmGroupCardInfoBean extends DataContainer implements DataContainerInterface,IBOCmGroupCardInfoValue{

  private static String  m_boName = "com.asiainfo.crm.cm.customer.group.bo.BOCmGroupCardInfo";
  ...
  public final static  String S_CardInfoId = "CARD_INFO_ID";
  ...
  public BOCmGroupCardInfoBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initCardInfoId(long value){
     this.initProperty(S_CardInfoId,new Long(value));
  }
  public  void setCardInfoId(long value){
     this.set(S_CardInfoId,new Long(value));
  }
  public  void setCardInfoIdNull(){
     this.set(S_CardInfoId,null);
  }

  public long getCardInfoId(){
        return DataType.getAsLong(this.get(S_CardInfoId));
  
  }
  public long getCardInfoIdInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_CardInfoId));
      }
