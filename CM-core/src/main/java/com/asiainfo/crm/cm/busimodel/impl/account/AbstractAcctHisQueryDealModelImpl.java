...
* @Description 该类对查询账户历史操作的业务逻辑进行了抽象的实现
*
*
* @version: v1.0.0
* @author: zhangyin
...
*/
public abstract class AbstractAcctHisQueryDealModelImpl extends AbstractQueryBusiModelImpl implements IQueryDataBusiModel, IQueryCountBusiModel {
