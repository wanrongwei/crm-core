...
public class BOCmRaccOperBean extends DataContainer implements DataContainerInterface,IBOCmRaccOperValue{

  private static String  m_boName = "com.asiainfo.crm.cm.ln.account.bo.BOCmRaccOper";
  ...
  public BOCmRaccOperBean() throws AIException{
      super(S_TYPE);
  }
