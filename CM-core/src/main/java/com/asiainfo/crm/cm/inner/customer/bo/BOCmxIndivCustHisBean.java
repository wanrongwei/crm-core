...
public class BOCmxIndivCustHisBean extends DataContainer implements DataContainerInterface,IBOCmxIndivCustHisValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmxIndivCustHis";
  ...
  public BOCmxIndivCustHisBean() throws AIException{
      super(S_TYPE);
  }
