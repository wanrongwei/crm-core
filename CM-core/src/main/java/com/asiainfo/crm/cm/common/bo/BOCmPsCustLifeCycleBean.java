...
public class BOCmPsCustLifeCycleBean extends DataContainer implements DataContainerInterface,IBOCmPsCustLifeCycleValue{

  private static String  m_boName = "com.asiainfo.crm.cm.common.bo.BOCmPsCustLifeCycle";
  ...
  public BOCmPsCustLifeCycleBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initAction(long value){
     this.initProperty(S_Action,new Long(value));
  }
  public  void setAction(long value){
     this.set(S_Action,new Long(value));
  }
  ...
  public long getAction(){
        return DataType.getAsLong(this.get(S_Action));
  
  }
  public long getActionInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_Action));
      }

  public void initOriginalCustId(long value){
     this.initProperty(S_OriginalCustId,new Long(value));
  }
  public  void setOriginalCustId(long value){
     this.set(S_OriginalCustId,new Long(value));
  }
  public  void setOriginalCustIdNull(){
     this.set(S_OriginalCustId,null);
  }

  public long getOriginalCustId(){
        return DataType.getAsLong(this.get(S_OriginalCustId));
  
  }
  public long getOriginalCustIdInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_OriginalCustId));
      }
