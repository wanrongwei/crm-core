...
public class BOCmPsOptinSyncC3Bean extends DataContainer implements DataContainerInterface,IBOCmPsOptinSyncC3Value{

  private static String  m_boName = "com.asiainfo.crm.cm.dk.bo.BOCmPsOptinSyncC3";
  ...
  public BOCmPsOptinSyncC3Bean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initOptinFlag(String value){
     this.initProperty(S_OptinFlag,value);
  }
  public  void setOptinFlag(String value){
     this.set(S_OptinFlag,value);
  }
  public  void setOptinFlagNull(){
     this.set(S_OptinFlag,null);
  }

  public String getOptinFlag(){
       return DataType.getAsString(this.get(S_OptinFlag));
  
  }
  public String getOptinFlagInitialValue(){
        return DataType.getAsString(this.getOldObj(S_OptinFlag));
      }
