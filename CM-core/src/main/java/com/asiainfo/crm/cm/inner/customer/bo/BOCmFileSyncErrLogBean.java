...
public class BOCmFileSyncErrLogBean extends DataContainer implements DataContainerInterface,IBOCmFileSyncErrLogValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmFileSyncErrLog";
  ...
  public BOCmFileSyncErrLogBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initFileType(long value){
     this.initProperty(S_FileType,new Long(value));
  }
  public  void setFileType(long value){
     this.set(S_FileType,new Long(value));
  }
  ...
  public long getFileType(){
        return DataType.getAsLong(this.get(S_FileType));
  
  }
  public long getFileTypeInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_FileType));
      }
