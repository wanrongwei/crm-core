...
public class BOCmCustManagerTeamBean extends DataContainer implements DataContainerInterface,IBOCmCustManagerTeamValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.manager.bo.BOCmCustManagerTeam";
  ...
  public BOCmCustManagerTeamBean() throws AIException{
      super(S_TYPE);
  }
