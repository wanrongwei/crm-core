...
public class BOCmPsTaskDealErrBean extends DataContainer implements DataContainerInterface,IBOCmPsTaskDealErrValue{

  private static String  m_boName = "com.asiainfo.crm.cm.common.bo.BOCmPsTaskDealErr";
  ...
  public BOCmPsTaskDealErrBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initTaskType(long value){
     this.initProperty(S_TaskType,new Long(value));
  }
  public  void setTaskType(long value){
     this.set(S_TaskType,new Long(value));
  }
  ...
  public long getTaskType(){
        return DataType.getAsLong(this.get(S_TaskType));
  
  }
  public long getTaskTypeInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_TaskType));
      }
