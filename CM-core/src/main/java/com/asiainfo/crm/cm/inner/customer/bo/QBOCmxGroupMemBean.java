...
public class QBOCmxGroupMemBean extends DataContainer implements DataContainerInterface,IQBOCmxGroupMemValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.QBOCmxGroupMem";
  ...
  public QBOCmxGroupMemBean() throws AIException{
      super(S_TYPE);
  }
