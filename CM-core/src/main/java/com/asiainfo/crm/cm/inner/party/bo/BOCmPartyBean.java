...
public class BOCmPartyBean extends DataContainer implements DataContainerInterface,IBOCmPartyValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.party.bo.BOCmParty";
  ...
  public BOCmPartyBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initPerferLanguage(long value){
     this.initProperty(S_PerferLanguage,new Long(value));
  }
  public  void setPerferLanguage(long value){
     this.set(S_PerferLanguage,new Long(value));
  }
  ...
  public long getPerferLanguage(){
        return DataType.getAsLong(this.get(S_PerferLanguage));
  
  }
  public long getPerferLanguageInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_PerferLanguage));
      }
