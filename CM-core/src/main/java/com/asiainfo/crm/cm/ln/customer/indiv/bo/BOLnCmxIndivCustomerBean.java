...
public class BOLnCmxIndivCustomerBean extends DataContainer implements DataContainerInterface,IBOLnCmxIndivCustomerValue{

  private static String  m_boName = "com.asiainfo.crm.cm.ln.customer.indiv.bo.BOLnCmxIndivCustomer";
  ...
  public BOLnCmxIndivCustomerBean() throws AIException{
      super(S_TYPE);
  }
