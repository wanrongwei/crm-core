 ...
 */
public class ClubServiceTimesStrategyAvgImpl implements IClubServiceTimesStrategy {
	...
	public int calculateAvailableTimes(Map countMap, Map weightMap) throws Exception {
		...
		return Integer.valueOf(String.valueOf(Math.round(sum / countMap.size())));
	}
