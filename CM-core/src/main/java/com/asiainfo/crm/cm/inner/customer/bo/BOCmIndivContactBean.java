...
public class BOCmIndivContactBean extends DataContainer implements DataContainerInterface,IBOCmIndivContactValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmIndivContact";
  ...
  public BOCmIndivContactBean() throws AIException{
      super(S_TYPE);
  }
