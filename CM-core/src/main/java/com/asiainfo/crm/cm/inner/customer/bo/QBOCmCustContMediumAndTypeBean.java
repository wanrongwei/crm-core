...
public class QBOCmCustContMediumAndTypeBean extends DataContainer implements DataContainerInterface,IQBOCmCustContMediumAndTypeValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.QBOCmCustContMediumAndType";
  ...
  public QBOCmCustContMediumAndTypeBean() throws AIException{
      super(S_TYPE);
  }
