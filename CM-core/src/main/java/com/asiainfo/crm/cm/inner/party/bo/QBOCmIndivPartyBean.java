...
public class QBOCmIndivPartyBean extends DataContainer implements DataContainerInterface,IQBOCmIndivPartyValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.party.bo.QBOCmIndivParty";
  ...
  public QBOCmIndivPartyBean() throws AIException{
      super(S_TYPE);
  }
