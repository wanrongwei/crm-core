...
public class BOCmGroupCustMemberBean extends DataContainer implements DataContainerInterface,IBOCmGroupCustMemberValue{

  private static String  m_boName = "com.asiainfo.crm.cm.customer.group.bo.BOCmGroupCustMember";
  ...
  public BOCmGroupCustMemberBean() throws AIException{
      super(S_TYPE);
  }
