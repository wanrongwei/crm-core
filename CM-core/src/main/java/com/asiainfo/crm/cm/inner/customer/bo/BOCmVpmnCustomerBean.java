...
public class BOCmVpmnCustomerBean extends DataContainer implements DataContainerInterface,IBOCmVpmnCustomerValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmVpmnCustomer";
  ...
  public BOCmVpmnCustomerBean() throws AIException{
      super(S_TYPE);
  }
