...
public class BOCmPreferPeriodBean extends DataContainer implements DataContainerInterface,IBOCmPreferPeriodValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmPreferPeriod";
  ...
  public BOCmPreferPeriodBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initTimeBeginUnit(long value){
     this.initProperty(S_TimeBeginUnit,new Long(value));
  }
  public  void setTimeBeginUnit(long value){
     this.set(S_TimeBeginUnit,new Long(value));
  }
  ...
  public long getTimeBeginUnit(){
        return DataType.getAsLong(this.get(S_TimeBeginUnit));
  
  }
  public long getTimeBeginUnitInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_TimeBeginUnit));
      }
  ...
  public void initTimeEndUnit(long value){
     this.initProperty(S_TimeEndUnit,new Long(value));
  }
  public  void setTimeEndUnit(long value){
     this.set(S_TimeEndUnit,new Long(value));
  }
  ...
  public long getTimeEndUnit(){
        return DataType.getAsLong(this.get(S_TimeEndUnit));
  
  }
  public long getTimeEndUnitInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_TimeEndUnit));
      }
