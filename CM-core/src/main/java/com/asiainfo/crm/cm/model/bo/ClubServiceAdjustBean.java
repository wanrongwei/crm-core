...
public class ClubServiceAdjustBean extends DataContainer implements DataContainerInterface,IClubServiceAdjustValue{

  private static String  m_boName = "com.asiainfo.crm.cm.model.bo.ClubServiceAdjust";
  ...
  public ClubServiceAdjustBean() throws AIException{
      super(S_TYPE);
  }
