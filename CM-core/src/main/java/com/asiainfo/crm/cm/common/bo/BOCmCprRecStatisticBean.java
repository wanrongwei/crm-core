...
public class BOCmCprRecStatisticBean extends DataContainer implements DataContainerInterface,IBOCmCprRecStatisticValue{

  private static String  m_boName = "com.asiainfo.crm.cm.common.bo.BOCmCprRecStatistic";
  ...
  public final static  String S_StatisticId = "statistic_id";
  ...
  public BOCmCprRecStatisticBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initStatisticId(long value){
     this.initProperty(S_StatisticId,new Long(value));
  }
  public  void setStatisticId(long value){
     this.set(S_StatisticId,new Long(value));
  }
  public  void setStatisticIdNull(){
     this.set(S_StatisticId,null);
  }

  public long getStatisticId(){
        return DataType.getAsLong(this.get(S_StatisticId));
  
  }
  public long getStatisticIdInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_StatisticId));
      }
