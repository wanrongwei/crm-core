...
public class PartyRoleBean extends DataContainer implements DataContainerInterface,IPartyRoleValue{

  private static String  m_boName = "com.asiainfo.crm.cm.model.bo.PartyRole";
  ...
  public PartyRoleBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initRoleStatus(int value){
     this.initProperty(S_RoleStatus,new Integer(value));
  }
  public  void setRoleStatus(int value){
     this.set(S_RoleStatus,new Integer(value));
  }
  ...
  public int getRoleStatus(){
        return DataType.getAsInt(this.get(S_RoleStatus));
  
  }
  public int getRoleStatusInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_RoleStatus));
      }
  ...
  public void initRoleType(int value){
     this.initProperty(S_RoleType,new Integer(value));
  }
  public  void setRoleType(int value){
     this.set(S_RoleType,new Integer(value));
  }
  ...
  public int getRoleType(){
        return DataType.getAsInt(this.get(S_RoleType));
  
  }
  public int getRoleTypeInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_RoleType));
      }
