...
public class AcctBillCustomizeBean extends DataContainer implements DataContainerInterface,IAcctBillCustomizeValue{

  private static String  m_boName = "com.asiainfo.crm.cm.model.bo.AcctBillCustomize";
  ...
  public AcctBillCustomizeBean() throws AIException{
      super(S_TYPE);
  }
