...
public class BOCmKobNameInfoBean extends DataContainer implements DataContainerInterface,IBOCmKobNameInfoValue{

  private static String  m_boName = "com.asiainfo.crm.cm.common.bo.BOCmKobNameInfo";
  ...
  public BOCmKobNameInfoBean() throws AIException{
      super(S_TYPE);
  }
