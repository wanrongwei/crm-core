...
public class BOCmVipElementBean extends DataContainer implements DataContainerInterface,IBOCmVipElementValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.club.bo.BOCmVipElement";
  ...
  public BOCmVipElementBean() throws AIException{
      super(S_TYPE);
  }
