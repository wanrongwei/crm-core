...
public class BOCmIndivCustomerHBean extends DataContainer implements DataContainerInterface,IBOCmIndivCustomerHValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmIndivCustomerH";
  ...
  public BOCmIndivCustomerHBean() throws AIException{
      super(S_TYPE);
  }
