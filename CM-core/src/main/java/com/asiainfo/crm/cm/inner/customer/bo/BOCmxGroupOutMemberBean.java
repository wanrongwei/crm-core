...
public class BOCmxGroupOutMemberBean extends DataContainer implements DataContainerInterface,IBOCmxGroupOutMemberValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmxGroupOutMember";
  ...
  public BOCmxGroupOutMemberBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initSpType(int value){
     this.initProperty(S_SpType,new Integer(value));
  }
  public  void setSpType(int value){
     this.set(S_SpType,new Integer(value));
  }
  public  void setSpTypeNull(){
     this.set(S_SpType,null);
  }

  public int getSpType(){
        return DataType.getAsInt(this.get(S_SpType));
  
  }
  public int getSpTypeInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_SpType));
      }
  ...
  public void initOutMemberId(long value){
     this.initProperty(S_OutMemberId,new Long(value));
  }
  public  void setOutMemberId(long value){
     this.set(S_OutMemberId,new Long(value));
  }
  public  void setOutMemberIdNull(){
     this.set(S_OutMemberId,null);
  }

  public long getOutMemberId(){
        return DataType.getAsLong(this.get(S_OutMemberId));
  
  }
  public long getOutMemberIdInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_OutMemberId));
      }
  ...
  public void initExt4(long value){
     this.initProperty(S_Ext4,new Long(value));
  }
  public  void setExt4(long value){
     this.set(S_Ext4,new Long(value));
  }
  ...
  public long getExt4(){
        return DataType.getAsLong(this.get(S_Ext4));
  
  }
  public long getExt4InitialValue(){
        return DataType.getAsLong(this.getOldObj(S_Ext4));
      }
