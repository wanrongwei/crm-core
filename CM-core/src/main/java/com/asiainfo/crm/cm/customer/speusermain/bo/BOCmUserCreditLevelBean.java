...
public class BOCmUserCreditLevelBean extends DataContainer implements DataContainerInterface,IBOCmUserCreditLevelValue{

  private static String  m_boName = "com.asiainfo.crm.cm.customer.speusermain.bo.BOCmUserCreditLevel";
  ...
  public BOCmUserCreditLevelBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initArrearsFlag(int value){
     this.initProperty(S_ArrearsFlag,new Integer(value));
  }
  public  void setArrearsFlag(int value){
     this.set(S_ArrearsFlag,new Integer(value));
  }
  public  void setArrearsFlagNull(){
     this.set(S_ArrearsFlag,null);
  }

  public int getArrearsFlag(){
        return DataType.getAsInt(this.get(S_ArrearsFlag));
  
  }
  public int getArrearsFlagInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_ArrearsFlag));
      }
  ...
  public void initLastCreditLevel(int value){
     this.initProperty(S_LastCreditLevel,new Integer(value));
  }
  public  void setLastCreditLevel(int value){
     this.set(S_LastCreditLevel,new Integer(value));
  }
  public  void setLastCreditLevelNull(){
     this.set(S_LastCreditLevel,null);
  }

  public int getLastCreditLevel(){
        return DataType.getAsInt(this.get(S_LastCreditLevel));
  
  }
  public int getLastCreditLevelInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_LastCreditLevel));
      }

  public void initTempId(long value){
     this.initProperty(S_TempId,new Long(value));
  }
  public  void setTempId(long value){
     this.set(S_TempId,new Long(value));
  }
  public  void setTempIdNull(){
     this.set(S_TempId,null);
  }

  public long getTempId(){
        return DataType.getAsLong(this.get(S_TempId));
  
  }
  public long getTempIdInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_TempId));
      }
