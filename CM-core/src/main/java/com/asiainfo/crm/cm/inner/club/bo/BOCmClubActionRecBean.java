...
public class BOCmClubActionRecBean extends DataContainer implements DataContainerInterface,IBOCmClubActionRecValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.club.bo.BOCmClubActionRec";
  ...
  public BOCmClubActionRecBean() throws AIException{
      super(S_TYPE);
  }
