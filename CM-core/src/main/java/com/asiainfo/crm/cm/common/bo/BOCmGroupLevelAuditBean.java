...
public class BOCmGroupLevelAuditBean extends DataContainer implements DataContainerInterface,IBOCmGroupLevelAuditValue{

  private static String  m_boName = "com.asiainfo.crm.cm.common.bo.BOCmGroupLevelAudit";
  ...
  public BOCmGroupLevelAuditBean() throws AIException{
      super(S_TYPE);
  }
