...
public class BOCmAttachExportBean extends DataContainer implements DataContainerInterface,IBOCmAttachExportValue{

  private static String  m_boName = "com.asiainfo.crm.cm.common.bo.BOCmAttachExport";
  ...
  public BOCmAttachExportBean() throws AIException{
      super(S_TYPE);
  }
