...
public class BOCmContactContMediumPojoBean extends DataContainer implements DataContainerInterface,IBOCmContactContMediumPojoValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmContactContMediumPojo";
  ...
  public BOCmContactContMediumPojoBean() throws AIException{
      super(S_TYPE);
  }
