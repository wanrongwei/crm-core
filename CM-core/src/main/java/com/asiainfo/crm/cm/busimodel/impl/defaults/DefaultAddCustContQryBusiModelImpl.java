...
public class DefaultAddCustContQryBusiModelImpl extends AbstractAddCustContQryBusiModelImpl {
		...
		if (CmCommonUtil.isNotEmptyObject(conditionDCs)) {
			...
			switch (custType) {
				case CmConstants.CustomerType.INDIVIDUAL:
					parameter = ParamUtil.buildParameter(prop, QBOCmPartyContactBean.class, new String[] { IContactValue.S_PartyName });
					break;
