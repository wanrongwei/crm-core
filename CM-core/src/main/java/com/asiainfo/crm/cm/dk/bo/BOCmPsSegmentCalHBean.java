...
public class BOCmPsSegmentCalHBean extends DataContainer implements DataContainerInterface,IBOCmPsSegmentCalHValue{

  private static String  m_boName = "com.asiainfo.crm.cm.dk.bo.BOCmPsSegmentCalH";
  ...
  public BOCmPsSegmentCalHBean() throws AIException{
      super(S_TYPE);
  }
