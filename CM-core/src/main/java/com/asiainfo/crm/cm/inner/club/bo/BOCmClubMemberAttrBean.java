...
public class BOCmClubMemberAttrBean extends DataContainer implements DataContainerInterface,IBOCmClubMemberAttrValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.club.bo.BOCmClubMemberAttr";
  ...
  public BOCmClubMemberAttrBean() throws AIException{
      super(S_TYPE);
  }
