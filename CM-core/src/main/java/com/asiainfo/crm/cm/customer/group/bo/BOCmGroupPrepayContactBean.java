...
public class BOCmGroupPrepayContactBean extends DataContainer implements DataContainerInterface,IBOCmGroupPrepayContactValue{

  private static String  m_boName = "com.asiainfo.crm.cm.customer.group.bo.BOCmGroupPrepayContact";
  ...
  public BOCmGroupPrepayContactBean() throws AIException{
      super(S_TYPE);
  }
