...
public class BOLnCmUserManagerBean extends DataContainer implements DataContainerInterface,IBOLnCmUserManagerValue{

  private static String  m_boName = "com.asiainfo.crm.cm.ln.club.bo.BOLnCmUserManager";
  ...
  public BOLnCmUserManagerBean() throws AIException{
      super(S_TYPE);
  }
