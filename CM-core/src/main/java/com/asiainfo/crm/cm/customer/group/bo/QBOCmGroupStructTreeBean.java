...
public class QBOCmGroupStructTreeBean extends DataContainer implements DataContainerInterface,IQBOCmGroupStructTreeValue{

  private static String  m_boName = "com.asiainfo.crm.cm.customer.group.bo.QBOCmGroupStructTree";
  ...
  public QBOCmGroupStructTreeBean() throws AIException{
      super(S_TYPE);
  }
