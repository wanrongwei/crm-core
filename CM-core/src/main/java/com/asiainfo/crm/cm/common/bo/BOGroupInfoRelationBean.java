...
public class BOGroupInfoRelationBean extends DataContainer implements DataContainerInterface,IBOGroupInfoRelationValue{

  private static String  m_boName = "com.asiainfo.crm.cm.common.bo.BOGroupInfoRelation";
  ...
  public BOGroupInfoRelationBean() throws AIException{
      super(S_TYPE);
  }
