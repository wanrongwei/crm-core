...
public class ClubServiceCylceBean extends DataContainer implements DataContainerInterface,IClubServiceCylceValue{

  private static String  m_boName = "com.asiainfo.crm.cm.model.bo.ClubServiceCylce";
  ...
  public ClubServiceCylceBean() throws AIException{
      super(S_TYPE);
  }
