...
public class QBOCmSubGroupCustomerBean extends DataContainer implements DataContainerInterface,IQBOCmSubGroupCustomerValue{

  private static String  m_boName = "com.asiainfo.crm.cm.customer.group.bo.QBOCmSubGroupCustomer";
  ...
  public final static  String S_ParentGroupId = "PARENT_GROUP_ID";
  ...
  public QBOCmSubGroupCustomerBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initParentGroupId(long value){
     this.initProperty(S_ParentGroupId,new Long(value));
  }
  public  void setParentGroupId(long value){
     this.set(S_ParentGroupId,new Long(value));
  }
  public  void setParentGroupIdNull(){
     this.set(S_ParentGroupId,null);
  }

  public long getParentGroupId(){
        return DataType.getAsLong(this.get(S_ParentGroupId));
  
  }
  public long getParentGroupIdInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_ParentGroupId));
      }
  ...
  public void initOrganType(long value){
     this.initProperty(S_OrganType,new Long(value));
  }
  public  void setOrganType(long value){
     this.set(S_OrganType,new Long(value));
  }
  ...
  public long getOrganType(){
        return DataType.getAsLong(this.get(S_OrganType));
  
  }
  public long getOrganTypeInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_OrganType));
      }
  ...
  public void initChnlCityId(long value){
     this.initProperty(S_ChnlCityId,new Long(value));
  }
  public  void setChnlCityId(long value){
     this.set(S_ChnlCityId,new Long(value));
  }
  public  void setChnlCityIdNull(){
     this.set(S_ChnlCityId,null);
  }

  public long getChnlCityId(){
        return DataType.getAsLong(this.get(S_ChnlCityId));
  
  }
  public long getChnlCityIdInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_ChnlCityId));
      }

  public void initGroupSubRegionType(long value){
     this.initProperty(S_GroupSubRegionType,new Long(value));
  }
  public  void setGroupSubRegionType(long value){
     this.set(S_GroupSubRegionType,new Long(value));
  }
  public  void setGroupSubRegionTypeNull(){
     this.set(S_GroupSubRegionType,null);
  }

  public long getGroupSubRegionType(){
        return DataType.getAsLong(this.get(S_GroupSubRegionType));
  
  }
  public long getGroupSubRegionTypeInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_GroupSubRegionType));
      }
  ...
  public void initChnlRegionType(long value){
     this.initProperty(S_ChnlRegionType,new Long(value));
  }
  public  void setChnlRegionType(long value){
     this.set(S_ChnlRegionType,new Long(value));
  }
  public  void setChnlRegionTypeNull(){
     this.set(S_ChnlRegionType,null);
  }

  public long getChnlRegionType(){
        return DataType.getAsLong(this.get(S_ChnlRegionType));
  
  }
  public long getChnlRegionTypeInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_ChnlRegionType));
      }
