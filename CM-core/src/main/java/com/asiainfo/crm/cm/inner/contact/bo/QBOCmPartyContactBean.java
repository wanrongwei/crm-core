...
public class QBOCmPartyContactBean extends DataContainer implements DataContainerInterface,IQBOCmPartyContactValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.contact.bo.QBOCmPartyContact";
  ...
  public QBOCmPartyContactBean() throws AIException{
      super(S_TYPE);
  }
