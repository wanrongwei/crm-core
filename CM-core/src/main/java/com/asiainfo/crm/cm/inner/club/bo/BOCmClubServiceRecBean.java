...
public class BOCmClubServiceRecBean extends DataContainer implements DataContainerInterface,IBOCmClubServiceRecValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.club.bo.BOCmClubServiceRec";
  ...
  public BOCmClubServiceRecBean() throws AIException{
      super(S_TYPE);
  }
