...
public class BoCmKobHierarchyInfoErrBean extends DataContainer implements DataContainerInterface,IBoCmKobHierarchyInfoErrValue{

  private static String  m_boName = "com.asiainfo.crm.cm.common.bo.BoCmKobHierarchyInfoErr";
  ...
  public BoCmKobHierarchyInfoErrBean() throws AIException{
      super(S_TYPE);
  }
