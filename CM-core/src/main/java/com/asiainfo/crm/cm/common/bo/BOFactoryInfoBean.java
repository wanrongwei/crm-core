...
public class BOFactoryInfoBean extends DataContainer implements DataContainerInterface,IBOFactoryInfoValue{

  private static String  m_boName = "com.asiainfo.crm.cm.common.bo.BOFactoryInfo";
  ...
  public BOFactoryInfoBean() throws AIException{
      super(S_TYPE);
  }
