...
public class BOCmIAcctCreditHBean extends DataContainer implements DataContainerInterface,IBOCmIAcctCreditHValue{

  private static String  m_boName = "com.asiainfo.crm.cm.ln.account.bo.BOCmIAcctCreditH";
  ...
  public BOCmIAcctCreditHBean() throws AIException{
      super(S_TYPE);
  }
