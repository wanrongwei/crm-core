...
public class BoGroupArchivesMemberBean extends DataContainer implements DataContainerInterface,IBoGroupArchivesMemberValue{

  private static String  m_boName = "com.asiainfo.crm.cm.common.bo.BoGroupArchivesMember";
  ...
  public BoGroupArchivesMemberBean() throws AIException{
      super(S_TYPE);
  }
