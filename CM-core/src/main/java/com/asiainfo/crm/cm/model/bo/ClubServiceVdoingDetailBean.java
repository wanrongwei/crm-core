...
public class ClubServiceVdoingDetailBean extends DataContainer implements DataContainerInterface,IClubServiceVdoingDetailValue{

  private static String  m_boName = "com.asiainfo.crm.cm.model.bo.ClubServiceVdoingDetail";
  ...
  public ClubServiceVdoingDetailBean() throws AIException{
      super(S_TYPE);
  }
