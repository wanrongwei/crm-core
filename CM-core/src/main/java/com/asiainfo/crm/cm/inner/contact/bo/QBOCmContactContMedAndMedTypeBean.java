...
public class QBOCmContactContMedAndMedTypeBean extends DataContainer implements DataContainerInterface,IQBOCmContactContMedAndMedTypeValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.contact.bo.QBOCmContactContMedAndMedType";
  ...
  public QBOCmContactContMedAndMedTypeBean() throws AIException{
      super(S_TYPE);
  }
