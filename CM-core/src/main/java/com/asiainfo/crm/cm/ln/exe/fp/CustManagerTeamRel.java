...
public class CustManagerTeamRel extends AbstractFpProcessImpl{
	...
	public String getFileName() throws Exception {
		String fileName = FtpFileNamingUtil.getTodayFileName("cust_manager_team_rel", ".txt", "yyyyMMdd");
		return fileName;
	}
	...
	public void process() throws Exception {
		...
		try {
			...
			sql.append("T.MANAGER_ID, ");
			sql.append("T.ROLE_TYPE, ");
			...
			sql.append("FROM CM_CUST_MANAGER_TEAM_REL T ");
			...
			while (rs.next()) {
				...
				sBuilder.append("|");
				sBuilder.append(rs.getString(15) == null ? "" : rs.getString(15)).append("\n");
