...
public class BOCmBatchDealResultBean extends DataContainer implements DataContainerInterface,IBOCmBatchDealResultValue{

  private static String  m_boName = "com.asiainfo.crm.cm.batch.bo.BOCmBatchDealResult";
  ...
  public BOCmBatchDealResultBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initErrorReason(String value){
     this.initProperty(S_ErrorReason,value);
  }
  public  void setErrorReason(String value){
     this.set(S_ErrorReason,value);
  }
  public  void setErrorReasonNull(){
     this.set(S_ErrorReason,null);
  }

  public String getErrorReason(){
       return DataType.getAsString(this.get(S_ErrorReason));
  
  }
  public String getErrorReasonInitialValue(){
        return DataType.getAsString(this.getOldObj(S_ErrorReason));
      }
  ...
  public void initFileContent(String value){
     this.initProperty(S_FileContent,value);
  }
  public  void setFileContent(String value){
     this.set(S_FileContent,value);
  }
  public  void setFileContentNull(){
     this.set(S_FileContent,null);
  }

  public String getFileContent(){
       return DataType.getAsString(this.get(S_FileContent));
  
  }
  public String getFileContentInitialValue(){
        return DataType.getAsString(this.getOldObj(S_FileContent));
      }
  ...
  public void initBatchDataDetailId(long value){
     this.initProperty(S_BatchDataDetailId,new Long(value));
  }
  public  void setBatchDataDetailId(long value){
     this.set(S_BatchDataDetailId,new Long(value));
  }
  public  void setBatchDataDetailIdNull(){
     this.set(S_BatchDataDetailId,null);
  }

  public long getBatchDataDetailId(){
        return DataType.getAsLong(this.get(S_BatchDataDetailId));
  
  }
  public long getBatchDataDetailIdInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_BatchDataDetailId));
      }
  ...
  public void initResultType(int value){
     this.initProperty(S_ResultType,new Integer(value));
  }
  public  void setResultType(int value){
     this.set(S_ResultType,new Integer(value));
  }
  public  void setResultTypeNull(){
     this.set(S_ResultType,null);
  }

  public int getResultType(){
        return DataType.getAsInt(this.get(S_ResultType));
  
  }
  public int getResultTypeInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_ResultType));
      }
