...
public class BOLnCmInsCmRelBean extends DataContainer implements DataContainerInterface,IBOLnCmInsCmRelValue{

  private static String  m_boName = "com.asiainfo.crm.cm.ln.common.bo.BOLnCmInsCmRel";
  ...
  public BOLnCmInsCmRelBean() throws AIException{
      super(S_TYPE);
  }
