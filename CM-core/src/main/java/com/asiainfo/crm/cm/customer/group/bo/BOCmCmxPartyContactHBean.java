...
public class BOCmCmxPartyContactHBean extends DataContainer implements DataContainerInterface,IBOCmCmxPartyContactHValue{

  private static String  m_boName = "com.asiainfo.crm.cm.customer.group.bo.BOCmCmxPartyContactH";
  ...
  public BOCmCmxPartyContactHBean() throws AIException{
      super(S_TYPE);
  }
