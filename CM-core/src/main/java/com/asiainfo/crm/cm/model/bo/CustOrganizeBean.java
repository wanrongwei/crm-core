...
public class CustOrganizeBean extends DataContainer implements DataContainerInterface,ICustOrganizeValue{

  private static String  m_boName = "com.asiainfo.crm.cm.model.bo.CustOrganize";
  ...
  public CustOrganizeBean() throws AIException{
      super(S_TYPE);
  }
