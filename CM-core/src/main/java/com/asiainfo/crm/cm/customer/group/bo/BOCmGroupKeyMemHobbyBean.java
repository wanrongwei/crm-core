...
public class BOCmGroupKeyMemHobbyBean extends DataContainer implements DataContainerInterface,IBOCmGroupKeyMemHobbyValue{

  private static String  m_boName = "com.asiainfo.crm.cm.customer.group.bo.BOCmGroupKeyMemHobby";
  ...
  public BOCmGroupKeyMemHobbyBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initHobbyType(int value){
     this.initProperty(S_HobbyType,new Integer(value));
  }
  public  void setHobbyType(int value){
     this.set(S_HobbyType,new Integer(value));
  }
  public  void setHobbyTypeNull(){
     this.set(S_HobbyType,null);
  }

  public int getHobbyType(){
        return DataType.getAsInt(this.get(S_HobbyType));
  
  }
  public int getHobbyTypeInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_HobbyType));
      }

  public void initHobbyId(int value){
     this.initProperty(S_HobbyId,new Integer(value));
  }
  public  void setHobbyId(int value){
     this.set(S_HobbyId,new Integer(value));
  }
  ...
  public int getHobbyId(){
        return DataType.getAsInt(this.get(S_HobbyId));
  
  }
  public int getHobbyIdInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_HobbyId));
      }
