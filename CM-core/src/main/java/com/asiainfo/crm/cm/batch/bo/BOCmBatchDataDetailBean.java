...
public class BOCmBatchDataDetailBean extends DataContainer implements DataContainerInterface,IBOCmBatchDataDetailValue{

  private static String  m_boName = "com.asiainfo.crm.cm.batch.bo.BOCmBatchDataDetail";
  ...
  public BOCmBatchDataDetailBean() throws AIException{
      super(S_TYPE);
  }
