...
public class BOCmAccountHisBean extends DataContainer implements DataContainerInterface,IBOCmAccountHisValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.account.bo.BOCmAccountHis";
  ...
  public BOCmAccountHisBean() throws AIException{
      super(S_TYPE);
  }
