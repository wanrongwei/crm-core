...
public class BOCmxCustRealNameInfoBean extends DataContainer implements DataContainerInterface,IBOCmxCustRealNameInfoValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.customer.bo.BOCmxCustRealNameInfo";
  ...
  public BOCmxCustRealNameInfoBean() throws AIException{
      super(S_TYPE);
  }
