...
public class BOCmClubMemberCardBean extends DataContainer implements DataContainerInterface,IBOCmClubMemberCardValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.club.bo.BOCmClubMemberCard";
  ...
  public BOCmClubMemberCardBean() throws AIException{
      super(S_TYPE);
  }
