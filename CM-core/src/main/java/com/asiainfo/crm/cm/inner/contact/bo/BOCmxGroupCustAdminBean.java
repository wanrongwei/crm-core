...
public class BOCmxGroupCustAdminBean extends DataContainer implements DataContainerInterface,IBOCmxGroupCustAdminValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.contact.bo.BOCmxGroupCustAdmin";
  ...
  public BOCmxGroupCustAdminBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initAcctCode(String value){
     this.initProperty(S_AcctCode,value);
  }
  public  void setAcctCode(String value){
     this.set(S_AcctCode,value);
  }
  public  void setAcctCodeNull(){
     this.set(S_AcctCode,null);
  }

  public String getAcctCode(){
       return DataType.getAsString(this.get(S_AcctCode));
  
  }
  public String getAcctCodeInitialValue(){
        return DataType.getAsString(this.getOldObj(S_AcctCode));
      }
