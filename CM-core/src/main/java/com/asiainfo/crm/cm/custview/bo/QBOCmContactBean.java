...
public class QBOCmContactBean extends DataContainer implements DataContainerInterface,IQBOCmContactValue{

  private static String  m_boName = "com.asiainfo.crm.cm.custview.bo.QBOCmContact";
  ...
  public QBOCmContactBean() throws AIException{
      super(S_TYPE);
  }
