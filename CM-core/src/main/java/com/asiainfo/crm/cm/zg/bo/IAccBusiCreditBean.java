...
public class IAccBusiCreditBean extends DataContainer implements DataContainerInterface,IIAccBusiCreditValue{

  private static String  m_boName = "com.asiainfo.crm.cm.zg.bo.IAccBusiCredit";
  ...
  public IAccBusiCreditBean() throws AIException{
      super(S_TYPE);
  }
