...
public class BOCmBusiLogBean extends DataContainer implements DataContainerInterface,IBOCmBusiLogValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.log.bo.BOCmBusiLog";
  ...
  public BOCmBusiLogBean() throws AIException{
      super(S_TYPE);
  }
