...
public class BOCmCustAdditionalInfoHBean extends DataContainer implements DataContainerInterface,IBOCmCustAdditionalInfoHValue{

  private static String  m_boName = "com.asiainfo.crm.cm.customer.group.bo.BOCmCustAdditionalInfoH";
  ...
  public final static  String S_CustInfoId = "CUST_INFO_ID";
  ...
  public BOCmCustAdditionalInfoHBean() throws AIException{
      super(S_TYPE);
  }
...
public Timestamp getCreateDate(){
  ...
  public void initCustInfoId(long value){
	     this.initProperty(S_CustInfoId,Long.valueOf(value));
	  }
	  public  void setCustInfoId(long value){
	     this.set(S_CustInfoId,Long.valueOf(value));
	  }
	  public  void setCustInfoIdNull(){
	     this.set(S_CustInfoId,null);
	  }

	  public long getCustInfoId(){
	        return DataType.getAsLong(this.get(S_CustInfoId));
	  
	  }
	  public long getCustInfoIdInitialValue(){
	        return DataType.getAsLong(this.getOldObj(S_CustInfoId));
	      }
 }
