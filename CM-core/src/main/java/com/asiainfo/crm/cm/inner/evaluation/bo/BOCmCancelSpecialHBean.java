...
public class BOCmCancelSpecialHBean extends DataContainer implements DataContainerInterface,IBOCmCancelSpecialHValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.evaluation.bo.BOCmCancelSpecialH";
  ...
  public BOCmCancelSpecialHBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initOperState(int value){
     this.initProperty(S_OperState,new Integer(value));
  }
  public  void setOperState(int value){
     this.set(S_OperState,new Integer(value));
  }
  public  void setOperStateNull(){
     this.set(S_OperState,null);
  }

  public int getOperState(){
        return DataType.getAsInt(this.get(S_OperState));
  
  }
  public int getOperStateInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_OperState));
      }
