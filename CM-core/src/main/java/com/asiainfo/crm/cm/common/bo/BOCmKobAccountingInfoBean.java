...
public class BOCmKobAccountingInfoBean extends DataContainer implements DataContainerInterface,IBOCmKobAccountingInfoValue{

  private static String  m_boName = "com.asiainfo.crm.cm.common.bo.BOCmKobAccountingInfo";
  ...
  public BOCmKobAccountingInfoBean() throws AIException{
      super(S_TYPE);
  }
