...
public class BOCmAccountAttrBean extends DataContainer implements DataContainerInterface,IBOCmAccountAttrValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.account.bo.BOCmAccountAttr";
  ...
  public BOCmAccountAttrBean() throws AIException{
      super(S_TYPE);
  }
