...
public class SQueryTransactionFeeReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.BusiSpecId[] busiSpecIdList;
    ...
    public SQueryTransactionFeeReq(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.BusiSpecId[] busiSpecIdList) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.BusiSpecId[] getBusiSpecIdList() {
        return busiSpecIdList;
    }
     ...
     */
    public void setBusiSpecIdList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.BusiSpecId[] busiSpecIdList) {
        this.busiSpecIdList = busiSpecIdList;
    }
