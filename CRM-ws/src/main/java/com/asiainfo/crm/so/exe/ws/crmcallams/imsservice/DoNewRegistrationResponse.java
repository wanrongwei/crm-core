...
public class DoNewRegistrationResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.CrmBaseResponse  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SUserResult[] userResultList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductOrderResult[] prodResultList;
    ...
    public DoNewRegistrationResponse(
           ...
           long[] acctIds,
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SUserResult[] userResultList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductOrderResult[] prodResultList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SUserResult[] getUserResultList() {
        return userResultList;
    }
     ...
     */
    public void setUserResultList(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SUserResult[] userResultList) {
        this.userResultList = userResultList;
    }
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductOrderResult[] getProdResultList() {
        return prodResultList;
    }
     ...
     */
    public void setProdResultList(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductOrderResult[] prodResultList) {
        this.prodResultList = prodResultList;
    }
