...
public class DoNetaxeptQueryResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.NetaxeptPaymentInfo paymentInfo;
    ...
    public DoNetaxeptQueryResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.NetaxeptPaymentInfo paymentInfo) {
        super(
            responseHead);
     ...
     * @return paymentInfo
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.NetaxeptPaymentInfo getPaymentInfo() {
        return paymentInfo;
    }
     ...
     * @param paymentInfo
     */
    public void setPaymentInfo(com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.NetaxeptPaymentInfo paymentInfo) {
        this.paymentInfo = paymentInfo;
    }
