...
public class QueryFreeResourceRatingResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SFreeResource[] sfreeResourceListOut;
    ...
    public QueryFreeResourceRatingResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SFreeResource[] sfreeResourceListOut) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SFreeResource[] getSfreeResourceListOut() {
        return sfreeResourceListOut;
    }
     ...
     */
    public void setSfreeResourceListOut(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SFreeResource[] sfreeResourceListOut) {
        this.sfreeResourceListOut = sfreeResourceListOut;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SFreeResource getSfreeResourceListOut(int i) {
        return this.sfreeResourceListOut[i];
    }

    public void setSfreeResourceListOut(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SFreeResource _value) {
