...
public class DoQueryPointInfoResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.QryPointOut[] qryPointOutList;
    ...
    public DoQueryPointInfoResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.QryPointOut[] qryPointOutList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.QryPointOut[] getQryPointOutList() {
        return qryPointOutList;
    }
     ...
     */
    public void setQryPointOutList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.QryPointOut[] qryPointOutList) {
        this.qryPointOutList = qryPointOutList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.QryPointOut getQryPointOutList(int i) {
        return this.qryPointOutList[i];
    }

    public void setQryPointOutList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.QryPointOut _value) {
