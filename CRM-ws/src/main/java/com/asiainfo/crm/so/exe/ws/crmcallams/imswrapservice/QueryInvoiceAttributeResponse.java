...
public class QueryInvoiceAttributeResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CaFileStorage[] invoiceUrlList;
    ...
    public QueryInvoiceAttributeResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CaFileStorage[] invoiceUrlList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CaFileStorage[] getInvoiceUrlList() {
        return invoiceUrlList;
    }
     ...
     */
    public void setInvoiceUrlList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CaFileStorage[] invoiceUrlList) {
        this.invoiceUrlList = invoiceUrlList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CaFileStorage getInvoiceUrlList(int i) {
        return this.invoiceUrlList[i];
    }

    public void setInvoiceUrlList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CaFileStorage _value) {
