...
public class SQueryAccountInfoResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SBillingAddressInfo billingAddressInfo;
    ...
    public SQueryAccountInfoResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SBillingAddressInfo billingAddressInfo) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SBillingAddressInfo getBillingAddressInfo() {
        return billingAddressInfo;
    }
     ...
     */
    public void setBillingAddressInfo(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SBillingAddressInfo billingAddressInfo) {
        this.billingAddressInfo = billingAddressInfo;
    }
