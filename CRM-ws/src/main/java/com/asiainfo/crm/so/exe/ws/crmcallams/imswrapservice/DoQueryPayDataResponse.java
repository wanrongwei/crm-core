...
public class DoQueryPayDataResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SPrintOutResponse sPrintOutResponse;
    ...
    public DoQueryPayDataResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SPrintOutResponse sPrintOutResponse) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SPrintOutResponse getSPrintOutResponse() {
        return sPrintOutResponse;
    }
     ...
     */
    public void setSPrintOutResponse(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SPrintOutResponse sPrintOutResponse) {
        this.sPrintOutResponse = sPrintOutResponse;
    }
