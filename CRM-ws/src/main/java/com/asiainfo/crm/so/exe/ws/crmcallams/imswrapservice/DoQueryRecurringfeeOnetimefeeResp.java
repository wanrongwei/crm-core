...
public class DoQueryRecurringfeeOnetimefeeResp  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.RecurringOnetimeFee[] recurringOnetimeFeeList;
    ...
    public DoQueryRecurringfeeOnetimefeeResp(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.RecurringOnetimeFee[] recurringOnetimeFeeList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.RecurringOnetimeFee[] getRecurringOnetimeFeeList() {
        return recurringOnetimeFeeList;
    }
     ...
     */
    public void setRecurringOnetimeFeeList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.RecurringOnetimeFee[] recurringOnetimeFeeList) {
        this.recurringOnetimeFeeList = recurringOnetimeFeeList;
    }
