...
public class FnOper  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.Fn[] fN_list;
    ...
    public FnOper(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.Fn[] fN_list) {
     ...
     * @return fN_list
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.Fn[] getFN_list() {
        return fN_list;
    }
     ...
     * @param fN_list
     */
    public void setFN_list(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.Fn[] fN_list) {
        this.fN_list = fN_list;
    }
