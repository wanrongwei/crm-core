...
public class DoQueryAllowanceDtlResp  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AllowanceDtlBo[] dtlList;
    ...
    public DoQueryAllowanceDtlResp(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AllowanceDtlBo[] dtlList) {
        super(
            responseHead);
     ...
     * @return dtlList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AllowanceDtlBo[] getDtlList() {
        return dtlList;
    }
     ...
     * @param dtlList
     */
    public void setDtlList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AllowanceDtlBo[] dtlList) {
        this.dtlList = dtlList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AllowanceDtlBo getDtlList(int i) {
        return this.dtlList[i];
    }

    public void setDtlList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AllowanceDtlBo _value) {
