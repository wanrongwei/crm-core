...
public class PcrfInfo  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.PccRule[] pccRules;
    ...
    public PcrfInfo(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.PccRule[] pccRules) {
     ...
     * @return pccRules
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.PccRule[] getPccRules() {
        return pccRules;
    }
     ...
     * @param pccRules
     */
    public void setPccRules(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.PccRule[] pccRules) {
        this.pccRules = pccRules;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.PccRule getPccRules(int i) {
        return this.pccRules[i];
    }

    public void setPccRules(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.PccRule _value) {
