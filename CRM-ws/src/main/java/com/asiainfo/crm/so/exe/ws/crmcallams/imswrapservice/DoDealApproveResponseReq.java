...
public class DoDealApproveResponseReq  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SApproveResult approveResult;

    public DoDealApproveResponseReq() {
    }

    public DoDealApproveResponseReq(
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SApproveResult approveResult) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SApproveResult getApproveResult() {
        return approveResult;
    }
     ...
     * @param approveResult
     */
    public void setApproveResult(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SApproveResult approveResult) {
        this.approveResult = approveResult;
    }
