...
public class DoUnifiedPayResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SInsertOrderRet insertOrderRet;
    ...
    public DoUnifiedPayResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SInsertOrderRet insertOrderRet) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SInsertOrderRet getInsertOrderRet() {
        return insertOrderRet;
    }
     ...
     */
    public void setInsertOrderRet(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SInsertOrderRet insertOrderRet) {
        this.insertOrderRet = insertOrderRet;
    }
