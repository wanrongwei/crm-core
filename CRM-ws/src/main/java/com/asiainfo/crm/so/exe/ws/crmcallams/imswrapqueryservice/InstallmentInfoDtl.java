...
public class InstallmentInfoDtl  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.Plan[] details;
    ...
    public InstallmentInfoDtl(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.Plan[] details,
     ...
     * @return details
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.Plan[] getDetails() {
        return details;
    }
     ...
     * @param details
     */
    public void setDetails(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.Plan[] details) {
        this.details = details;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.Plan getDetails(int i) {
        return this.details[i];
    }

    public void setDetails(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.Plan _value) {
