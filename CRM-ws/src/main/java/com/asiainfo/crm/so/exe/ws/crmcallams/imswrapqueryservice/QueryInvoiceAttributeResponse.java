...
public class QueryInvoiceAttributeResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CaFileStorage[] invoiceUrlList;
    ...
    public QueryInvoiceAttributeResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CaFileStorage[] invoiceUrlList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CaFileStorage[] getInvoiceUrlList() {
        return invoiceUrlList;
    }
     ...
     */
    public void setInvoiceUrlList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CaFileStorage[] invoiceUrlList) {
        this.invoiceUrlList = invoiceUrlList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CaFileStorage getInvoiceUrlList(int i) {
        return this.invoiceUrlList[i];
    }

    public void setInvoiceUrlList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CaFileStorage _value) {
