...
public class DoTransferResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SBalance[] sBalanceList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.FreeResource[] freeResourceList;
    ...
    public DoTransferResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SBalance[] sBalanceList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.FreeResource[] freeResourceList) {
        super(
            responseHead);
     ...
     * @return sBalanceList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SBalance[] getSBalanceList() {
        return sBalanceList;
    }
     ...
     * @param sBalanceList
     */
    public void setSBalanceList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SBalance[] sBalanceList) {
        this.sBalanceList = sBalanceList;
    }
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.FreeResource[] getFreeResourceList() {
        return freeResourceList;
    }
     ...
     */
    public void setFreeResourceList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.FreeResource[] freeResourceList) {
        this.freeResourceList = freeResourceList;
    }
