...
public class SPrintOutResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SPrintOut sPrintOut;

    public SPrintOutResponse() {
    }

    public SPrintOutResponse(
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SPrintOut sPrintOut) {
     ...
     * @return sPrintOut
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SPrintOut getSPrintOut() {
        return sPrintOut;
    }
     ...
     * @param sPrintOut
     */
    public void setSPrintOut(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SPrintOut sPrintOut) {
        this.sPrintOut = sPrintOut;
    }
