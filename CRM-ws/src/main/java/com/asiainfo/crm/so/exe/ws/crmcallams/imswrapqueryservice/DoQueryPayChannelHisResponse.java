...
public class DoQueryPayChannelHisResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.PayChannelHisInfo[] payChannelHisInfoList;
    ...
    public DoQueryPayChannelHisResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.PayChannelHisInfo[] payChannelHisInfoList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.PayChannelHisInfo[] getPayChannelHisInfoList() {
        return payChannelHisInfoList;
    }
     ...
     */
    public void setPayChannelHisInfoList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.PayChannelHisInfo[] payChannelHisInfoList) {
        this.payChannelHisInfoList = payChannelHisInfoList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.PayChannelHisInfo getPayChannelHisInfoList(int i) {
        return this.payChannelHisInfoList[i];
    }

    public void setPayChannelHisInfoList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.PayChannelHisInfo _value) {
