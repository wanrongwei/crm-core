...
public class DoQueryTaxResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.STaxFee[] sTaxFeeList;
    ...
    public DoQueryTaxResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.STaxFee[] sTaxFeeList) {
        super(
            responseHead);
     ...
     * @return sTaxFeeList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.STaxFee[] getSTaxFeeList() {
        return sTaxFeeList;
    }
     ...
     * @param sTaxFeeList
     */
    public void setSTaxFeeList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.STaxFee[] sTaxFeeList) {
        this.sTaxFeeList = sTaxFeeList;
    }
