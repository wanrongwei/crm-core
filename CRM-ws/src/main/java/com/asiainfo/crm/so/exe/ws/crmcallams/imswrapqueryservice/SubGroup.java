...
public class SubGroup  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SProductOrderOper[] productOrderOperList;
    ...
    public SubGroup(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SProductOrderOper[] productOrderOperList) {
    ...
    /**
     * Gets the outer_group_id value for this SubGroup.
     * 
    ...
    /**
     * Sets the outer_group_id value for this SubGroup.
     * 
    ...
    /**
     * Gets the group_id value for this SubGroup.
     * 
     * @return group_id
     */
    ...
    /**
     * Sets the group_id value for this SubGroup.
     * 
     * @param group_id
     */
    ...
    /**
     * Gets the productOrderOperList value for this SubGroup.
     * 
     * @return productOrderOperList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SProductOrderOper[] getProductOrderOperList() {
        return productOrderOperList;
    }


    /**
     * Sets the productOrderOperList value for this SubGroup.
     * 
     * @param productOrderOperList
     */
    public void setProductOrderOperList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SProductOrderOper[] productOrderOperList) {
        this.productOrderOperList = productOrderOperList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://imsintf.service.openbilling.ailk.com/", "subGroup"));
