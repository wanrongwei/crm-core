...
public class SRegretRefundReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SRegretOrderInfo[] orderList;
    ...
    public SRegretRefundReq(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SRegretOrderInfo[] orderList) {
     ...
     * @return orderList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SRegretOrderInfo[] getOrderList() {
        return orderList;
    }
     ...
     * @param orderList
     */
    public void setOrderList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SRegretOrderInfo[] orderList) {
        this.orderList = orderList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SRegretOrderInfo getOrderList(int i) {
        return this.orderList[i];
    }

    public void setOrderList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SRegretOrderInfo _value) {
