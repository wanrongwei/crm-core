...
public class RenewRegistration  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductOrder[] productList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SAccount account;
    ...
    public RenewRegistration(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductOrder[] productList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SAccount account,
     ...
     * @return productList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductOrder[] getProductList() {
        return productList;
    }
     ...
     * @param productList
     */
    public void setProductList(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductOrder[] productList) {
        this.productList = productList;
    }
     ...
     * @return account
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SAccount getAccount() {
        return account;
    }
     ...
     * @param account
     */
    public void setAccount(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SAccount account) {
        this.account = account;
    }
