...
public class DoQueryNotifyHisResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.NotificationHistory[] notify_his_list;
    ...
    public DoQueryNotifyHisResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.NotificationHistory[] notify_his_list) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.NotificationHistory[] getNotify_his_list() {
        return notify_his_list;
    }
     ...
     */
    public void setNotify_his_list(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.NotificationHistory[] notify_his_list) {
        this.notify_his_list = notify_his_list;
    }
