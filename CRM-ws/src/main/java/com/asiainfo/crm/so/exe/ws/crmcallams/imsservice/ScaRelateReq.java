...
public class ScaRelateReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SubCA[] sub_ca_list;
    ...
    public ScaRelateReq(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SubCA[] sub_ca_list) {
     ...
     * @return sub_ca_list
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SubCA[] getSub_ca_list() {
        return sub_ca_list;
    }
     ...
     * @param sub_ca_list
     */
    public void setSub_ca_list(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SubCA[] sub_ca_list) {
        this.sub_ca_list = sub_ca_list;
    }
