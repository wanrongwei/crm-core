...
public class CustomerInformation  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.companyRegistrationNumber==null && other.getCompanyRegistrationNumber()==null) || 
             (this.companyRegistrationNumber!=null &&
              this.companyRegistrationNumber.equals(other.getCompanyRegistrationNumber()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getCompanyRegistrationNumber() != null) {
            _hashCode += getCompanyRegistrationNumber().hashCode();
        }
        if (getCountry() != null) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://imsintf.service.openbilling.ailk.com/", "customerInformation"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "CompanyRegistrationNumber"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
