...
public class DoSetMaxFreeResourceResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.MaxFreeResourceResponse maxFreeResourceResponseList;
    ...
    public DoSetMaxFreeResourceResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.MaxFreeResourceResponse maxFreeResourceResponseList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.MaxFreeResourceResponse getMaxFreeResourceResponseList() {
        return maxFreeResourceResponseList;
    }
     ...
     */
    public void setMaxFreeResourceResponseList(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.MaxFreeResourceResponse maxFreeResourceResponseList) {
        this.maxFreeResourceResponseList = maxFreeResourceResponseList;
    }
