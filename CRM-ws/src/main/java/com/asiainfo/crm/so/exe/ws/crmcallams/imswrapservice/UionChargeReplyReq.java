...
public class UionChargeReplyReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.PayInfo[] payInfoList;
    ...
    public UionChargeReplyReq(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.PayInfo[] payInfoList) {
           this.acctId = acctId;
     ...
     * @return payInfoList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.PayInfo[] getPayInfoList() {
        return payInfoList;
    }
     ...
     * @param payInfoList
     */
    public void setPayInfoList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.PayInfo[] payInfoList) {
        this.payInfoList = payInfoList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.PayInfo getPayInfoList(int i) {
        return this.payInfoList[i];
    }

    public void setPayInfoList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.PayInfo _value) {
