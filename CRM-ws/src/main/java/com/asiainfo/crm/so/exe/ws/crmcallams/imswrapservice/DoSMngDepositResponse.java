...
public class DoSMngDepositResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SDepositResp sDepositResp;
    ...
    public DoSMngDepositResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SDepositResp sDepositResp) {
        super(
            responseHead);
     ...
     * @return sDepositResp
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SDepositResp getSDepositResp() {
        return sDepositResp;
    }
     ...
     * @param sDepositResp
     */
    public void setSDepositResp(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SDepositResp sDepositResp) {
        this.sDepositResp = sDepositResp;
    }
