...
public class DoQueryAcctDetailByCustResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.InnerBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SacctDetailByCustBean[] acctDetailList;

    public DoQueryAcctDetailByCustResponse() {
    }

    public DoQueryAcctDetailByCustResponse(
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CbsErrorMsg errorMsg,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SPage sPage,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SacctDetailByCustBean[] acctDetailList) {
        super(
            errorMsg,
            sPage);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SacctDetailByCustBean[] getAcctDetailList() {
        return acctDetailList;
    }
     ...
     */
    public void setAcctDetailList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SacctDetailByCustBean[] acctDetailList) {
        this.acctDetailList = acctDetailList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SacctDetailByCustBean getAcctDetailList(int i) {
        return this.acctDetailList[i];
    }

    public void setAcctDetailList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SacctDetailByCustBean _value) {
