...
public class IImsQueryService_ServiceLocator extends org.apache.axis.client.Service implements com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.IImsQueryService_Service {
    private static transient Log log = LogFactory.getLog(IImsQueryService_ServiceLocator.class);
    ...
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.IImsQueryServiceWs getIImsQueryService() throws javax.xml.rpc.ServiceException {
    ...
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.IImsQueryServiceWs getIImsQueryService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.IImsQueryServiceSoapBindingStub _stub = new com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.IImsQueryServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.IImsQueryServiceWs.class.isAssignableFrom(serviceEndpointInterface)) {
                com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.IImsQueryServiceSoapBindingStub _stub = new com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.IImsQueryServiceSoapBindingStub(new java.net.URL(IImsQueryService_address), this);
                _stub.setPortName(getIImsQueryServiceWSDDServiceName());
                return _stub;
            }
        }
