...
public class DoQueryRegretStsResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQueryRegretOut queryOut;
    ...
    public DoQueryRegretStsResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQueryRegretOut queryOut) {
        super(
            responseHead);
     ...
     * @return queryOut
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQueryRegretOut getQueryOut() {
        return queryOut;
    }
     ...
     * @param queryOut
     */
    public void setQueryOut(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQueryRegretOut queryOut) {
        this.queryOut = queryOut;
    }
