...
public class IImsWrapServiceRemoteLocator extends org.apache.axis.client.Service implements com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.IImsWrapServiceRemote {
    ...
    private java.lang.String IImsWrapService_address = "http://10.10.12.84:8180/infosystem/ws/imsintf_iImsWrapService";
    ...
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.IImsWrapServiceWs getIImsWrapService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.IImsWrapServiceRemoteSoapBindingStub _stub = new com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.IImsWrapServiceRemoteSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.IImsWrapServiceWs.class.isAssignableFrom(serviceEndpointInterface)) {
                com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.IImsWrapServiceRemoteSoapBindingStub _stub = new com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.IImsWrapServiceRemoteSoapBindingStub(new java.net.URL(IImsWrapService_address), this);
                _stub.setPortName(getIImsWrapServiceWSDDServiceName());
                return _stub;
            }
        }
