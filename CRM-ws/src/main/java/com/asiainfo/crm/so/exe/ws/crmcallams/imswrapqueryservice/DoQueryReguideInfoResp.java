...
public class DoQueryReguideInfoResp  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.ReguideInfo[] reguideInfoList;
    ...
    public DoQueryReguideInfoResp(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.ReguideInfo[] reguideInfoList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.ReguideInfo[] getReguideInfoList() {
        return reguideInfoList;
    }
     ...
     */
    public void setReguideInfoList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.ReguideInfo[] reguideInfoList) {
        this.reguideInfoList = reguideInfoList;
    }
