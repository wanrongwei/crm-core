...
public class DoQueryServiceStateResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.ServiceStateResult[] service_state_list;
    ...
    public DoQueryServiceStateResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.ServiceStateResult[] service_state_list) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.ServiceStateResult[] getService_state_list() {
        return service_state_list;
    }
     ...
     */
    public void setService_state_list(com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.ServiceStateResult[] service_state_list) {
        this.service_state_list = service_state_list;
    }
