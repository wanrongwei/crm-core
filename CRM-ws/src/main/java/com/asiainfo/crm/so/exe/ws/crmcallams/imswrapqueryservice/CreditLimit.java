...
public class CreditLimit  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SubscriberExempt[] subscriberExemptList;
    ...
    public CreditLimit(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SubscriberExempt[] subscriberExemptList,
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SubscriberExempt[] getSubscriberExemptList() {
        return subscriberExemptList;
    }
     ...
     */
    public void setSubscriberExemptList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SubscriberExempt[] subscriberExemptList) {
        this.subscriberExemptList = subscriberExemptList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SubscriberExempt getSubscriberExemptList(int i) {
        return this.subscriberExemptList[i];
    }

    public void setSubscriberExemptList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SubscriberExempt _value) {
