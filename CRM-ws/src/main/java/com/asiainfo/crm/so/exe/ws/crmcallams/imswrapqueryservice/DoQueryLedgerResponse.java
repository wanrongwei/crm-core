...
public class DoQueryLedgerResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQueryLedgerOut[] ledgerOutList;
    ...
    public DoQueryLedgerResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQueryLedgerOut[] ledgerOutList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQueryLedgerOut[] getLedgerOutList() {
        return ledgerOutList;
    }
     ...
     * @param ledgerOutList
     */
    public void setLedgerOutList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQueryLedgerOut[] ledgerOutList) {
        this.ledgerOutList = ledgerOutList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQueryLedgerOut getLedgerOutList(int i) {
        return this.ledgerOutList[i];
    }

    public void setLedgerOutList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQueryLedgerOut _value) {
