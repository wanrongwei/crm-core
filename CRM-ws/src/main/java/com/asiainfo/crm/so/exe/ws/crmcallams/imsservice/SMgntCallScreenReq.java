...
public class SMgntCallScreenReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SCallScreenNo[] no_list;
    ...
    public SMgntCallScreenReq(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SCallScreenNo[] no_list) {
     ...
     * @return no_list
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SCallScreenNo[] getNo_list() {
        return no_list;
    }
     ...
     * @param no_list
     */
    public void setNo_list(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SCallScreenNo[] no_list) {
        this.no_list = no_list;
    }
