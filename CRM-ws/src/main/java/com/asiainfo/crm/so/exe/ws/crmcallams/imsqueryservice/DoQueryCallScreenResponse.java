...
public class DoQueryCallScreenResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.CrmBaseResponse  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SCallScreenNo[] callscreen_list;
    ...
    public DoQueryCallScreenResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SCallScreenNo[] callscreen_list) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SCallScreenNo[] getCallscreen_list() {
        return callscreen_list;
    }
     ...
     */
    public void setCallscreen_list(com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SCallScreenNo[] callscreen_list) {
        this.callscreen_list = callscreen_list;
    }
