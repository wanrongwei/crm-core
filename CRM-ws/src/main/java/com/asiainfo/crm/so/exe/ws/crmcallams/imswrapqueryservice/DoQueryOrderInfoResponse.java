...
public class DoQueryOrderInfoResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQryOrderOut[] qryOrderOut;
    ...
    public DoQueryOrderInfoResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQryOrderOut[] qryOrderOut) {
        super(
            responseHead);
     ...
     * @return qryOrderOut
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQryOrderOut[] getQryOrderOut() {
        return qryOrderOut;
    }
     ...
     * @param qryOrderOut
     */
    public void setQryOrderOut(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQryOrderOut[] qryOrderOut) {
        this.qryOrderOut = qryOrderOut;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQryOrderOut getQryOrderOut(int i) {
        return this.qryOrderOut[i];
    }

    public void setQryOrderOut(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQryOrderOut _value) {
