...
public class IImsWrapQueryService_ServiceLocator extends org.apache.axis.client.Service implements com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.IImsWrapQueryService_Service {
    ...
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.IImsWrapQueryServiceWs getIImsWrapQueryService() throws javax.xml.rpc.ServiceException {
    ...
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.IImsWrapQueryServiceWs getIImsWrapQueryService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.IImsWrapQueryServiceSoapBindingStub _stub = new com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.IImsWrapQueryServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.IImsWrapQueryServiceWs.class.isAssignableFrom(serviceEndpointInterface)) {
                com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.IImsWrapQueryServiceSoapBindingStub _stub = new com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.IImsWrapQueryServiceSoapBindingStub(new java.net.URL(IImsWrapQueryService_address), this);
                _stub.setPortName(getIImsWrapQueryServiceWSDDServiceName());
                return _stub;
            }
        }
