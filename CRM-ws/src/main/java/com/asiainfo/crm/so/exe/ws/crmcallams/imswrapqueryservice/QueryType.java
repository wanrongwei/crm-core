...
public class QueryType  implements java.io.Serializable {
    ...
    /**
     * Gets the queryType value for this QueryType.
     * 
     * @return queryType
     */
    ...
    /**
     * Sets the queryType value for this QueryType.
     * 
     * @param queryType
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://imsintf.service.openbilling.ailk.com/", "queryType"));
