...
public class SBusiServiceOper  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SBusiService busiService;
    ...
    public SBusiServiceOper(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SBusiService busiService) {
     ...
     * @return busiService
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SBusiService getBusiService() {
        return busiService;
    }
     ...
     * @param busiService
     */
    public void setBusiService(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SBusiService busiService) {
        this.busiService = busiService;
    }
