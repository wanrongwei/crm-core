...
public class DoQueryUsersByBssResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SUser[] userList;
    ...
    public DoQueryUsersByBssResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SUser[] userList) {
        super(
            responseHead);
     ...
     * @return userList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SUser[] getUserList() {
        return userList;
    }
     ...
     * @param userList
     */
    public void setUserList(com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SUser[] userList) {
        this.userList = userList;
    }
