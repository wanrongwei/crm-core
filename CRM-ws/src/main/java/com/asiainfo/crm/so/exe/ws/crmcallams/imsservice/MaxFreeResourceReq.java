...
public class MaxFreeResourceReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.PhoneItem[] phoneItemList;
    ...
    public MaxFreeResourceReq(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.PhoneItem[] phoneItemList) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.PhoneItem[] getPhoneItemList() {
        return phoneItemList;
    }
     ...
     * @param phoneItemList
     */
    public void setPhoneItemList(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.PhoneItem[] phoneItemList) {
        this.phoneItemList = phoneItemList;
    }
