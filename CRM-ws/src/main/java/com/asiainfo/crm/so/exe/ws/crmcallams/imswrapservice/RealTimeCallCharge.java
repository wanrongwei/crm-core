...
public class RealTimeCallCharge  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CallDetail[] callDetailList;
    ...
    public RealTimeCallCharge(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CallDetail[] callDetailList) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CallDetail[] getCallDetailList() {
        return callDetailList;
    }
     ...
     */
    public void setCallDetailList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CallDetail[] callDetailList) {
        this.callDetailList = callDetailList;
    }
