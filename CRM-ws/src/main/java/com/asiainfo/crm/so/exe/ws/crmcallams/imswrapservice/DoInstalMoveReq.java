...
public class DoInstalMoveReq  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SCancelInstal[] cancelInstals;
    ...
    public DoInstalMoveReq(
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SCancelInstal[] cancelInstals,
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SCancelInstal[] getCancelInstals() {
        return cancelInstals;
    }
     ...
     * @param cancelInstals
     */
    public void setCancelInstals(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SCancelInstal[] cancelInstals) {
        this.cancelInstals = cancelInstals;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SCancelInstal getCancelInstals(int i) {
        return this.cancelInstals[i];
    }

    public void setCancelInstals(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SCancelInstal _value) {
