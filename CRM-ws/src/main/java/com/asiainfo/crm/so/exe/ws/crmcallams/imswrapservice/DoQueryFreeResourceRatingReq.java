...
public class DoQueryFreeResourceRatingReq  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SQryBalance sqryBalanceIn;

    public DoQueryFreeResourceRatingReq() {
    }

    public DoQueryFreeResourceRatingReq(
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SQryBalance sqryBalanceIn) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SQryBalance getSqryBalanceIn() {
        return sqryBalanceIn;
    }
     ...
     * @param sqryBalanceIn
     */
    public void setSqryBalanceIn(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SQryBalance sqryBalanceIn) {
        this.sqryBalanceIn = sqryBalanceIn;
    }
