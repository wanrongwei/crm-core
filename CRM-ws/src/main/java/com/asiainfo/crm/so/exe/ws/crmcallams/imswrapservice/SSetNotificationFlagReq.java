...
public class SSetNotificationFlagReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.NotifyOper[][] notifyOperList;
    ...
    public SSetNotificationFlagReq(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.NotifyOper[][] notifyOperList,
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.NotifyOper[][] getNotifyOperList() {
        return notifyOperList;
    }
     ...
     */
    public void setNotifyOperList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.NotifyOper[][] notifyOperList) {
        this.notifyOperList = notifyOperList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.NotifyOper[] getNotifyOperList(int i) {
        return this.notifyOperList[i];
    }

    public void setNotifyOperList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.NotifyOper[] _value) {
