...
public class InnerBaseResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.BaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.CbsErrorMsg errorMsg;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SPage sPage;
     ...
     * @return errorMsg
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.CbsErrorMsg getErrorMsg() {
        return errorMsg;
    }
     ...
     * @param errorMsg
     */
    public void setErrorMsg(com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.CbsErrorMsg errorMsg) {
        this.errorMsg = errorMsg;
    }
     ...
     * @return sPage
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SPage getSPage() {
        return sPage;
    }
     ...
     * @param sPage
     */
    public void setSPage(com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SPage sPage) {
        this.sPage = sPage;
    }
