...
public class DoAdjustBalanceResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SBalanceAdjustResponse sBalanceAdjustResponse;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.FreeResource[] freeResourceListAdjustResponse;
    ...
    public DoAdjustBalanceResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SBalanceAdjustResponse sBalanceAdjustResponse,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.FreeResource[] freeResourceListAdjustResponse) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SBalanceAdjustResponse getSBalanceAdjustResponse() {
        return sBalanceAdjustResponse;
    }
     ...
     */
    public void setSBalanceAdjustResponse(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SBalanceAdjustResponse sBalanceAdjustResponse) {
        this.sBalanceAdjustResponse = sBalanceAdjustResponse;
    }
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.FreeResource[] getFreeResourceListAdjustResponse() {
        return freeResourceListAdjustResponse;
    }
     ...
     */
    public void setFreeResourceListAdjustResponse(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.FreeResource[] freeResourceListAdjustResponse) {
        this.freeResourceListAdjustResponse = freeResourceListAdjustResponse;
    }
