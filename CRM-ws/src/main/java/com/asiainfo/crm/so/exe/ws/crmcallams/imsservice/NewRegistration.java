...
public class NewRegistration  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SCustomer customer;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SAccount[] accountList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SUser[] userList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductOrder[] productOrderList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SContact[] contactList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SUserAuth[] userAuthList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SBalance[] balanceList;

    public NewRegistration() {
    }

    public NewRegistration(
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SCustomer customer,
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SAccount[] accountList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SUser[] userList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductOrder[] productOrderList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SContact[] contactList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SUserAuth[] userAuthList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SBalance[] balanceList) {
     ...
     * @return customer
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SCustomer getCustomer() {
        return customer;
    }
     ...
     * @param customer
     */
    public void setCustomer(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SCustomer customer) {
        this.customer = customer;
    }
     ...
     * @return accountList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SAccount[] getAccountList() {
        return accountList;
    }
     ...
     * @param accountList
     */
    public void setAccountList(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SAccount[] accountList) {
        this.accountList = accountList;
    }
     ...
     * @return userList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SUser[] getUserList() {
        return userList;
    }
     ...
     * @param userList
     */
    public void setUserList(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SUser[] userList) {
        this.userList = userList;
    }
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductOrder[] getProductOrderList() {
        return productOrderList;
    }
     ...
     */
    public void setProductOrderList(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductOrder[] productOrderList) {
        this.productOrderList = productOrderList;
    }
     ...
     * @return userAuthList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SUserAuth[] getUserAuthList() {
        return userAuthList;
    }
     ...
     * @param userAuthList
     */
    public void setUserAuthList(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SUserAuth[] userAuthList) {
        this.userAuthList = userAuthList;
    }
     ...
     * @return balanceList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SBalance[] getBalanceList() {
        return balanceList;
    }
     ...
     * @param balanceList
     */
    public void setBalanceList(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SBalance[] balanceList) {
        this.balanceList = balanceList;
    }
