...
public class DoQueryUnOrderFeeResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.InnerBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SProductFee[] productFeeList;
    ...
    public DoQueryUnOrderFeeResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SProductFee[] productFeeList) {
        super(
            errorMsg,
            sPage);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SProductFee[] getProductFeeList() {
        return productFeeList;
    }
     ...
     */
    public void setProductFeeList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SProductFee[] productFeeList) {
        this.productFeeList = productFeeList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SProductFee getProductFeeList(int i) {
        return this.productFeeList[i];
    }

    public void setProductFeeList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SProductFee _value) {
