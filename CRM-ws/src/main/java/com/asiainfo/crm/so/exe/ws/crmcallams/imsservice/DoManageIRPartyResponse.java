...
public class DoManageIRPartyResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.IrResponse[] iRResponseList;
    ...
    public DoManageIRPartyResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.IrResponse[] iRResponseList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.IrResponse[] getIRResponseList() {
        return iRResponseList;
    }
     ...
     */
    public void setIRResponseList(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.IrResponse[] iRResponseList) {
        this.iRResponseList = iRResponseList;
    }
