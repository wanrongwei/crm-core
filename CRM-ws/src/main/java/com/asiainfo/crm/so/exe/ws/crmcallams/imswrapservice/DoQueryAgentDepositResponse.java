...
public class DoQueryAgentDepositResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsAgentDepositQueryResult[] agentDepositQueryResultList;
    ...
    public DoQueryAgentDepositResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsAgentDepositQueryResult[] agentDepositQueryResultList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsAgentDepositQueryResult[] getAgentDepositQueryResultList() {
        return agentDepositQueryResultList;
    }
     ...
     */
    public void setAgentDepositQueryResultList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsAgentDepositQueryResult[] agentDepositQueryResultList) {
        this.agentDepositQueryResultList = agentDepositQueryResultList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsAgentDepositQueryResult getAgentDepositQueryResultList(int i) {
        return this.agentDepositQueryResultList[i];
    }

    public void setAgentDepositQueryResultList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsAgentDepositQueryResult _value) {
