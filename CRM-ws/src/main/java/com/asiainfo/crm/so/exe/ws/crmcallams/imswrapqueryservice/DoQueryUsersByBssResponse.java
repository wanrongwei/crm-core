...
public class DoQueryUsersByBssResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SUser[] userList;
    ...
    public DoQueryUsersByBssResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SUser[] userList) {
        super(
            responseHead);
     ...
     * @return userList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SUser[] getUserList() {
        return userList;
    }
     ...
     * @param userList
     */
    public void setUserList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SUser[] userList) {
        this.userList = userList;
    }
