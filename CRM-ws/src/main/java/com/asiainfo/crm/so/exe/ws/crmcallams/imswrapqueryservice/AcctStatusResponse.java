...
public class AcctStatusResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AcctStatus acctStatus;
    ...
    public AcctStatusResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AcctStatus acctStatus) {
        super(
            responseHead);
     ...
     * @return acctStatus
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AcctStatus getAcctStatus() {
        return acctStatus;
    }
     ...
     * @param acctStatus
     */
    public void setAcctStatus(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AcctStatus acctStatus) {
        this.acctStatus = acctStatus;
    }
