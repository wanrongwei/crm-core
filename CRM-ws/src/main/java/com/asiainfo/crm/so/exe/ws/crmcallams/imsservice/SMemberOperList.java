...
public class SMemberOperList  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SMember[] sMemberList_Item;
    ...
    public SMemberOperList(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SMember[] sMemberList_Item) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SMember[] getSMemberList_Item() {
        return sMemberList_Item;
    }
     ...
     */
    public void setSMemberList_Item(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SMember[] sMemberList_Item) {
        this.sMemberList_Item = sMemberList_Item;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SMember getSMemberList_Item(int i) {
        return this.sMemberList_Item[i];
    }

    public void setSMemberList_Item(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SMember _value) {
