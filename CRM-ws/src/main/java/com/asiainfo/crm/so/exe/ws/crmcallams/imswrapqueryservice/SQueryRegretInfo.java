...
public class SQueryRegretInfo  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRegretOffer[] offerList;
    ...
    public SQueryRegretInfo(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRegretOffer[] offerList) {
           this.acctId = acctId;
     ...
     * @return offerList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRegretOffer[] getOfferList() {
        return offerList;
    }
     ...
     * @param offerList
     */
    public void setOfferList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRegretOffer[] offerList) {
        this.offerList = offerList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRegretOffer getOfferList(int i) {
        return this.offerList[i];
    }

    public void setOfferList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRegretOffer _value) {
