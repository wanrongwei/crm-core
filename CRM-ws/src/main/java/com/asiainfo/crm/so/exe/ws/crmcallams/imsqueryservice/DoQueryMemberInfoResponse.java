...
public class DoQueryMemberInfoResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.GroupandMemberList[] groupandMemberList;
    ...
    public DoQueryMemberInfoResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.GroupandMemberList[] groupandMemberList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.GroupandMemberList[] getGroupandMemberList() {
        return groupandMemberList;
    }
     ...
     */
    public void setGroupandMemberList(com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.GroupandMemberList[] groupandMemberList) {
        this.groupandMemberList = groupandMemberList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.GroupandMemberList getGroupandMemberList(int i) {
        return this.groupandMemberList[i];
    }

    public void setGroupandMemberList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.GroupandMemberList _value) {
