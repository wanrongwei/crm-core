...
public class SQueryNtCdrReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.ServiceType[] serviceIdList;
    ...
    public SQueryNtCdrReq(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.ServiceType[] serviceIdList,
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.ServiceType[] getServiceIdList() {
        return serviceIdList;
    }
     ...
     * @param serviceIdList
     */
    public void setServiceIdList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.ServiceType[] serviceIdList) {
        this.serviceIdList = serviceIdList;
    }
