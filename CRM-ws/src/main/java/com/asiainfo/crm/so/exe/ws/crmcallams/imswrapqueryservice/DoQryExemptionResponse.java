...
public class DoQryExemptionResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.ExemptionInfo exemptionInfo;
    ...
    public DoQryExemptionResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.ExemptionInfo exemptionInfo) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.ExemptionInfo getExemptionInfo() {
        return exemptionInfo;
    }
     ...
     * @param exemptionInfo
     */
    public void setExemptionInfo(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.ExemptionInfo exemptionInfo) {
        this.exemptionInfo = exemptionInfo;
    }
