...
public class SOfferInfo  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SOfferFee[] offerFeeList;
    ...
    private java.lang.Long allowance;
    
    private java.lang.Integer offerType;
    

    public java.lang.Integer getOfferType() {
		return offerType;
	}

	public void setOfferType(java.lang.Integer offerType) {
    ...
    public SOfferInfo(
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SOfferFee[] offerFeeList,
...
//           this.offerType = offerType;
     ...
     * @return offerFeeList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SOfferFee[] getOfferFeeList() {
        return offerFeeList;
    }
     ...
     * @param offerFeeList
     */
    public void setOfferFeeList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SOfferFee[] offerFeeList) {
        this.offerFeeList = offerFeeList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SOfferFee getOfferFeeList(int i) {
        return this.offerFeeList[i];
    }

    public void setOfferFeeList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SOfferFee _value) {
    ...
    /**
     * Gets the tempIMEI value for this SOfferInfo.
     * 
     * @return tempIMEI
     */
    ...
    /**
     * Sets the tempIMEI value for this SOfferInfo.
     * 
     * @param tempIMEI
     */
    ...
    /**
     * Gets the allowance value for this SOfferInfo.
     * 
     * @return allowance
     */
    public java.lang.Long getAllowance() {
        return allowance;
    }


    /**
     * Sets the allowance value for this SOfferInfo.
     * 
     * @param allowance
     */
    public void setAllowance(java.lang.Long allowance) {
        this.allowance = allowance;
    }
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "allowance"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
