...
public class DoQueryCapMaxResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CapMaxAccumulate[] capMaxAccumulateList;
    ...
    public DoQueryCapMaxResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CapMaxAccumulate[] capMaxAccumulateList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CapMaxAccumulate[] getCapMaxAccumulateList() {
        return capMaxAccumulateList;
    }
     ...
     */
    public void setCapMaxAccumulateList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CapMaxAccumulate[] capMaxAccumulateList) {
        this.capMaxAccumulateList = capMaxAccumulateList;
    }
