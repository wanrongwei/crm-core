...
public class ProductFN  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SProductOrder productOrder;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.Fn[] fNList;
    ...
    public ProductFN(
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SProductOrder productOrder,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.Fn[] fNList,
     ...
     * @return productOrder
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SProductOrder getProductOrder() {
        return productOrder;
    }
     ...
     * @param productOrder
     */
    public void setProductOrder(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SProductOrder productOrder) {
        this.productOrder = productOrder;
    }
     ...
     * @return fNList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.Fn[] getFNList() {
        return fNList;
    }
     ...
     * @param fNList
     */
    public void setFNList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.Fn[] fNList) {
        this.fNList = fNList;
    }
