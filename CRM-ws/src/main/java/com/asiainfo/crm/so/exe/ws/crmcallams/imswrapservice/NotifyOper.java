...
public class NotifyOper  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.Notify[][] notifyList;
    ...
    public NotifyOper(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.Notify[][] notifyList) {
     ...
     * @return notifyList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.Notify[][] getNotifyList() {
        return notifyList;
    }
     ...
     * @param notifyList
     */
    public void setNotifyList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.Notify[][] notifyList) {
        this.notifyList = notifyList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.Notify[] getNotifyList(int i) {
        return this.notifyList[i];
    }

    public void setNotifyList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.Notify[] _value) {
