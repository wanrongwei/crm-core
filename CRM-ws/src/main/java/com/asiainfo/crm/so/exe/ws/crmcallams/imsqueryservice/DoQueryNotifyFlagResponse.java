...
public class DoQueryNotifyFlagResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.Notify[] notifyList;
    ...
    public DoQueryNotifyFlagResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.Notify[] notifyList) {
        super(
            responseHead);
     ...
     * @return notifyList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.Notify[] getNotifyList() {
        return notifyList;
    }
     ...
     * @param notifyList
     */
    public void setNotifyList(com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.Notify[] notifyList) {
        this.notifyList = notifyList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.Notify getNotifyList(int i) {
        return this.notifyList[i];
    }

    public void setNotifyList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.Notify _value) {
