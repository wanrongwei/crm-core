...
public class SQueryTransactionFeeReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.BusiSpecId[] busiSpecIdList;
    ...
    public SQueryTransactionFeeReq(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.BusiSpecId[] busiSpecIdList) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.BusiSpecId[] getBusiSpecIdList() {
        return busiSpecIdList;
    }
     ...
     */
    public void setBusiSpecIdList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.BusiSpecId[] busiSpecIdList) {
        this.busiSpecIdList = busiSpecIdList;
    }
