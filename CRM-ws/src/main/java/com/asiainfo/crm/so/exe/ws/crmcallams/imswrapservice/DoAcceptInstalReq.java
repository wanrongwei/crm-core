...
public class DoAcceptInstalReq  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SInstalInfoAccept instalInfoAccept;

    public DoAcceptInstalReq() {
    }

    public DoAcceptInstalReq(
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SInstalInfoAccept instalInfoAccept) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SInstalInfoAccept getInstalInfoAccept() {
        return instalInfoAccept;
    }
     ...
     */
    public void setInstalInfoAccept(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SInstalInfoAccept instalInfoAccept) {
        this.instalInfoAccept = instalInfoAccept;
    }
