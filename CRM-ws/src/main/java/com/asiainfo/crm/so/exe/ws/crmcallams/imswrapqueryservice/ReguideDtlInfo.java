...
public class ReguideDtlInfo  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.ReguideAcctInfo[] reguideAcctInfoList;
    ...
    public ReguideDtlInfo(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.ReguideAcctInfo[] reguideAcctInfoList) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.ReguideAcctInfo[] getReguideAcctInfoList() {
        return reguideAcctInfoList;
    }
     ...
     */
    public void setReguideAcctInfoList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.ReguideAcctInfo[] reguideAcctInfoList) {
        this.reguideAcctInfoList = reguideAcctInfoList;
    }
