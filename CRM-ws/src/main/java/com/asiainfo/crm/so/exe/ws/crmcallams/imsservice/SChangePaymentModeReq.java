...
public class SChangePaymentModeReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SCustomer sCustomer;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SAccount sAccount;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductOrderOper[] productOrderOperList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SBusiServiceOper[] busiServiceOperList;
    ...
    public SChangePaymentModeReq(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SCustomer sCustomer,
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SAccount sAccount,
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductOrderOper[] productOrderOperList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SBusiServiceOper[] busiServiceOperList,
     ...
     * @return sCustomer
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SCustomer getSCustomer() {
        return sCustomer;
    }
     ...
     * @param sCustomer
     */
    public void setSCustomer(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SCustomer sCustomer) {
        this.sCustomer = sCustomer;
    }
     ...
     * @return sAccount
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SAccount getSAccount() {
        return sAccount;
    }
     ...
     * @param sAccount
     */
    public void setSAccount(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SAccount sAccount) {
        this.sAccount = sAccount;
    }
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductOrderOper[] getProductOrderOperList() {
        return productOrderOperList;
    }
     ...
     */
    public void setProductOrderOperList(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductOrderOper[] productOrderOperList) {
        this.productOrderOperList = productOrderOperList;
    }
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SBusiServiceOper[] getBusiServiceOperList() {
        return busiServiceOperList;
    }
     ...
     */
    public void setBusiServiceOperList(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SBusiServiceOper[] busiServiceOperList) {
        this.busiServiceOperList = busiServiceOperList;
    }
