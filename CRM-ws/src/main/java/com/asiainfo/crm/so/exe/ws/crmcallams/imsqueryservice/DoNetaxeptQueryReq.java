...
public class DoNetaxeptQueryReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.NetaxeptQueryRequest request;
    ...
    public DoNetaxeptQueryReq(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.NetaxeptQueryRequest request) {
     ...
     * @return request
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.NetaxeptQueryRequest getRequest() {
        return request;
    }
     ...
     * @param request
     */
    public void setRequest(com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.NetaxeptQueryRequest request) {
        this.request = request;
    }
