...
public class DoQryExemptionResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.ExemptionInfo exemptionInfo;
    ...
    public DoQryExemptionResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.ExemptionInfo exemptionInfo) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.ExemptionInfo getExemptionInfo() {
        return exemptionInfo;
    }
     ...
     * @param exemptionInfo
     */
    public void setExemptionInfo(com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.ExemptionInfo exemptionInfo) {
        this.exemptionInfo = exemptionInfo;
    }
