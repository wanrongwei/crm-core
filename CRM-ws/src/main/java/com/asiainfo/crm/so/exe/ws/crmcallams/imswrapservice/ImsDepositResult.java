...
public class ImsDepositResult  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsSAssetInfo[] unchangedAssetes;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsSAssetInfo[] changedAssetes;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsCaRewardInfo[] rewardInfos;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsQCreditLimit[] creditLimitRemain;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsDeductFeeOut deductFee;
    ...
    public ImsDepositResult(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsSAssetInfo[] unchangedAssetes,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsSAssetInfo[] changedAssetes,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsCaRewardInfo[] rewardInfos,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsQCreditLimit[] creditLimitRemain,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsDeductFeeOut deductFee) {
           this.soNbr = soNbr;
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsSAssetInfo[] getUnchangedAssetes() {
        return unchangedAssetes;
    }
     ...
     */
    public void setUnchangedAssetes(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsSAssetInfo[] unchangedAssetes) {
        this.unchangedAssetes = unchangedAssetes;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsSAssetInfo getUnchangedAssetes(int i) {
        return this.unchangedAssetes[i];
    }

    public void setUnchangedAssetes(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsSAssetInfo _value) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsSAssetInfo[] getChangedAssetes() {
        return changedAssetes;
    }
     ...
     */
    public void setChangedAssetes(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsSAssetInfo[] changedAssetes) {
        this.changedAssetes = changedAssetes;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsSAssetInfo getChangedAssetes(int i) {
        return this.changedAssetes[i];
    }

    public void setChangedAssetes(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsSAssetInfo _value) {
     ...
     * @return rewardInfos
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsCaRewardInfo[] getRewardInfos() {
        return rewardInfos;
    }
     ...
     * @param rewardInfos
     */
    public void setRewardInfos(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsCaRewardInfo[] rewardInfos) {
        this.rewardInfos = rewardInfos;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsCaRewardInfo getRewardInfos(int i) {
        return this.rewardInfos[i];
    }

    public void setRewardInfos(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsCaRewardInfo _value) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsQCreditLimit[] getCreditLimitRemain() {
        return creditLimitRemain;
    }
     ...
     */
    public void setCreditLimitRemain(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsQCreditLimit[] creditLimitRemain) {
        this.creditLimitRemain = creditLimitRemain;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsQCreditLimit getCreditLimitRemain(int i) {
        return this.creditLimitRemain[i];
    }

    public void setCreditLimitRemain(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsQCreditLimit _value) {
     ...
     * @return deductFee
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsDeductFeeOut getDeductFee() {
        return deductFee;
    }
     ...
     * @param deductFee
     */
    public void setDeductFee(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsDeductFeeOut deductFee) {
        this.deductFee = deductFee;
    }
