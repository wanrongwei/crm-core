...
public class SQryOrderOut  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SOfferInfo[] offerList;
    ...
    public SQryOrderOut(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SOfferInfo[] offerList) {
     ...
     * @return offerList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SOfferInfo[] getOfferList() {
        return offerList;
    }
     ...
     * @param offerList
     */
    public void setOfferList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SOfferInfo[] offerList) {
        this.offerList = offerList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SOfferInfo getOfferList(int i) {
        return this.offerList[i];
    }

    public void setOfferList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SOfferInfo _value) {
