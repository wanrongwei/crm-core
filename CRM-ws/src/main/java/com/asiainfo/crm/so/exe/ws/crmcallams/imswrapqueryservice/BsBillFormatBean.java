...
public class BsBillFormatBean  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CodeValue[] paymentList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CodeValue[] mailCodeList;
    ...
    public BsBillFormatBean(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CodeValue[] paymentList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CodeValue[] mailCodeList,
     ...
     * @return paymentList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CodeValue[] getPaymentList() {
        return paymentList;
    }
     ...
     * @param paymentList
     */
    public void setPaymentList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CodeValue[] paymentList) {
        this.paymentList = paymentList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CodeValue getPaymentList(int i) {
        return this.paymentList[i];
    }

    public void setPaymentList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CodeValue _value) {
     ...
     * @return mailCodeList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CodeValue[] getMailCodeList() {
        return mailCodeList;
    }
     ...
     * @param mailCodeList
     */
    public void setMailCodeList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CodeValue[] mailCodeList) {
        this.mailCodeList = mailCodeList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CodeValue getMailCodeList(int i) {
        return this.mailCodeList[i];
    }

    public void setMailCodeList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CodeValue _value) {
