...
public class DoQueryReguideInfoResp  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ReguideInfo[] reguideInfoList;
    ...
    public DoQueryReguideInfoResp(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ReguideInfo[] reguideInfoList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ReguideInfo[] getReguideInfoList() {
        return reguideInfoList;
    }
     ...
     */
    public void setReguideInfoList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ReguideInfo[] reguideInfoList) {
        this.reguideInfoList = reguideInfoList;
    }
