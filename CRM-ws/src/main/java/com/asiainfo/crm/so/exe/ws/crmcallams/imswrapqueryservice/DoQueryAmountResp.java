...
public class DoQueryAmountResp  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.BillAmountBo billAmountBo;
    ...
    public DoQueryAmountResp(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.BillAmountBo billAmountBo) {
        super(
            responseHead);
        this.custId = custId;
     ...
     * @return billAmountBo
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.BillAmountBo getBillAmountBo() {
        return billAmountBo;
    }
     ...
     * @param billAmountBo
     */
    public void setBillAmountBo(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.BillAmountBo billAmountBo) {
        this.billAmountBo = billAmountBo;
    }
