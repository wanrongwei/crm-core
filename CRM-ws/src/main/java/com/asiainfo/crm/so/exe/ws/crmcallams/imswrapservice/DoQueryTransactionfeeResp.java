...
public class DoQueryTransactionfeeResp  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SQueryFreeTimes[] queryFreeTimesList;
    ...
    public DoQueryTransactionfeeResp(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SQueryFreeTimes[] queryFreeTimesList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SQueryFreeTimes[] getQueryFreeTimesList() {
        return queryFreeTimesList;
    }
     ...
     */
    public void setQueryFreeTimesList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SQueryFreeTimes[] queryFreeTimesList) {
        this.queryFreeTimesList = queryFreeTimesList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SQueryFreeTimes getQueryFreeTimesList(int i) {
        return this.queryFreeTimesList[i];
    }

    public void setQueryFreeTimesList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SQueryFreeTimes _value) {
