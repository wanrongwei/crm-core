...
public class CreditLimit  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SubscriberExempt[] subscriberExemptList;
    ...
    public CreditLimit(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SubscriberExempt[] subscriberExemptList,
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SubscriberExempt[] getSubscriberExemptList() {
        return subscriberExemptList;
    }
     ...
     */
    public void setSubscriberExemptList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SubscriberExempt[] subscriberExemptList) {
        this.subscriberExemptList = subscriberExemptList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SubscriberExempt getSubscriberExemptList(int i) {
        return this.subscriberExemptList[i];
    }

    public void setSubscriberExemptList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SubscriberExempt _value) {
