...
public class ManageUserFriendsNum  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.FnOper[] sFNOperList;
    ...
    public ManageUserFriendsNum(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.FnOper[] sFNOperList) {
     ...
     * @return sFNOperList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.FnOper[] getSFNOperList() {
        return sFNOperList;
    }
     ...
     * @param sFNOperList
     */
    public void setSFNOperList(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.FnOper[] sFNOperList) {
        this.sFNOperList = sFNOperList;
    }
