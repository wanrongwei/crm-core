...
public class ImsDeductFeeOut  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsTaxFeeDetail[] taxDetailList;
    ...
    public ImsDeductFeeOut(
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsTaxFeeDetail[] taxDetailList,
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsTaxFeeDetail[] getTaxDetailList() {
        return taxDetailList;
    }
     ...
     * @param taxDetailList
     */
    public void setTaxDetailList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsTaxFeeDetail[] taxDetailList) {
        this.taxDetailList = taxDetailList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsTaxFeeDetail getTaxDetailList(int i) {
        return this.taxDetailList[i];
    }

    public void setTaxDetailList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ImsTaxFeeDetail _value) {
