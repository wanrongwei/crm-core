...
public class DoQueryInstallmenInfoResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.InstallmentInfoDtl[] installmentInfoList;
    ...
    public DoQueryInstallmenInfoResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.InstallmentInfoDtl[] installmentInfoList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.InstallmentInfoDtl[] getInstallmentInfoList() {
        return installmentInfoList;
    }
     ...
     */
    public void setInstallmentInfoList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.InstallmentInfoDtl[] installmentInfoList) {
        this.installmentInfoList = installmentInfoList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.InstallmentInfoDtl getInstallmentInfoList(int i) {
        return this.installmentInfoList[i];
    }

    public void setInstallmentInfoList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.InstallmentInfoDtl _value) {
