...
public class DoRemoveUserResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SBalance[] sBalanceList;
    ...
    public DoRemoveUserResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SBalance[] sBalanceList) {
        super(
            responseHead);
     ...
     * @return sBalanceList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SBalance[] getSBalanceList() {
        return sBalanceList;
    }
     ...
     * @param sBalanceList
     */
    public void setSBalanceList(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SBalance[] sBalanceList) {
        this.sBalanceList = sBalanceList;
    }
