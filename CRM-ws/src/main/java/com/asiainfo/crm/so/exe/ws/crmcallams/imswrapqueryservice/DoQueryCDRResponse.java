...
public class DoQueryCDRResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SContact sContact;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CallDetailRecordList callDetailRecordList;
    ...
    public DoQueryCDRResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SContact sContact,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CallDetailRecordList callDetailRecordList) {
        super(
            responseHead);
     ...
     * @return sContact
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SContact getSContact() {
        return sContact;
    }
     ...
     * @param sContact
     */
    public void setSContact(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SContact sContact) {
        this.sContact = sContact;
    }
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CallDetailRecordList getCallDetailRecordList() {
        return callDetailRecordList;
    }
     ...
     */
    public void setCallDetailRecordList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CallDetailRecordList callDetailRecordList) {
        this.callDetailRecordList = callDetailRecordList;
    }
