...
public class SProductOrder  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.ExtendParam[] reguidPriceParam;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductParam[] paramList;
    ...
    public SProductOrder(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.ExtendParam[] reguidPriceParam,
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductParam[] paramList,
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.ExtendParam[] getReguidPriceParam() {
        return reguidPriceParam;
    }
     ...
     */
    public void setReguidPriceParam(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.ExtendParam[] reguidPriceParam) {
        this.reguidPriceParam = reguidPriceParam;
    }
     ...
     * @return paramList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductParam[] getParamList() {
        return paramList;
    }
     ...
     * @param paramList
     */
    public void setParamList(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductParam[] paramList) {
        this.paramList = paramList;
    }
