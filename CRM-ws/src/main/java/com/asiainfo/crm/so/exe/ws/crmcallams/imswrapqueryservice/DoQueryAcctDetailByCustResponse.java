...
public class DoQueryAcctDetailByCustResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SacctDetailByCustBean[] acctDetailList;
    ...
    public DoQueryAcctDetailByCustResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SacctDetailByCustBean[] acctDetailList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SacctDetailByCustBean[] getAcctDetailList() {
        return acctDetailList;
    }
     ...
     */
    public void setAcctDetailList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SacctDetailByCustBean[] acctDetailList) {
        this.acctDetailList = acctDetailList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SacctDetailByCustBean getAcctDetailList(int i) {
        return this.acctDetailList[i];
    }

    public void setAcctDetailList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SacctDetailByCustBean _value) {
