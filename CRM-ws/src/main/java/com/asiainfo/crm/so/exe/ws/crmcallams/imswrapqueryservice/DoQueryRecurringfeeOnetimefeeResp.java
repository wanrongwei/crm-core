...
public class DoQueryRecurringfeeOnetimefeeResp  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.RecurringOnetimeFee[] recurringOnetimeFeeList;
    ...
    public DoQueryRecurringfeeOnetimefeeResp(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.RecurringOnetimeFee[] recurringOnetimeFeeList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.RecurringOnetimeFee[] getRecurringOnetimeFeeList() {
        return recurringOnetimeFeeList;
    }
     ...
     */
    public void setRecurringOnetimeFeeList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.RecurringOnetimeFee[] recurringOnetimeFeeList) {
        this.recurringOnetimeFeeList = recurringOnetimeFeeList;
    }
