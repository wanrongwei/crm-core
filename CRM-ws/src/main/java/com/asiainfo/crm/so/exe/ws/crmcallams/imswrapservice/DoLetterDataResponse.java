...
public class DoLetterDataResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.LetterDataOut letterDataOut;
    ...
    public DoLetterDataResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.LetterDataOut letterDataOut) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.LetterDataOut getLetterDataOut() {
        return letterDataOut;
    }
     ...
     * @param letterDataOut
     */
    public void setLetterDataOut(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.LetterDataOut letterDataOut) {
        this.letterDataOut = letterDataOut;
    }
