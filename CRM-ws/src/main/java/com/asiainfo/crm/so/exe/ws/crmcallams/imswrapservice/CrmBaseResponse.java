...
public class CrmBaseResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.BaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ResponseHead responseHead;
     ...
     * @return responseHead
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ResponseHead getResponseHead() {
        return responseHead;
    }
     ...
     * @param responseHead
     */
    public void setResponseHead(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.ResponseHead responseHead) {
        this.responseHead = responseHead;
    }
