...
public class DoQueryMdbDataResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.InnerBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.MdbEntity[] valueMap;
    ...
    public DoQueryMdbDataResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.MdbEntity[] valueMap,
     ...
     * @return valueMap
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.MdbEntity[] getValueMap() {
        return valueMap;
    }
     ...
     * @param valueMap
     */
    public void setValueMap(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.MdbEntity[] valueMap) {
        this.valueMap = valueMap;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.MdbEntity getValueMap(int i) {
        return this.valueMap[i];
    }

    public void setValueMap(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.MdbEntity _value) {
