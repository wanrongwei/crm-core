...
public class CrmBaseResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.BaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.ResponseHead responseHead;
     ...
     * @return responseHead
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.ResponseHead getResponseHead() {
        return responseHead;
    }
     ...
     * @param responseHead
     */
    public void setResponseHead(com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.ResponseHead responseHead) {
        this.responseHead = responseHead;
    }
