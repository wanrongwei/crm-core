...
public class SOfferFee  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SDiscountInfo[] discountList;
    ...
    public SOfferFee(
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SDiscountInfo[] discountList,
     ...
     * @return discountList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SDiscountInfo[] getDiscountList() {
        return discountList;
    }
     ...
     * @param discountList
     */
    public void setDiscountList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SDiscountInfo[] discountList) {
        this.discountList = discountList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SDiscountInfo getDiscountList(int i) {
        return this.discountList[i];
    }

    public void setDiscountList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SDiscountInfo _value) {
