...
public class DoChangeOwnerReqResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductOrderResult[] prod_result_list;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SBalance[] oldBalance_list;
    ...
    public DoChangeOwnerReqResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SBalance[] oldBalance_list) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SBalance[] getOldBalance_list() {
        return oldBalance_list;
    }
     ...
     */
    public void setOldBalance_list(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SBalance[] oldBalance_list) {
        this.oldBalance_list = oldBalance_list;
    }
