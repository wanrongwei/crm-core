...
public class DoQueryPayChannelResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.CrmBaseResponse  implements java.io.Serializable {
    private java.lang.Integer paymentType;

    private java.lang.Long expireTime;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.BankDebitInfo bankInfo;
    ...
    public DoQueryPayChannelResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.BankDebitInfo bankInfo,
     ...
     * @return bankInfo
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.BankDebitInfo getBankInfo() {
        return bankInfo;
    }
     ...
     * @param bankInfo
     */
    public void setBankInfo(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.BankDebitInfo bankInfo) {
        this.bankInfo = bankInfo;
    }
