...
public class SUserStatus  implements java.io.Serializable {
    ...
    private java.util.Calendar onHoldFutureExpireDate;

    private java.util.Calendar onHoldPastValidDate;
    ...
    public SUserStatus(
           ...
           java.util.Calendar onHoldFutureExpireDate,
           java.util.Calendar onHoldPastValidDate) {
           this.userId = userId;
           ...
           this.onHoldFutureExpireDate = onHoldFutureExpireDate;
           this.onHoldPastValidDate = onHoldPastValidDate;
    }
    ...
    /**
     * Gets the onHoldFutureExpireDate value for this SUserStatus.
     * 
     * @return onHoldFutureExpireDate
     */
    public java.util.Calendar getOnHoldFutureExpireDate() {
        return onHoldFutureExpireDate;
    }


    /**
     * Sets the onHoldFutureExpireDate value for this SUserStatus.
     * 
     * @param onHoldFutureExpireDate
     */
    public void setOnHoldFutureExpireDate(java.util.Calendar onHoldFutureExpireDate) {
        this.onHoldFutureExpireDate = onHoldFutureExpireDate;
    }


    /**
     * Gets the onHoldPastValidDate value for this SUserStatus.
     * 
     * @return onHoldPastValidDate
     */
    public java.util.Calendar getOnHoldPastValidDate() {
        return onHoldPastValidDate;
    }


    /**
     * Sets the onHoldPastValidDate value for this SUserStatus.
     * 
     * @param onHoldPastValidDate
     */
    public void setOnHoldPastValidDate(java.util.Calendar onHoldPastValidDate) {
        this.onHoldPastValidDate = onHoldPastValidDate;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.onHoldFutureExpireDate==null && other.getOnHoldFutureExpireDate()==null) || 
             (this.onHoldFutureExpireDate!=null &&
              this.onHoldFutureExpireDate.equals(other.getOnHoldFutureExpireDate()))) &&
            ((this.onHoldPastValidDate==null && other.getOnHoldPastValidDate()==null) || 
             (this.onHoldPastValidDate!=null &&
              this.onHoldPastValidDate.equals(other.getOnHoldPastValidDate())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getOnHoldFutureExpireDate() != null) {
            _hashCode += getOnHoldFutureExpireDate().hashCode();
        }
        if (getOnHoldPastValidDate() != null) {
            _hashCode += getOnHoldPastValidDate().hashCode();
        }
    ...
    static {
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("onHoldFutureExpireDate");
        elemField.setXmlName(new javax.xml.namespace.QName("", "onHoldFutureExpireDate"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "dateTime"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("onHoldPastValidDate");
        elemField.setXmlName(new javax.xml.namespace.QName("", "onHoldPastValidDate"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "dateTime"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
