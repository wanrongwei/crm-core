...
public class CrmBaseResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.BaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.ResponseHead responseHead;
     ...
     * @return responseHead
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.ResponseHead getResponseHead() {
        return responseHead;
    }
     ...
     * @param responseHead
     */
    public void setResponseHead(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.ResponseHead responseHead) {
        this.responseHead = responseHead;
    }
