...
public class InnerBaseResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.BaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CbsErrorMsg errorMsg;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SPage sPage;
     ...
     * @return errorMsg
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CbsErrorMsg getErrorMsg() {
        return errorMsg;
    }
     ...
     * @param errorMsg
     */
    public void setErrorMsg(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CbsErrorMsg errorMsg) {
        this.errorMsg = errorMsg;
    }
     ...
     * @return sPage
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SPage getSPage() {
        return sPage;
    }
     ...
     * @param sPage
     */
    public void setSPage(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SPage sPage) {
        this.sPage = sPage;
    }
