...
public class PayChannelHisInfo  extends com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.InnerBaseResponse  implements java.io.Serializable {
    private java.lang.Integer paymentType;

    private java.util.Calendar expireTime;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.BankDebitInfo[] bankInfo;
    ...
    public PayChannelHisInfo(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.BankDebitInfo[] bankInfo) {
        super(
            errorMsg,
            sPage);
     ...
     * @return bankInfo
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.BankDebitInfo[] getBankInfo() {
        return bankInfo;
    }
     ...
     * @param bankInfo
     */
    public void setBankInfo(com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.BankDebitInfo[] bankInfo) {
        this.bankInfo = bankInfo;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.BankDebitInfo getBankInfo(int i) {
        return this.bankInfo[i];
    }

    public void setBankInfo(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.BankDebitInfo _value) {
