...
public class SAllowanceRec  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SAllowanceRecDetail[] detailList;
    ...
    public SAllowanceRec(
           ...
           java.lang.Long opId,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SAllowanceRecDetail[] detailList) {
           this.acctId = acctId;
     ...
     * @return detailList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SAllowanceRecDetail[] getDetailList() {
        return detailList;
    }
     ...
     * @param detailList
     */
    public void setDetailList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SAllowanceRecDetail[] detailList) {
        this.detailList = detailList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SAllowanceRecDetail getDetailList(int i) {
        return this.detailList[i];
    }

    public void setDetailList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SAllowanceRecDetail _value) {
