...
public class DoQueryProdStateResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.ProdStateResult[] service_state_list;
    ...
    public DoQueryProdStateResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.ProdStateResult[] service_state_list) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.ProdStateResult[] getService_state_list() {
        return service_state_list;
    }
     ...
     */
    public void setService_state_list(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.ProdStateResult[] service_state_list) {
        this.service_state_list = service_state_list;
    }
