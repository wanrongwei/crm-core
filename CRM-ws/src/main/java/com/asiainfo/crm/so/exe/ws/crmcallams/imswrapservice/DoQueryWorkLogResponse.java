...
public class DoQueryWorkLogResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.RechargeLog[] rechargeLogList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.AdjustLog[] adjustLogList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.TransferLog[] transferLogList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.PaymentLog[] paymentLogList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.NegativeBalanceLog[] negativebalLogList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.MaxFreeResourceLog[] maxFreesourceLogList;
    ...
    public DoQueryWorkLogResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.RechargeLog[] rechargeLogList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.AdjustLog[] adjustLogList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.TransferLog[] transferLogList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.PaymentLog[] paymentLogList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.NegativeBalanceLog[] negativebalLogList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.MaxFreeResourceLog[] maxFreesourceLogList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.RechargeLog[] getRechargeLogList() {
        return rechargeLogList;
    }
     ...
     */
    public void setRechargeLogList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.RechargeLog[] rechargeLogList) {
        this.rechargeLogList = rechargeLogList;
    }
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.AdjustLog[] getAdjustLogList() {
        return adjustLogList;
    }
     ...
     * @param adjustLogList
     */
    public void setAdjustLogList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.AdjustLog[] adjustLogList) {
        this.adjustLogList = adjustLogList;
    }
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.TransferLog[] getTransferLogList() {
        return transferLogList;
    }
     ...
     */
    public void setTransferLogList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.TransferLog[] transferLogList) {
        this.transferLogList = transferLogList;
    }
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.PaymentLog[] getPaymentLogList() {
        return paymentLogList;
    }
     ...
     */
    public void setPaymentLogList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.PaymentLog[] paymentLogList) {
        this.paymentLogList = paymentLogList;
    }
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.NegativeBalanceLog[] getNegativebalLogList() {
        return negativebalLogList;
    }
     ...
     */
    public void setNegativebalLogList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.NegativeBalanceLog[] negativebalLogList) {
        this.negativebalLogList = negativebalLogList;
    }
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.MaxFreeResourceLog[] getMaxFreesourceLogList() {
        return maxFreesourceLogList;
    }
     ...
     */
    public void setMaxFreesourceLogList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.MaxFreeResourceLog[] maxFreesourceLogList) {
        this.maxFreesourceLogList = maxFreesourceLogList;
    }
