...
public class SAllowanceUsage  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SAllowanceOfferUsage[] offerLimits;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SFreeResource[] freeResList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SAllowanceRec[] allowanceRecList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AssetChgIn[] assetChgs;
    ...
    public SAllowanceUsage(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SAllowanceOfferUsage[] offerLimits,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SFreeResource[] freeResList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SAllowanceRec[] allowanceRecList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AssetChgIn[] assetChgs) {
     ...
     * @return offerLimits
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SAllowanceOfferUsage[] getOfferLimits() {
        return offerLimits;
    }
     ...
     * @param offerLimits
     */
    public void setOfferLimits(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SAllowanceOfferUsage[] offerLimits) {
        this.offerLimits = offerLimits;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SAllowanceOfferUsage getOfferLimits(int i) {
        return this.offerLimits[i];
    }

    public void setOfferLimits(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SAllowanceOfferUsage _value) {
     ...
     * @return freeResList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SFreeResource[] getFreeResList() {
        return freeResList;
    }
     ...
     * @param freeResList
     */
    public void setFreeResList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SFreeResource[] freeResList) {
        this.freeResList = freeResList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SFreeResource getFreeResList(int i) {
        return this.freeResList[i];
    }

    public void setFreeResList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SFreeResource _value) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SAllowanceRec[] getAllowanceRecList() {
        return allowanceRecList;
    }
     ...
     */
    public void setAllowanceRecList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SAllowanceRec[] allowanceRecList) {
        this.allowanceRecList = allowanceRecList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SAllowanceRec getAllowanceRecList(int i) {
        return this.allowanceRecList[i];
    }

    public void setAllowanceRecList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SAllowanceRec _value) {
     ...
     * @return assetChgs
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AssetChgIn[] getAssetChgs() {
        return assetChgs;
    }
     ...
     * @param assetChgs
     */
    public void setAssetChgs(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AssetChgIn[] assetChgs) {
        this.assetChgs = assetChgs;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AssetChgIn getAssetChgs(int i) {
        return this.assetChgs[i];
    }

    public void setAssetChgs(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AssetChgIn _value) {
