...
public class ActualUsage  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SubActualUsage[] subActualUsageList;
    ...
    public ActualUsage(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SubActualUsage[] subActualUsageList,
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SubActualUsage[] getSubActualUsageList() {
        return subActualUsageList;
    }
     ...
     */
    public void setSubActualUsageList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SubActualUsage[] subActualUsageList) {
        this.subActualUsageList = subActualUsageList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SubActualUsage getSubActualUsageList(int i) {
        return this.subActualUsageList[i];
    }

    public void setSubActualUsageList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SubActualUsage _value) {
