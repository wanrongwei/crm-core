...
public class DoQueryInvoiceInfoResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.InvoiceInfoResult[] invoiceInfoList;
    ...
    public DoQueryInvoiceInfoResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.InvoiceInfoResult[] invoiceInfoList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.InvoiceInfoResult[] getInvoiceInfoList() {
        return invoiceInfoList;
    }
     ...
     */
    public void setInvoiceInfoList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.InvoiceInfoResult[] invoiceInfoList) {
        this.invoiceInfoList = invoiceInfoList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.InvoiceInfoResult getInvoiceInfoList(int i) {
        return this.invoiceInfoList[i];
    }

    public void setInvoiceInfoList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.InvoiceInfoResult _value) {
