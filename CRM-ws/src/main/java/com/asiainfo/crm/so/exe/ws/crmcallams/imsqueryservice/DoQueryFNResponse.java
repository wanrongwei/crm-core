...
public class DoQueryFNResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.ProductFN[] fn_list;
    ...
    public DoQueryFNResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.ProductFN[] fn_list) {
        super(
            responseHead);
     ...
     * @return fn_list
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.ProductFN[] getFn_list() {
        return fn_list;
    }
     ...
     * @param fn_list
     */
    public void setFn_list(com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.ProductFN[] fn_list) {
        this.fn_list = fn_list;
    }
