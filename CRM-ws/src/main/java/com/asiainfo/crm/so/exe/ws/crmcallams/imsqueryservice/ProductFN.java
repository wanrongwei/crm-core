...
public class ProductFN  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SProductOrder productOrder;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.Fn[] fNList;
    ...
    public ProductFN(
           com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SProductOrder productOrder,
           com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.Fn[] fNList,
     ...
     * @return productOrder
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SProductOrder getProductOrder() {
        return productOrder;
    }
     ...
     * @param productOrder
     */
    public void setProductOrder(com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SProductOrder productOrder) {
        this.productOrder = productOrder;
    }
     ...
     * @return fNList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.Fn[] getFNList() {
        return fNList;
    }
     ...
     * @param fNList
     */
    public void setFNList(com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.Fn[] fNList) {
        this.fNList = fNList;
    }
