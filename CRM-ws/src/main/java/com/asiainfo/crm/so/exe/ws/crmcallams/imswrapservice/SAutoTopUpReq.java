...
public class SAutoTopUpReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.AutoTopUpRelation[] autoTopUpRelList;
    ...
    public SAutoTopUpReq(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.AutoTopUpRelation[] autoTopUpRelList) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.AutoTopUpRelation[] getAutoTopUpRelList() {
        return autoTopUpRelList;
    }
     ...
     */
    public void setAutoTopUpRelList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.AutoTopUpRelation[] autoTopUpRelList) {
        this.autoTopUpRelList = autoTopUpRelList;
    }
