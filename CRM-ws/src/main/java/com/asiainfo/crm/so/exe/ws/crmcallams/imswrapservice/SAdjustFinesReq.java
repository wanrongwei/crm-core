...
public class SAdjustFinesReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SAmountDetailInfo[] sAmountDetailInfo;
    ...
    public SAdjustFinesReq(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SAmountDetailInfo[] sAmountDetailInfo) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SAmountDetailInfo[] getSAmountDetailInfo() {
        return sAmountDetailInfo;
    }
     ...
     */
    public void setSAmountDetailInfo(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SAmountDetailInfo[] sAmountDetailInfo) {
        this.sAmountDetailInfo = sAmountDetailInfo;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SAmountDetailInfo getSAmountDetailInfo(int i) {
        return this.sAmountDetailInfo[i];
    }

    public void setSAmountDetailInfo(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SAmountDetailInfo _value) {
