...
public class HybridBusiService  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SBusiService[] sBusiServiceList;
    ...
    public HybridBusiService(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SBusiService[] sBusiServiceList) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SBusiService[] getSBusiServiceList() {
        return sBusiServiceList;
    }
     ...
     */
    public void setSBusiServiceList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SBusiService[] sBusiServiceList) {
        this.sBusiServiceList = sBusiServiceList;
    }
