...
public class DoQueryOrderInfoReq  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQryOrderIn qryOrderIn;

    public DoQueryOrderInfoReq() {
    }

    public DoQueryOrderInfoReq(
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQryOrderIn qryOrderIn) {
     ...
     * @return qryOrderIn
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQryOrderIn getQryOrderIn() {
        return qryOrderIn;
    }
     ...
     * @param qryOrderIn
     */
    public void setQryOrderIn(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQryOrderIn qryOrderIn) {
        this.qryOrderIn = qryOrderIn;
    }
