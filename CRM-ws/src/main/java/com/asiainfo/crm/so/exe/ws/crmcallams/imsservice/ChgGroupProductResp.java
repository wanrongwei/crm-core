...
public class ChgGroupProductResp  extends com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductOrderResult[] sProductOrderResultList;
    ...
    public ChgGroupProductResp(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductOrderResult[] sProductOrderResultList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductOrderResult[] getSProductOrderResultList() {
        return sProductOrderResultList;
    }
     ...
     */
    public void setSProductOrderResultList(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductOrderResult[] sProductOrderResultList) {
        this.sProductOrderResultList = sProductOrderResultList;
    }
