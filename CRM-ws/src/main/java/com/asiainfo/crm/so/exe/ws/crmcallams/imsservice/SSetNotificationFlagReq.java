...
public class SSetNotificationFlagReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.NotifyOper[][] notifyOperList;
    ...
    public SSetNotificationFlagReq(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.NotifyOper[][] notifyOperList,
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.NotifyOper[][] getNotifyOperList() {
        return notifyOperList;
    }
     ...
     */
    public void setNotifyOperList(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.NotifyOper[][] notifyOperList) {
        this.notifyOperList = notifyOperList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.NotifyOper[] getNotifyOperList(int i) {
        return this.notifyOperList[i];
    }

    public void setNotifyOperList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.NotifyOper[] _value) {
