...
public class DoQueryProductBillAttrResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private java.lang.Integer productOfferingId;

    private java.lang.String productOfferingName;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SProductRecurringFee[] feeList;
    ...
    public DoQueryProductBillAttrResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SProductRecurringFee[] feeList) {
        super(
            responseHead);
     ...
     * @return feeList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SProductRecurringFee[] getFeeList() {
        return feeList;
    }
     ...
     * @param feeList
     */
    public void setFeeList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SProductRecurringFee[] feeList) {
        this.feeList = feeList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SProductRecurringFee getFeeList(int i) {
        return this.feeList[i];
    }

    public void setFeeList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SProductRecurringFee _value) {
