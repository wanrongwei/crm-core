...
public class DoQueryGroupInfoResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private java.lang.Integer number_of_sub;

    private java.lang.Integer number_of_cug;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SProductOrder[] productOrderList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SGroup[] groupInfoList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SubGroup[] subGroupList;
    ...
    public DoQueryGroupInfoResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SProductOrder[] productOrderList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SGroup[] groupInfoList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SubGroup[] subGroupList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SProductOrder[] getProductOrderList() {
        return productOrderList;
    }
     ...
     */
    public void setProductOrderList(com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SProductOrder[] productOrderList) {
        this.productOrderList = productOrderList;
    }
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SGroup[] getGroupInfoList() {
        return groupInfoList;
    }
     ...
     * @param groupInfoList
     */
    public void setGroupInfoList(com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SGroup[] groupInfoList) {
        this.groupInfoList = groupInfoList;
    }
     ...
     * @return subGroupList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SubGroup[] getSubGroupList() {
        return subGroupList;
    }
     ...
     * @param subGroupList
     */
    public void setSubGroupList(com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.SubGroup[] subGroupList) {
        this.subGroupList = subGroupList;
    }
