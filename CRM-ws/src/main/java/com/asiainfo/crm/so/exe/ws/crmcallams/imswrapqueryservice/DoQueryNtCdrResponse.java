...
public class DoQueryNtCdrResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SReplyInfo[] sReplyDisInfoList;
    ...
    public DoQueryNtCdrResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SReplyInfo[] sReplyDisInfoList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SReplyInfo[] getSReplyDisInfoList() {
        return sReplyDisInfoList;
    }
     ...
     */
    public void setSReplyDisInfoList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SReplyInfo[] sReplyDisInfoList) {
        this.sReplyDisInfoList = sReplyDisInfoList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SReplyInfo getSReplyDisInfoList(int i) {
        return this.sReplyDisInfoList[i];
    }

    public void setSReplyDisInfoList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SReplyInfo _value) {
