...
public class GroupandMemberList  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SMember[] sMemberList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SGroup sGroup;

    public GroupandMemberList() {
    }

    public GroupandMemberList(
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SMember[] sMemberList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SGroup sGroup) {
     ...
     * @return sMemberList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SMember[] getSMemberList() {
        return sMemberList;
    }
     ...
     * @param sMemberList
     */
    public void setSMemberList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SMember[] sMemberList) {
        this.sMemberList = sMemberList;
    }
     ...
     * @return sGroup
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SGroup getSGroup() {
        return sGroup;
    }
     ...
     * @param sGroup
     */
    public void setSGroup(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SGroup sGroup) {
        this.sGroup = sGroup;
    }
