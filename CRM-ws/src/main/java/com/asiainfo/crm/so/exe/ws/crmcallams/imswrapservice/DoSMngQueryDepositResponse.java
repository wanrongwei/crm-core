...
public class DoSMngQueryDepositResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SPocket[] pocketList;
    ...
    public DoSMngQueryDepositResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SPocket[] pocketList) {
        super(
            responseHead);
     ...
     * @return pocketList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SPocket[] getPocketList() {
        return pocketList;
    }
     ...
     * @param pocketList
     */
    public void setPocketList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SPocket[] pocketList) {
        this.pocketList = pocketList;
    }
