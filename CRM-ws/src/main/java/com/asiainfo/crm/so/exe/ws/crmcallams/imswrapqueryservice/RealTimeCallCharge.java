...
public class RealTimeCallCharge  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CallDetail[] callDetailList;
    ...
    public RealTimeCallCharge(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CallDetail[] callDetailList) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CallDetail[] getCallDetailList() {
        return callDetailList;
    }
     ...
     */
    public void setCallDetailList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CallDetail[] callDetailList) {
        this.callDetailList = callDetailList;
    }
