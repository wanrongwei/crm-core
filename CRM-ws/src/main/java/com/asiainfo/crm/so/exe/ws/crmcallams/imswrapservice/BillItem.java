...
public class BillItem  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.BillDetail[] billDetaillist;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CaBillProd[] caBillProdList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CaBillTax[] caBillTaxList;
    ...
    public BillItem(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.BillDetail[] billDetaillist,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CaBillProd[] caBillProdList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CaBillTax[] caBillTaxList) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.BillDetail[] getBillDetaillist() {
        return billDetaillist;
    }
     ...
     */
    public void setBillDetaillist(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.BillDetail[] billDetaillist) {
        this.billDetaillist = billDetaillist;
    }
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CaBillProd[] getCaBillProdList() {
        return caBillProdList;
    }
     ...
     */
    public void setCaBillProdList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CaBillProd[] caBillProdList) {
        this.caBillProdList = caBillProdList;
    }
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CaBillTax[] getCaBillTaxList() {
        return caBillTaxList;
    }
     ...
     * @param caBillTaxList
     */
    public void setCaBillTaxList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CaBillTax[] caBillTaxList) {
        this.caBillTaxList = caBillTaxList;
    }
