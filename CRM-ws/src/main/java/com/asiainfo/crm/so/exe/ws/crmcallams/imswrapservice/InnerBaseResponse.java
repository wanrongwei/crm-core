...
public class InnerBaseResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.BaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CbsErrorMsg errorMsg;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SPage sPage;
     ...
     * @return errorMsg
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CbsErrorMsg getErrorMsg() {
        return errorMsg;
    }
     ...
     * @param errorMsg
     */
    public void setErrorMsg(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CbsErrorMsg errorMsg) {
        this.errorMsg = errorMsg;
    }
     ...
     * @return sPage
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SPage getSPage() {
        return sPage;
    }
     ...
     * @param sPage
     */
    public void setSPage(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SPage sPage) {
        this.sPage = sPage;
    }
