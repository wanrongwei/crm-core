...
public class OneTimeFee  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.FeeItem[] feeList;
    ...
    public OneTimeFee(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.FeeItem[] feeList) {
     ...
     * @return feeList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.FeeItem[] getFeeList() {
        return feeList;
    }
     ...
     * @param feeList
     */
    public void setFeeList(com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.FeeItem[] feeList) {
        this.feeList = feeList;
    }
