...
public class ScpProfileInfo  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SUserAuth sUserAuth;
    ...
    public ScpProfileInfo(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SUserAuth sUserAuth,
     ...
     * @return sUserAuth
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SUserAuth getSUserAuth() {
        return sUserAuth;
    }
     ...
     * @param sUserAuth
     */
    public void setSUserAuth(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SUserAuth sUserAuth) {
        this.sUserAuth = sUserAuth;
    }
