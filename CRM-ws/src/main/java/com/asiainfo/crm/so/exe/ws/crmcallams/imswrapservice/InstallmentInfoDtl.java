...
public class InstallmentInfoDtl  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.Plan[] details;
    ...
    public InstallmentInfoDtl(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.Plan[] details,
     ...
     * @return details
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.Plan[] getDetails() {
        return details;
    }
     ...
     * @param details
     */
    public void setDetails(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.Plan[] details) {
        this.details = details;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.Plan getDetails(int i) {
        return this.details[i];
    }

    public void setDetails(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.Plan _value) {
        this.details[i] = _value;
    }


    /**
     * Gets the imei value for this InstallmentInfoDtl.
     * 
     * @return imei
     */
    ...
    /**
     * Sets the imei value for this InstallmentInfoDtl.
     * 
     * @param imei
     */
    ...
    /**
     * Gets the offerId value for this InstallmentInfoDtl.
     * 
     * @return offerId
     */
    ...
    /**
     * Sets the offerId value for this InstallmentInfoDtl.
     * 
     * @param offerId
     */
