...
public class SAccount  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SPayChannel[] payChannelList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.DoQueryPayChannelResponse payChannels;
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.BankDebitInfo[] panHashList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SOioublInfo sOioublInfo;
    ...
    public SAccount(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SPayChannel[] payChannelList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.DoQueryPayChannelResponse payChannels,
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.BankDebitInfo[] panHashList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SOioublInfo sOioublInfo) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SPayChannel[] getPayChannelList() {
        return payChannelList;
    }
     ...
     */
    public void setPayChannelList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SPayChannel[] payChannelList) {
        this.payChannelList = payChannelList;
    }
     ...
     * @return payChannels
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.DoQueryPayChannelResponse getPayChannels() {
        return payChannels;
    }
     ...
     * @param payChannels
     */
    public void setPayChannels(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.DoQueryPayChannelResponse payChannels) {
        this.payChannels = payChannels;
    }
     ...
     * @return panHashList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.BankDebitInfo[] getPanHashList() {
        return panHashList;
    }
     ...
     * @param panHashList
     */
    public void setPanHashList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.BankDebitInfo[] panHashList) {
        this.panHashList = panHashList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.BankDebitInfo getPanHashList(int i) {
        return this.panHashList[i];
    }

    public void setPanHashList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.BankDebitInfo _value) {
     ...
     * @return sOioublInfo
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SOioublInfo getSOioublInfo() {
        return sOioublInfo;
    }
     ...
     * @param sOioublInfo
     */
    public void setSOioublInfo(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SOioublInfo sOioublInfo) {
        this.sOioublInfo = sOioublInfo;
    }
