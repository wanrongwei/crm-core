...
public class DoQueryLostBalanceResponce  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SBalance[] balanceList;
    ...
    public DoQueryLostBalanceResponce(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SBalance[] balanceList) {
        super(
            responseHead);
     ...
     * @return balanceList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SBalance[] getBalanceList() {
        return balanceList;
    }
     ...
     * @param balanceList
     */
    public void setBalanceList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SBalance[] balanceList) {
        this.balanceList = balanceList;
    }
