...
public class SQueryDeductCondResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQueryDeductOut[] deductOutList;
    ...
    public SQueryDeductCondResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQueryDeductOut[] deductOutList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQueryDeductOut[] getDeductOutList() {
        return deductOutList;
    }
     ...
     * @param deductOutList
     */
    public void setDeductOutList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQueryDeductOut[] deductOutList) {
        this.deductOutList = deductOutList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQueryDeductOut getDeductOutList(int i) {
        return this.deductOutList[i];
    }

    public void setDeductOutList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQueryDeductOut _value) {
