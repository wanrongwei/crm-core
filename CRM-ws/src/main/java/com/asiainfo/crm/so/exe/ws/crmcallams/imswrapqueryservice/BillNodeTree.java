...
public class BillNodeTree  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.BillNodeTree[] children;
    ...
    public BillNodeTree(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.BillNodeTree[] children,
     ...
     * @return children
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.BillNodeTree[] getChildren() {
        return children;
    }
     ...
     * @param children
     */
    public void setChildren(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.BillNodeTree[] children) {
        this.children = children;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.BillNodeTree getChildren(int i) {
        return this.children[i];
    }

    public void setChildren(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.BillNodeTree _value) {
