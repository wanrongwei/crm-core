...
public class DoQueryBillExResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.BillNodeTree billNodeTree;
    ...
    public DoQueryBillExResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.BillNodeTree billNodeTree) {
        super(
            responseHead);
     ...
     * @return billNodeTree
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.BillNodeTree getBillNodeTree() {
        return billNodeTree;
    }
     ...
     * @param billNodeTree
     */
    public void setBillNodeTree(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.BillNodeTree billNodeTree) {
        this.billNodeTree = billNodeTree;
    }
