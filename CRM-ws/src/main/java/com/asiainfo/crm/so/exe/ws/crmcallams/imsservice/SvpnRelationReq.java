...
public class SvpnRelationReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SubGroup[] subGroupList;
    ...
    public SvpnRelationReq(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SubGroup[] subGroupList) {
     ...
     * @return subGroupList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SubGroup[] getSubGroupList() {
        return subGroupList;
    }
     ...
     * @param subGroupList
     */
    public void setSubGroupList(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SubGroup[] subGroupList) {
        this.subGroupList = subGroupList;
    }
