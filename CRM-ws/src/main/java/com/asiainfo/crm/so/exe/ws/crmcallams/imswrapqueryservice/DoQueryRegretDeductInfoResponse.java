...
public class DoQueryRegretDeductInfoResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRecOrderInfo[] queryOut;
    ...
    public DoQueryRegretDeductInfoResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRecOrderInfo[] queryOut) {
        super(
            responseHead);
     ...
     * @return queryOut
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRecOrderInfo[] getQueryOut() {
        return queryOut;
    }
     ...
     * @param queryOut
     */
    public void setQueryOut(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRecOrderInfo[] queryOut) {
        this.queryOut = queryOut;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRecOrderInfo getQueryOut(int i) {
        return this.queryOut[i];
    }

    public void setQueryOut(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRecOrderInfo _value) {
