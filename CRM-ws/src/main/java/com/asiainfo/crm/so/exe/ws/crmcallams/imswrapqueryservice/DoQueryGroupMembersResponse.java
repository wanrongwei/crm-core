...
public class DoQueryGroupMembersResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SMember[] member_list;
    ...
    public DoQueryGroupMembersResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SMember[] member_list) {
        super(
            responseHead);
     ...
     * @return member_list
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SMember[] getMember_list() {
        return member_list;
    }
     ...
     * @param member_list
     */
    public void setMember_list(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SMember[] member_list) {
        this.member_list = member_list;
    }
