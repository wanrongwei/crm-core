...
public class DoQueryGroupInfoResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private java.lang.Integer number_of_sub;

    private java.lang.Integer number_of_cug;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SProductOrder[] productOrderList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SGroup[] groupInfoList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SubGroup[] subGroupList;
    ...
    public DoQueryGroupInfoResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SProductOrder[] productOrderList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SGroup[] groupInfoList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SubGroup[] subGroupList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SProductOrder[] getProductOrderList() {
        return productOrderList;
    }
     ...
     */
    public void setProductOrderList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SProductOrder[] productOrderList) {
        this.productOrderList = productOrderList;
    }
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SGroup[] getGroupInfoList() {
        return groupInfoList;
    }
     ...
     * @param groupInfoList
     */
    public void setGroupInfoList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SGroup[] groupInfoList) {
        this.groupInfoList = groupInfoList;
    }
     ...
     * @return subGroupList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SubGroup[] getSubGroupList() {
        return subGroupList;
    }
     ...
     * @param subGroupList
     */
    public void setSubGroupList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SubGroup[] subGroupList) {
        this.subGroupList = subGroupList;
    }
