...
public class DoQueryWorkLogResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.RechargeLog[] rechargeLogList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AdjustLog[] adjustLogList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.TransferLog[] transferLogList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.PaymentLog[] paymentLogList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.NegativeBalanceLog[] negativebalLogList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.MaxFreeResourceLog[] maxFreesourceLogList;
    ...
    public DoQueryWorkLogResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.RechargeLog[] rechargeLogList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AdjustLog[] adjustLogList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.TransferLog[] transferLogList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.PaymentLog[] paymentLogList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.NegativeBalanceLog[] negativebalLogList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.MaxFreeResourceLog[] maxFreesourceLogList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.RechargeLog[] getRechargeLogList() {
        return rechargeLogList;
    }
     ...
     */
    public void setRechargeLogList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.RechargeLog[] rechargeLogList) {
        this.rechargeLogList = rechargeLogList;
    }
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AdjustLog[] getAdjustLogList() {
        return adjustLogList;
    }
     ...
     * @param adjustLogList
     */
    public void setAdjustLogList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AdjustLog[] adjustLogList) {
        this.adjustLogList = adjustLogList;
    }
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.TransferLog[] getTransferLogList() {
        return transferLogList;
    }
     ...
     */
    public void setTransferLogList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.TransferLog[] transferLogList) {
        this.transferLogList = transferLogList;
    }
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.PaymentLog[] getPaymentLogList() {
        return paymentLogList;
    }
     ...
     */
    public void setPaymentLogList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.PaymentLog[] paymentLogList) {
        this.paymentLogList = paymentLogList;
    }
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.NegativeBalanceLog[] getNegativebalLogList() {
        return negativebalLogList;
    }
     ...
     */
    public void setNegativebalLogList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.NegativeBalanceLog[] negativebalLogList) {
        this.negativebalLogList = negativebalLogList;
    }
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.MaxFreeResourceLog[] getMaxFreesourceLogList() {
        return maxFreesourceLogList;
    }
     ...
     */
    public void setMaxFreesourceLogList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.MaxFreeResourceLog[] maxFreesourceLogList) {
        this.maxFreesourceLogList = maxFreesourceLogList;
    }
