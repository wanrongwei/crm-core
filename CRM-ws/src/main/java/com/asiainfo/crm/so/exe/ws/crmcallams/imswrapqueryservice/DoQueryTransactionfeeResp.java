...
public class DoQueryTransactionfeeResp  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQueryFreeTimes[] queryFreeTimesList;
    ...
    public DoQueryTransactionfeeResp(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQueryFreeTimes[] queryFreeTimesList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQueryFreeTimes[] getQueryFreeTimesList() {
        return queryFreeTimesList;
    }
     ...
     */
    public void setQueryFreeTimesList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQueryFreeTimes[] queryFreeTimesList) {
        this.queryFreeTimesList = queryFreeTimesList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQueryFreeTimes getQueryFreeTimesList(int i) {
        return this.queryFreeTimesList[i];
    }

    public void setQueryFreeTimesList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SQueryFreeTimes _value) {
