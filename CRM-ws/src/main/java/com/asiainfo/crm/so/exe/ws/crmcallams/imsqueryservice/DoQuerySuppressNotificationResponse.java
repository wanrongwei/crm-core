...
public class DoQuerySuppressNotificationResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.AcctNotify[] acctNotifyList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.PhoneNotify[] phoneNotifyList;
    ...
    public DoQuerySuppressNotificationResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.AcctNotify[] acctNotifyList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.PhoneNotify[] phoneNotifyList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.AcctNotify[] getAcctNotifyList() {
        return acctNotifyList;
    }
     ...
     */
    public void setAcctNotifyList(com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.AcctNotify[] acctNotifyList) {
        this.acctNotifyList = acctNotifyList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.AcctNotify getAcctNotifyList(int i) {
        return this.acctNotifyList[i];
    }

    public void setAcctNotifyList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.AcctNotify _value) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.PhoneNotify[] getPhoneNotifyList() {
        return phoneNotifyList;
    }
     ...
     */
    public void setPhoneNotifyList(com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.PhoneNotify[] phoneNotifyList) {
        this.phoneNotifyList = phoneNotifyList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.PhoneNotify getPhoneNotifyList(int i) {
        return this.phoneNotifyList[i];
    }

    public void setPhoneNotifyList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.PhoneNotify _value) {
