...
public class PaymentInfo  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.PaymentItem[] paymentList;
    ...
    public PaymentInfo(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.PaymentItem[] paymentList) {
     ...
     * @return paymentList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.PaymentItem[] getPaymentList() {
        return paymentList;
    }
     ...
     * @param paymentList
     */
    public void setPaymentList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.PaymentItem[] paymentList) {
        this.paymentList = paymentList;
    }
