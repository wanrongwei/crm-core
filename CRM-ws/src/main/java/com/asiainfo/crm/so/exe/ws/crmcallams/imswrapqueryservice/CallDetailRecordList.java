...
public class CallDetailRecordList  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CallDetailRecord[] detailList;
    ...
    public CallDetailRecordList(
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CallDetailRecord[] detailList,
     ...
     * @return detailList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CallDetailRecord[] getDetailList() {
        return detailList;
    }
     ...
     * @param detailList
     */
    public void setDetailList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CallDetailRecord[] detailList) {
        this.detailList = detailList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CallDetailRecord getDetailList(int i) {
        return this.detailList[i];
    }

    public void setDetailList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CallDetailRecord _value) {
