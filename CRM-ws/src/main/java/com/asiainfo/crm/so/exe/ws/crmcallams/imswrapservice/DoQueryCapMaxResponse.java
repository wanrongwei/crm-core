...
public class DoQueryCapMaxResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CapMaxAccumulate[] capMaxAccumulateList;
    ...
    public DoQueryCapMaxResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CapMaxAccumulate[] capMaxAccumulateList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CapMaxAccumulate[] getCapMaxAccumulateList() {
        return capMaxAccumulateList;
    }
     ...
     */
    public void setCapMaxAccumulateList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CapMaxAccumulate[] capMaxAccumulateList) {
        this.capMaxAccumulateList = capMaxAccumulateList;
    }
