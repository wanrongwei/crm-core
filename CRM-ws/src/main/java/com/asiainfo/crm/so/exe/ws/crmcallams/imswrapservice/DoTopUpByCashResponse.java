...
public class DoTopUpByCashResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.STopUpResponse topUpResp;
    ...
    public DoTopUpByCashResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.STopUpResponse topUpResp) {
        super(
            responseHead);
     ...
     * @return topUpResp
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.STopUpResponse getTopUpResp() {
        return topUpResp;
    }
     ...
     * @param topUpResp
     */
    public void setTopUpResp(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.STopUpResponse topUpResp) {
        this.topUpResp = topUpResp;
    }
