...
public class SOfferInfo  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SOfferFee[] offerFeeList;
    ...
    public SOfferInfo(
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SOfferFee[] offerFeeList,
     ...
     * @return offerFeeList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SOfferFee[] getOfferFeeList() {
        return offerFeeList;
    }
     ...
     * @param offerFeeList
     */
    public void setOfferFeeList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SOfferFee[] offerFeeList) {
        this.offerFeeList = offerFeeList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SOfferFee getOfferFeeList(int i) {
        return this.offerFeeList[i];
    }

    public void setOfferFeeList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SOfferFee _value) {
