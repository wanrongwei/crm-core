...
public class DoQueryUnPayFeeResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CaBill[] billList;
    ...
    public DoQueryUnPayFeeResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CaBill[] billList) {
        super(
            responseHead);
        this.acctId = acctId;
     ...
     * @return billList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CaBill[] getBillList() {
        return billList;
    }
     ...
     * @param billList
     */
    public void setBillList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CaBill[] billList) {
        this.billList = billList;
    }
