/**
 * DoFirstActivationResponse.java
 *
...
public class DoFirstActivationResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductOrderResult[] prod_result_list;

    public DoFirstActivationResponse() {
    }
    ...
    /**
     * Gets the prod_result_list value for this DoFirstActivationResponse.
     * 
    ...
    /**
     * Sets the prod_result_list value for this DoFirstActivationResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        if (!(obj instanceof DoFirstActivationResponse)) return false;
        DoFirstActivationResponse other = (DoFirstActivationResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DoFirstActivationResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://imsintf.service.openbilling.ailk.com/", "doFirstActivationResponse"));
