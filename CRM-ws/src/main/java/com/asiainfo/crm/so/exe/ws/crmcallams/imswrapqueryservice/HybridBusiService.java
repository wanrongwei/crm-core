...
public class HybridBusiService  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SBusiService[] sBusiServiceList;
    ...
    public HybridBusiService(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SBusiService[] sBusiServiceList) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SBusiService[] getSBusiServiceList() {
        return sBusiServiceList;
    }
     ...
     */
    public void setSBusiServiceList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SBusiService[] sBusiServiceList) {
        this.sBusiServiceList = sBusiServiceList;
    }
