...
public class DoQueryAutoTopUpResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AutoTopUpQryResult[] autoTopUpResultList;
    ...
    public DoQueryAutoTopUpResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AutoTopUpQryResult[] autoTopUpResultList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AutoTopUpQryResult[] getAutoTopUpResultList() {
        return autoTopUpResultList;
    }
     ...
     */
    public void setAutoTopUpResultList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.AutoTopUpQryResult[] autoTopUpResultList) {
        this.autoTopUpResultList = autoTopUpResultList;
    }
