...
public class DoQueryTermBalanceResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SUserStatus userStatus;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SBalance[] termBalanceList;
    ...
    public DoQueryTermBalanceResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SUserStatus userStatus,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SBalance[] termBalanceList) {
        super(
            responseHead);
        this.acctId = acctId;
     ...
     * @return userStatus
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SUserStatus getUserStatus() {
        return userStatus;
    }
     ...
     * @param userStatus
     */
    public void setUserStatus(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SUserStatus userStatus) {
        this.userStatus = userStatus;
    }
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SBalance[] getTermBalanceList() {
        return termBalanceList;
    }
     ...
     */
    public void setTermBalanceList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SBalance[] termBalanceList) {
        this.termBalanceList = termBalanceList;
    }
