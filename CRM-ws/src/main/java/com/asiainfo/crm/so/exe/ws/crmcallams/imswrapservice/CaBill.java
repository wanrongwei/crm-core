...
public class CaBill  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CaBillItem[] caBillItemList;
    ...
    public CaBill(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CaBillItem[] caBillItemList) {
           this.billNo = billNo;
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CaBillItem[] getCaBillItemList() {
        return caBillItemList;
    }
     ...
     */
    public void setCaBillItemList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CaBillItem[] caBillItemList) {
        this.caBillItemList = caBillItemList;
    }
