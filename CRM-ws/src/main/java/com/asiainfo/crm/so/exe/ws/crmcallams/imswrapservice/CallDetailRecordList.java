...
public class CallDetailRecordList  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CallDetailRecord[] detailList;
    ...
    public CallDetailRecordList(
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CallDetailRecord[] detailList,
     ...
     * @return detailList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CallDetailRecord[] getDetailList() {
        return detailList;
    }
     ...
     * @param detailList
     */
    public void setDetailList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CallDetailRecord[] detailList) {
        this.detailList = detailList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CallDetailRecord getDetailList(int i) {
        return this.detailList[i];
    }

    public void setDetailList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.CallDetailRecord _value) {
