...
public class SAllowanceUsage  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SAllowanceOfferUsage[] offerLimits;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SFreeResource[] freeResList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SAllowanceRec[] allowanceRecList;
    ...
    public SAllowanceUsage(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SAllowanceOfferUsage[] offerLimits,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SFreeResource[] freeResList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SAllowanceRec[] allowanceRecList,
     ...
     * @return offerLimits
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SAllowanceOfferUsage[] getOfferLimits() {
        return offerLimits;
    }
     ...
     * @param offerLimits
     */
    public void setOfferLimits(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SAllowanceOfferUsage[] offerLimits) {
        this.offerLimits = offerLimits;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SAllowanceOfferUsage getOfferLimits(int i) {
        return this.offerLimits[i];
    }

    public void setOfferLimits(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SAllowanceOfferUsage _value) {
     ...
     * @return freeResList
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SFreeResource[] getFreeResList() {
        return freeResList;
    }
     ...
     * @param freeResList
     */
    public void setFreeResList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SFreeResource[] freeResList) {
        this.freeResList = freeResList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SFreeResource getFreeResList(int i) {
        return this.freeResList[i];
    }

    public void setFreeResList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SFreeResource _value) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SAllowanceRec[] getAllowanceRecList() {
        return allowanceRecList;
    }
     ...
     */
    public void setAllowanceRecList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SAllowanceRec[] allowanceRecList) {
        this.allowanceRecList = allowanceRecList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SAllowanceRec getAllowanceRecList(int i) {
        return this.allowanceRecList[i];
    }

    public void setAllowanceRecList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapservice.SAllowanceRec _value) {
