...
public class SProductOrderResult  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductParam[] productParamList;

    private com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.ExtendParam[] extendParamList;
    ...
    public SProductOrderResult(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductParam[] productParamList,
           com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.ExtendParam[] extendParamList) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductParam[] getProductParamList() {
        return productParamList;
    }
     ...
     */
    public void setProductParamList(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.SProductParam[] productParamList) {
        this.productParamList = productParamList;
    }
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.ExtendParam[] getExtendParamList() {
        return extendParamList;
    }
     ...
     */
    public void setExtendParamList(com.asiainfo.crm.so.exe.ws.crmcallams.imsservice.ExtendParam[] extendParamList) {
        this.extendParamList = extendParamList;
    }
