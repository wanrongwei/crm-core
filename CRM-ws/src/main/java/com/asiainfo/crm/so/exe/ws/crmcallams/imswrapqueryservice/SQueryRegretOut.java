...
public class SQueryRegretOut  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRegretErrorInfo[] regretErrorInfo;
    ...
    public SQueryRegretOut(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRegretErrorInfo[] regretErrorInfo) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRegretErrorInfo[] getRegretErrorInfo() {
        return regretErrorInfo;
    }
     ...
     */
    public void setRegretErrorInfo(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRegretErrorInfo[] regretErrorInfo) {
        this.regretErrorInfo = regretErrorInfo;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRegretErrorInfo getRegretErrorInfo(int i) {
        return this.regretErrorInfo[i];
    }

    public void setRegretErrorInfo(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRegretErrorInfo _value) {
