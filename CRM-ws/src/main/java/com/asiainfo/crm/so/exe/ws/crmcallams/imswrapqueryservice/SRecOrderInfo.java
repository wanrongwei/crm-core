...
public class SRecOrderInfo  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SCaBusiRecOffer[] caBusiRecOfferList;
    ...
    private com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRegretOfferInfo[] regretOfferList;
    ...
    public SRecOrderInfo(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SCaBusiRecOffer[] caBusiRecOfferList,
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRegretOfferInfo[] regretOfferList) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SCaBusiRecOffer[] getCaBusiRecOfferList() {
        return caBusiRecOfferList;
    }
     ...
     */
    public void setCaBusiRecOfferList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SCaBusiRecOffer[] caBusiRecOfferList) {
        this.caBusiRecOfferList = caBusiRecOfferList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SCaBusiRecOffer getCaBusiRecOfferList(int i) {
        return this.caBusiRecOfferList[i];
    }

    public void setCaBusiRecOfferList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SCaBusiRecOffer _value) {
     ...
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRegretOfferInfo[] getRegretOfferList() {
        return regretOfferList;
    }
     ...
     */
    public void setRegretOfferList(com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRegretOfferInfo[] regretOfferList) {
        this.regretOfferList = regretOfferList;
    }

    public com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRegretOfferInfo getRegretOfferList(int i) {
        return this.regretOfferList[i];
    }

    public void setRegretOfferList(int i, com.asiainfo.crm.so.exe.ws.crmcallams.imswrapqueryservice.SRegretOfferInfo _value) {
