...
public class DoQueryPCRFInfoResponse  extends com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.PcrfInfo pcrfInfo;
    ...
    public DoQueryPCRFInfoResponse(
           ...
           com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.PcrfInfo pcrfInfo) {
        super(
            responseHead);
     ...
     * @return pcrfInfo
     */
    public com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.PcrfInfo getPcrfInfo() {
        return pcrfInfo;
    }
     ...
     * @param pcrfInfo
     */
    public void setPcrfInfo(com.asiainfo.crm.so.exe.ws.crmcallams.imsqueryservice.PcrfInfo pcrfInfo) {
        this.pcrfInfo = pcrfInfo;
    }
