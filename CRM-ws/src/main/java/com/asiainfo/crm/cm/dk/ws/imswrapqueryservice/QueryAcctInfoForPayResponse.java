...
public class QueryAcctInfoForPayResponse  extends com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private java.lang.Boolean isMatch;

    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SAccount[] acctList;
    ...
    public QueryAcctInfoForPayResponse(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SAccount[] acctList) {
        super(
            responseHead);
     ...
     * @return acctList
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SAccount[] getAcctList() {
        return acctList;
    }
     ...
     * @param acctList
     */
    public void setAcctList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SAccount[] acctList) {
        this.acctList = acctList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SAccount getAcctList(int i) {
        return this.acctList[i];
    }

    public void setAcctList(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SAccount _value) {
