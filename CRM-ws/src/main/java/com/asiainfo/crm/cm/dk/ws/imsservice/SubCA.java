...
public class SubCA  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.cm.dk.ws.imsservice.SAddSubscriber[] user_list;
    ...
    public SubCA(
           ...
           com.asiainfo.crm.cm.dk.ws.imsservice.SAddSubscriber[] user_list) {
     ...
     * @return user_list
     */
    public com.asiainfo.crm.cm.dk.ws.imsservice.SAddSubscriber[] getUser_list() {
        return user_list;
    }
     ...
     * @param user_list
     */
    public void setUser_list(com.asiainfo.crm.cm.dk.ws.imsservice.SAddSubscriber[] user_list) {
        this.user_list = user_list;
    }
