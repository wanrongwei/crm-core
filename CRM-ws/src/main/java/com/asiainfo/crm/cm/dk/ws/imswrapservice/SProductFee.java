...
public class SProductFee  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.cm.dk.ws.imswrapservice.SMonthlyFee[] monthlyFeeList;
    ...
    public SProductFee(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapservice.SMonthlyFee[] monthlyFeeList) {
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapservice.SMonthlyFee[] getMonthlyFeeList() {
        return monthlyFeeList;
    }
     ...
     */
    public void setMonthlyFeeList(com.asiainfo.crm.cm.dk.ws.imswrapservice.SMonthlyFee[] monthlyFeeList) {
        this.monthlyFeeList = monthlyFeeList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapservice.SMonthlyFee getMonthlyFeeList(int i) {
        return this.monthlyFeeList[i];
    }

    public void setMonthlyFeeList(int i, com.asiainfo.crm.cm.dk.ws.imswrapservice.SMonthlyFee _value) {
