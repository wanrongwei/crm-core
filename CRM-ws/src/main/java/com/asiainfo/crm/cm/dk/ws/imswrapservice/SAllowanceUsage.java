...
public class SAllowanceUsage  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.cm.dk.ws.imswrapservice.SAllowanceOfferUsage[] offerLimits;

    private com.asiainfo.crm.cm.dk.ws.imswrapservice.SFreeResource[] freeResList;

    private com.asiainfo.crm.cm.dk.ws.imswrapservice.SAllowanceRec[] allowanceRecList;

    private com.asiainfo.crm.cm.dk.ws.imswrapservice.AssetChgIn[] assetChgs;
    ...
    public SAllowanceUsage(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapservice.SAllowanceOfferUsage[] offerLimits,
           com.asiainfo.crm.cm.dk.ws.imswrapservice.SFreeResource[] freeResList,
           com.asiainfo.crm.cm.dk.ws.imswrapservice.SAllowanceRec[] allowanceRecList,
           com.asiainfo.crm.cm.dk.ws.imswrapservice.AssetChgIn[] assetChgs) {
     ...
     * @return offerLimits
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapservice.SAllowanceOfferUsage[] getOfferLimits() {
        return offerLimits;
    }
     ...
     * @param offerLimits
     */
    public void setOfferLimits(com.asiainfo.crm.cm.dk.ws.imswrapservice.SAllowanceOfferUsage[] offerLimits) {
        this.offerLimits = offerLimits;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapservice.SAllowanceOfferUsage getOfferLimits(int i) {
        return this.offerLimits[i];
    }

    public void setOfferLimits(int i, com.asiainfo.crm.cm.dk.ws.imswrapservice.SAllowanceOfferUsage _value) {
     ...
     * @return freeResList
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapservice.SFreeResource[] getFreeResList() {
        return freeResList;
    }
     ...
     * @param freeResList
     */
    public void setFreeResList(com.asiainfo.crm.cm.dk.ws.imswrapservice.SFreeResource[] freeResList) {
        this.freeResList = freeResList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapservice.SFreeResource getFreeResList(int i) {
        return this.freeResList[i];
    }

    public void setFreeResList(int i, com.asiainfo.crm.cm.dk.ws.imswrapservice.SFreeResource _value) {
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapservice.SAllowanceRec[] getAllowanceRecList() {
        return allowanceRecList;
    }
     ...
     */
    public void setAllowanceRecList(com.asiainfo.crm.cm.dk.ws.imswrapservice.SAllowanceRec[] allowanceRecList) {
        this.allowanceRecList = allowanceRecList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapservice.SAllowanceRec getAllowanceRecList(int i) {
        return this.allowanceRecList[i];
    }

    public void setAllowanceRecList(int i, com.asiainfo.crm.cm.dk.ws.imswrapservice.SAllowanceRec _value) {
     ...
     * @return assetChgs
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapservice.AssetChgIn[] getAssetChgs() {
        return assetChgs;
    }
     ...
     * @param assetChgs
     */
    public void setAssetChgs(com.asiainfo.crm.cm.dk.ws.imswrapservice.AssetChgIn[] assetChgs) {
        this.assetChgs = assetChgs;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapservice.AssetChgIn getAssetChgs(int i) {
        return this.assetChgs[i];
    }

    public void setAssetChgs(int i, com.asiainfo.crm.cm.dk.ws.imswrapservice.AssetChgIn _value) {
