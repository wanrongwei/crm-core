...
public class SPage  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.cm.dk.ws.imsservice.SOrderField[] orderFieldList;
    ...
    public SPage(
           ...
           com.asiainfo.crm.cm.dk.ws.imsservice.SOrderField[] orderFieldList) {
           this.num = num;
           this.size = size;
           this.count = count;
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imsservice.SOrderField[] getOrderFieldList() {
        return orderFieldList;
    }
     ...
     */
    public void setOrderFieldList(com.asiainfo.crm.cm.dk.ws.imsservice.SOrderField[] orderFieldList) {
        this.orderFieldList = orderFieldList;
    }

    public com.asiainfo.crm.cm.dk.ws.imsservice.SOrderField getOrderFieldList(int i) {
        return this.orderFieldList[i];
    }

    public void setOrderFieldList(int i, com.asiainfo.crm.cm.dk.ws.imsservice.SOrderField _value) {
