...
public class DoMailGroupManageResponse  extends com.asiainfo.crm.cm.dk.ws.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapservice.AccountMail[] accountMail;
    ...
    public DoMailGroupManageResponse(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapservice.AccountMail[] accountMail) {
        super(
            responseHead);
     ...
     * @return accountMail
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapservice.AccountMail[] getAccountMail() {
        return accountMail;
    }
     ...
     * @param accountMail
     */
    public void setAccountMail(com.asiainfo.crm.cm.dk.ws.imswrapservice.AccountMail[] accountMail) {
        this.accountMail = accountMail;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapservice.AccountMail getAccountMail(int i) {
        return this.accountMail[i];
    }

    public void setAccountMail(int i, com.asiainfo.crm.cm.dk.ws.imswrapservice.AccountMail _value) {
