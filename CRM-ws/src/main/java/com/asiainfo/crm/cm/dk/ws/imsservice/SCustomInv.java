...
public class SCustomInv  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.cm.dk.ws.imsservice.SProductRecurringFee[] feeList;

    private com.asiainfo.crm.cm.dk.ws.imsservice.SCustomInvDtl[] cacustomInvDtl;
    ...
    public SCustomInv(
           ...
           com.asiainfo.crm.cm.dk.ws.imsservice.SProductRecurringFee[] feeList,
           com.asiainfo.crm.cm.dk.ws.imsservice.SCustomInvDtl[] cacustomInvDtl,
     ...
     * @return feeList
     */
    public com.asiainfo.crm.cm.dk.ws.imsservice.SProductRecurringFee[] getFeeList() {
        return feeList;
    }
     ...
     * @param feeList
     */
    public void setFeeList(com.asiainfo.crm.cm.dk.ws.imsservice.SProductRecurringFee[] feeList) {
        this.feeList = feeList;
    }

    public com.asiainfo.crm.cm.dk.ws.imsservice.SProductRecurringFee getFeeList(int i) {
        return this.feeList[i];
    }

    public void setFeeList(int i, com.asiainfo.crm.cm.dk.ws.imsservice.SProductRecurringFee _value) {
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imsservice.SCustomInvDtl[] getCacustomInvDtl() {
        return cacustomInvDtl;
    }
     ...
     */
    public void setCacustomInvDtl(com.asiainfo.crm.cm.dk.ws.imsservice.SCustomInvDtl[] cacustomInvDtl) {
        this.cacustomInvDtl = cacustomInvDtl;
    }

    public com.asiainfo.crm.cm.dk.ws.imsservice.SCustomInvDtl getCacustomInvDtl(int i) {
        return this.cacustomInvDtl[i];
    }

    public void setCacustomInvDtl(int i, com.asiainfo.crm.cm.dk.ws.imsservice.SCustomInvDtl _value) {
