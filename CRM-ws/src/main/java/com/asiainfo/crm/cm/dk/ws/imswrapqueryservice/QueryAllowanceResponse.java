...
public class QueryAllowanceResponse  extends com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SAllowanceUsage[] allowanceUsageResp;
    ...
    public QueryAllowanceResponse(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SAllowanceUsage[] allowanceUsageResp) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SAllowanceUsage[] getAllowanceUsageResp() {
        return allowanceUsageResp;
    }
     ...
     */
    public void setAllowanceUsageResp(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SAllowanceUsage[] allowanceUsageResp) {
        this.allowanceUsageResp = allowanceUsageResp;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SAllowanceUsage getAllowanceUsageResp(int i) {
        return this.allowanceUsageResp[i];
    }

    public void setAllowanceUsageResp(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SAllowanceUsage _value) {
