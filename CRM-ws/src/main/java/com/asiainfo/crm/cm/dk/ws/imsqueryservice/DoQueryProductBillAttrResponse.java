...
public class DoQueryProductBillAttrResponse  extends com.asiainfo.crm.cm.dk.ws.imsqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private java.lang.Integer productOfferingId;

    private java.lang.String productOfferingName;

    private com.asiainfo.crm.cm.dk.ws.imsqueryservice.SProductRecurringFee[] feeList;
    ...
    public DoQueryProductBillAttrResponse(
           ...
           com.asiainfo.crm.cm.dk.ws.imsqueryservice.SProductRecurringFee[] feeList) {
        super(
            responseHead);
     ...
     * @return feeList
     */
    public com.asiainfo.crm.cm.dk.ws.imsqueryservice.SProductRecurringFee[] getFeeList() {
        return feeList;
    }
     ...
     * @param feeList
     */
    public void setFeeList(com.asiainfo.crm.cm.dk.ws.imsqueryservice.SProductRecurringFee[] feeList) {
        this.feeList = feeList;
    }

    public com.asiainfo.crm.cm.dk.ws.imsqueryservice.SProductRecurringFee getFeeList(int i) {
        return this.feeList[i];
    }

    public void setFeeList(int i, com.asiainfo.crm.cm.dk.ws.imsqueryservice.SProductRecurringFee _value) {
