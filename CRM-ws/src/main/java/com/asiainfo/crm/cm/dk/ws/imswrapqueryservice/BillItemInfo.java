...
public class BillItemInfo  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.BillItemValue[] billItemValue;
    ...
    public BillItemInfo(
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.BillItemValue[] billItemValue,
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.BillItemValue[] getBillItemValue() {
        return billItemValue;
    }
     ...
     * @param billItemValue
     */
    public void setBillItemValue(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.BillItemValue[] billItemValue) {
        this.billItemValue = billItemValue;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.BillItemValue getBillItemValue(int i) {
        return this.billItemValue[i];
    }

    public void setBillItemValue(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.BillItemValue _value) {
