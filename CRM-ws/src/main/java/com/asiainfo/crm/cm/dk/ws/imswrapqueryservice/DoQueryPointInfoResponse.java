...
public class DoQueryPointInfoResponse  extends com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.QryPointOut[] qryPointOutList;
    ...
    public DoQueryPointInfoResponse(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.QryPointOut[] qryPointOutList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.QryPointOut[] getQryPointOutList() {
        return qryPointOutList;
    }
     ...
     */
    public void setQryPointOutList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.QryPointOut[] qryPointOutList) {
        this.qryPointOutList = qryPointOutList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.QryPointOut getQryPointOutList(int i) {
        return this.qryPointOutList[i];
    }

    public void setQryPointOutList(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.QryPointOut _value) {
