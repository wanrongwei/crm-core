...
public class DoQueryAgentDepositResponse  extends com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ImsAgentDepositQueryResult[] agentDepositQueryResultList;
    ...
    public DoQueryAgentDepositResponse(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ImsAgentDepositQueryResult[] agentDepositQueryResultList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ImsAgentDepositQueryResult[] getAgentDepositQueryResultList() {
        return agentDepositQueryResultList;
    }
     ...
     */
    public void setAgentDepositQueryResultList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ImsAgentDepositQueryResult[] agentDepositQueryResultList) {
        this.agentDepositQueryResultList = agentDepositQueryResultList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ImsAgentDepositQueryResult getAgentDepositQueryResultList(int i) {
        return this.agentDepositQueryResultList[i];
    }

    public void setAgentDepositQueryResultList(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ImsAgentDepositQueryResult _value) {
