...
public class DoQuerySuppressNotificationResponse  extends com.asiainfo.crm.cm.dk.ws.imsqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imsqueryservice.AcctNotify[] acctNotifyList;

    private com.asiainfo.crm.cm.dk.ws.imsqueryservice.PhoneNotify[] phoneNotifyList;
    ...
    public DoQuerySuppressNotificationResponse(
           ...
           com.asiainfo.crm.cm.dk.ws.imsqueryservice.AcctNotify[] acctNotifyList,
           com.asiainfo.crm.cm.dk.ws.imsqueryservice.PhoneNotify[] phoneNotifyList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imsqueryservice.AcctNotify[] getAcctNotifyList() {
        return acctNotifyList;
    }
     ...
     */
    public void setAcctNotifyList(com.asiainfo.crm.cm.dk.ws.imsqueryservice.AcctNotify[] acctNotifyList) {
        this.acctNotifyList = acctNotifyList;
    }

    public com.asiainfo.crm.cm.dk.ws.imsqueryservice.AcctNotify getAcctNotifyList(int i) {
        return this.acctNotifyList[i];
    }

    public void setAcctNotifyList(int i, com.asiainfo.crm.cm.dk.ws.imsqueryservice.AcctNotify _value) {
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imsqueryservice.PhoneNotify[] getPhoneNotifyList() {
        return phoneNotifyList;
    }
     ...
     */
    public void setPhoneNotifyList(com.asiainfo.crm.cm.dk.ws.imsqueryservice.PhoneNotify[] phoneNotifyList) {
        this.phoneNotifyList = phoneNotifyList;
    }

    public com.asiainfo.crm.cm.dk.ws.imsqueryservice.PhoneNotify getPhoneNotifyList(int i) {
        return this.phoneNotifyList[i];
    }

    public void setPhoneNotifyList(int i, com.asiainfo.crm.cm.dk.ws.imsqueryservice.PhoneNotify _value) {
