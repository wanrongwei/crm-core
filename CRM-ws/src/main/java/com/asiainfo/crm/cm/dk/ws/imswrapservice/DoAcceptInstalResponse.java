...
public class DoAcceptInstalResponse  extends com.asiainfo.crm.cm.dk.ws.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapservice.SInstalInfo[] instalInfoList;
    ...
    public DoAcceptInstalResponse(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapservice.SInstalInfo[] instalInfoList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapservice.SInstalInfo[] getInstalInfoList() {
        return instalInfoList;
    }
     ...
     */
    public void setInstalInfoList(com.asiainfo.crm.cm.dk.ws.imswrapservice.SInstalInfo[] instalInfoList) {
        this.instalInfoList = instalInfoList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapservice.SInstalInfo getInstalInfoList(int i) {
        return this.instalInfoList[i];
    }

    public void setInstalInfoList(int i, com.asiainfo.crm.cm.dk.ws.imswrapservice.SInstalInfo _value) {
