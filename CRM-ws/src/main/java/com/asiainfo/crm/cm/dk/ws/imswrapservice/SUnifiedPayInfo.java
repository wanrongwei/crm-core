...
public class SUnifiedPayInfo  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapservice.SInstalInfo[] instalInfo;

    private com.asiainfo.crm.cm.dk.ws.imswrapservice.SPayDetail[] allowancePayDetails;
    ...
    public SUnifiedPayInfo(
           com.asiainfo.crm.cm.dk.ws.imswrapservice.SInstalInfo[] instalInfo,
           com.asiainfo.crm.cm.dk.ws.imswrapservice.SPayDetail[] allowancePayDetails,
     ...
     * @return instalInfo
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapservice.SInstalInfo[] getInstalInfo() {
        return instalInfo;
    }
     ...
     * @param instalInfo
     */
    public void setInstalInfo(com.asiainfo.crm.cm.dk.ws.imswrapservice.SInstalInfo[] instalInfo) {
        this.instalInfo = instalInfo;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapservice.SInstalInfo getInstalInfo(int i) {
        return this.instalInfo[i];
    }

    public void setInstalInfo(int i, com.asiainfo.crm.cm.dk.ws.imswrapservice.SInstalInfo _value) {
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapservice.SPayDetail[] getAllowancePayDetails() {
        return allowancePayDetails;
    }
     ...
     */
    public void setAllowancePayDetails(com.asiainfo.crm.cm.dk.ws.imswrapservice.SPayDetail[] allowancePayDetails) {
        this.allowancePayDetails = allowancePayDetails;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapservice.SPayDetail getAllowancePayDetails(int i) {
        return this.allowancePayDetails[i];
    }

    public void setAllowancePayDetails(int i, com.asiainfo.crm.cm.dk.ws.imswrapservice.SPayDetail _value) {
