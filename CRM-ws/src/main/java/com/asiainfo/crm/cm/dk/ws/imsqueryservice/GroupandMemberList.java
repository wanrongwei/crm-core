...
public class GroupandMemberList  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imsqueryservice.SMember[] sMemberList;

    private com.asiainfo.crm.cm.dk.ws.imsqueryservice.SGroup sGroup;

    public GroupandMemberList() {
    }

    public GroupandMemberList(
           com.asiainfo.crm.cm.dk.ws.imsqueryservice.SMember[] sMemberList,
           com.asiainfo.crm.cm.dk.ws.imsqueryservice.SGroup sGroup) {
     ...
     * @return sMemberList
     */
    public com.asiainfo.crm.cm.dk.ws.imsqueryservice.SMember[] getSMemberList() {
        return sMemberList;
    }
     ...
     * @param sMemberList
     */
    public void setSMemberList(com.asiainfo.crm.cm.dk.ws.imsqueryservice.SMember[] sMemberList) {
        this.sMemberList = sMemberList;
    }
     ...
     * @return sGroup
     */
    public com.asiainfo.crm.cm.dk.ws.imsqueryservice.SGroup getSGroup() {
        return sGroup;
    }
     ...
     * @param sGroup
     */
    public void setSGroup(com.asiainfo.crm.cm.dk.ws.imsqueryservice.SGroup sGroup) {
        this.sGroup = sGroup;
    }
