...
public class AdjustMultiBillInReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.cm.dk.ws.imswrapservice.AdjustMultiBillDtl[] listAdjustDtl;
    ...
    public AdjustMultiBillInReq(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapservice.AdjustMultiBillDtl[] listAdjustDtl,
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapservice.AdjustMultiBillDtl[] getListAdjustDtl() {
        return listAdjustDtl;
    }
     ...
     * @param listAdjustDtl
     */
    public void setListAdjustDtl(com.asiainfo.crm.cm.dk.ws.imswrapservice.AdjustMultiBillDtl[] listAdjustDtl) {
        this.listAdjustDtl = listAdjustDtl;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapservice.AdjustMultiBillDtl getListAdjustDtl(int i) {
        return this.listAdjustDtl[i];
    }

    public void setListAdjustDtl(int i, com.asiainfo.crm.cm.dk.ws.imswrapservice.AdjustMultiBillDtl _value) {
