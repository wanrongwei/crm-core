...
public class ScdrBusiInfo  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.PhoneId[] phoneIdList;

    private java.lang.String startDate;

    private java.lang.String endDate;

    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ServiceId[] serviceIdList;
    ...
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.BillItemInfo[] billItemList;
    ...
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.Service[] service;
    ...
    public ScdrBusiInfo(
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.PhoneId[] phoneIdList,
           java.lang.String startDate,
           java.lang.String endDate,
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ServiceId[] serviceIdList,
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.BillItemInfo[] billItemList,
           java.lang.Integer isFreeRes,
           java.lang.Boolean isUsageType,
           java.lang.Long tenantId,
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.Service[] service,
     ...
     * @return phoneIdList
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.PhoneId[] getPhoneIdList() {
        return phoneIdList;
    }
     ...
     * @param phoneIdList
     */
    public void setPhoneIdList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.PhoneId[] phoneIdList) {
        this.phoneIdList = phoneIdList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.PhoneId getPhoneIdList(int i) {
        return this.phoneIdList[i];
    }

    public void setPhoneIdList(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.PhoneId _value) {
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ServiceId[] getServiceIdList() {
        return serviceIdList;
    }
     ...
     * @param serviceIdList
     */
    public void setServiceIdList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ServiceId[] serviceIdList) {
        this.serviceIdList = serviceIdList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ServiceId getServiceIdList(int i) {
        return this.serviceIdList[i];
    }

    public void setServiceIdList(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ServiceId _value) {
     ...
     * @return billItemList
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.BillItemInfo[] getBillItemList() {
        return billItemList;
    }
     ...
     * @param billItemList
     */
    public void setBillItemList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.BillItemInfo[] billItemList) {
        this.billItemList = billItemList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.BillItemInfo getBillItemList(int i) {
        return this.billItemList[i];
    }

    public void setBillItemList(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.BillItemInfo _value) {
     ...
     * @return service
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.Service[] getService() {
        return service;
    }
     ...
     * @param service
     */
    public void setService(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.Service[] service) {
        this.service = service;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.Service getService(int i) {
        return this.service[i];
    }

    public void setService(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.Service _value) {
