...
public class DoNetaxeptRegisterReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.cm.dk.ws.imsservice.RegisterRequest request;
    ...
    public DoNetaxeptRegisterReq(
           ...
           com.asiainfo.crm.cm.dk.ws.imsservice.RegisterRequest request) {
     ...
     * @return request
     */
    public com.asiainfo.crm.cm.dk.ws.imsservice.RegisterRequest getRequest() {
        return request;
    }
     ...
     * @param request
     */
    public void setRequest(com.asiainfo.crm.cm.dk.ws.imsservice.RegisterRequest request) {
        this.request = request;
    }
