...
public class STransferTransformRuleResponse  extends com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ResponseHead responseHead;

    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.STransferTransformRule[] sTransferTransformRules;

    public STransferTransformRuleResponse() {
    }

    public STransferTransformRuleResponse(
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ResponseHead _responseHead,
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ResponseHead responseHead,
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.STransferTransformRule[] sTransferTransformRules) {
        super(
            _responseHead);
     ...
     * @return responseHead
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ResponseHead getResponseHead() {
        return responseHead;
    }
     ...
     * @param responseHead
     */
    public void setResponseHead(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ResponseHead responseHead) {
        this.responseHead = responseHead;
    }
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.STransferTransformRule[] getSTransferTransformRules() {
        return sTransferTransformRules;
    }
     ...
     */
    public void setSTransferTransformRules(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.STransferTransformRule[] sTransferTransformRules) {
        this.sTransferTransformRules = sTransferTransformRules;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.STransferTransformRule getSTransferTransformRules(int i) {
        return this.sTransferTransformRules[i];
    }

    public void setSTransferTransformRules(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.STransferTransformRule _value) {
