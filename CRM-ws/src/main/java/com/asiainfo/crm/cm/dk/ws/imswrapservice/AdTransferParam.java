...
public class AdTransferParam  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.cm.dk.ws.imswrapservice.TransferDetail[] targetTransDetails;
    ...
    public AdTransferParam(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapservice.TransferDetail[] targetTransDetails) {
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapservice.TransferDetail[] getTargetTransDetails() {
        return targetTransDetails;
    }
     ...
     */
    public void setTargetTransDetails(com.asiainfo.crm.cm.dk.ws.imswrapservice.TransferDetail[] targetTransDetails) {
        this.targetTransDetails = targetTransDetails;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapservice.TransferDetail getTargetTransDetails(int i) {
        return this.targetTransDetails[i];
    }

    public void setTargetTransDetails(int i, com.asiainfo.crm.cm.dk.ws.imswrapservice.TransferDetail _value) {
