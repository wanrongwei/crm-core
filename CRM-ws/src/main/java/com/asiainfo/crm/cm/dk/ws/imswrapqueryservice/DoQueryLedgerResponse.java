...
public class DoQueryLedgerResponse  extends com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQueryLedgerOut[] ledgerOutList;
    ...
    public DoQueryLedgerResponse(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQueryLedgerOut[] ledgerOutList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQueryLedgerOut[] getLedgerOutList() {
        return ledgerOutList;
    }
     ...
     * @param ledgerOutList
     */
    public void setLedgerOutList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQueryLedgerOut[] ledgerOutList) {
        this.ledgerOutList = ledgerOutList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQueryLedgerOut getLedgerOutList(int i) {
        return this.ledgerOutList[i];
    }

    public void setLedgerOutList(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQueryLedgerOut _value) {
