...
public class SOfferInfo  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SOfferFee[] offerFeeList;
    ...
    public SOfferInfo(
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SOfferFee[] offerFeeList,
     ...
     * @return offerFeeList
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SOfferFee[] getOfferFeeList() {
        return offerFeeList;
    }
     ...
     * @param offerFeeList
     */
    public void setOfferFeeList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SOfferFee[] offerFeeList) {
        this.offerFeeList = offerFeeList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SOfferFee getOfferFeeList(int i) {
        return this.offerFeeList[i];
    }

    public void setOfferFeeList(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SOfferFee _value) {
