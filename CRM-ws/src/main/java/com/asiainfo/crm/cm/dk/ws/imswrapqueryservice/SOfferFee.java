...
public class SOfferFee  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SDiscountInfo[] discountList;
    ...
    public SOfferFee(
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SDiscountInfo[] discountList,
     ...
     * @return discountList
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SDiscountInfo[] getDiscountList() {
        return discountList;
    }
     ...
     * @param discountList
     */
    public void setDiscountList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SDiscountInfo[] discountList) {
        this.discountList = discountList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SDiscountInfo getDiscountList(int i) {
        return this.discountList[i];
    }

    public void setDiscountList(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SDiscountInfo _value) {
