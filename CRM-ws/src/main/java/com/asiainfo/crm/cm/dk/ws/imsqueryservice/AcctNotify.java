...
public class AcctNotify  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imsqueryservice.Notify[] notifyList_item;
    ...
    public AcctNotify(
           com.asiainfo.crm.cm.dk.ws.imsqueryservice.Notify[] notifyList_item,
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imsqueryservice.Notify[] getNotifyList_item() {
        return notifyList_item;
    }
     ...
     */
    public void setNotifyList_item(com.asiainfo.crm.cm.dk.ws.imsqueryservice.Notify[] notifyList_item) {
        this.notifyList_item = notifyList_item;
    }

    public com.asiainfo.crm.cm.dk.ws.imsqueryservice.Notify getNotifyList_item(int i) {
        return this.notifyList_item[i];
    }

    public void setNotifyList_item(int i, com.asiainfo.crm.cm.dk.ws.imsqueryservice.Notify _value) {
