...
public class DoQueryOrderInfoReq  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQryOrderIn qryOrderIn;

    public DoQueryOrderInfoReq() {
    }

    public DoQueryOrderInfoReq(
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQryOrderIn qryOrderIn) {
     ...
     * @return qryOrderIn
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQryOrderIn getQryOrderIn() {
        return qryOrderIn;
    }
     ...
     * @param qryOrderIn
     */
    public void setQryOrderIn(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQryOrderIn qryOrderIn) {
        this.qryOrderIn = qryOrderIn;
    }
