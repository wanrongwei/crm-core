...
public class SPage  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SOrderField[] orderFieldList;
    ...
    public SPage(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SOrderField[] orderFieldList) {
           this.num = num;
           this.size = size;
           this.count = count;
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SOrderField[] getOrderFieldList() {
        return orderFieldList;
    }
     ...
     */
    public void setOrderFieldList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SOrderField[] orderFieldList) {
        this.orderFieldList = orderFieldList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SOrderField getOrderFieldList(int i) {
        return this.orderFieldList[i];
    }

    public void setOrderFieldList(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SOrderField _value) {
