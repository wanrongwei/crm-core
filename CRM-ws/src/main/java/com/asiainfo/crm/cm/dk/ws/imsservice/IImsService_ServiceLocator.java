...
public class IImsService_ServiceLocator extends org.apache.axis.client.Service implements com.asiainfo.crm.cm.dk.ws.imsservice.IImsService_Service {
    ...
    public com.asiainfo.crm.cm.dk.ws.imsservice.IImsServiceWs getIImsService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.asiainfo.crm.cm.dk.ws.imsservice.IImsServiceSoapBindingStub _stub = new com.asiainfo.crm.cm.dk.ws.imsservice.IImsServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.asiainfo.crm.cm.dk.ws.imsservice.IImsServiceWs.class.isAssignableFrom(serviceEndpointInterface)) {
                com.asiainfo.crm.cm.dk.ws.imsservice.IImsServiceSoapBindingStub _stub = new com.asiainfo.crm.cm.dk.ws.imsservice.IImsServiceSoapBindingStub(new java.net.URL(IImsService_address), this);
                _stub.setPortName(getIImsServiceWSDDServiceName());
                return _stub;
            }
        }
