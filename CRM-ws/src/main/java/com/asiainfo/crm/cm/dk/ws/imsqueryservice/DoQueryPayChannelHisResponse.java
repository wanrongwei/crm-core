...
public class DoQueryPayChannelHisResponse  extends com.asiainfo.crm.cm.dk.ws.imsqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imsqueryservice.PayChannelHisInfo[] payChannelHisInfoList;
    ...
    public DoQueryPayChannelHisResponse(
           ...
           com.asiainfo.crm.cm.dk.ws.imsqueryservice.PayChannelHisInfo[] payChannelHisInfoList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imsqueryservice.PayChannelHisInfo[] getPayChannelHisInfoList() {
        return payChannelHisInfoList;
    }
     ...
     */
    public void setPayChannelHisInfoList(com.asiainfo.crm.cm.dk.ws.imsqueryservice.PayChannelHisInfo[] payChannelHisInfoList) {
        this.payChannelHisInfoList = payChannelHisInfoList;
    }

    public com.asiainfo.crm.cm.dk.ws.imsqueryservice.PayChannelHisInfo getPayChannelHisInfoList(int i) {
        return this.payChannelHisInfoList[i];
    }

    public void setPayChannelHisInfoList(int i, com.asiainfo.crm.cm.dk.ws.imsqueryservice.PayChannelHisInfo _value) {
