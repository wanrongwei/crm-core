...
public class DoQueryCapMaxResponse  extends com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CapMaxAccumulate[] capMaxAccumulateList;
    ...
    public DoQueryCapMaxResponse(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CapMaxAccumulate[] capMaxAccumulateList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CapMaxAccumulate[] getCapMaxAccumulateList() {
        return capMaxAccumulateList;
    }
     ...
     */
    public void setCapMaxAccumulateList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CapMaxAccumulate[] capMaxAccumulateList) {
        this.capMaxAccumulateList = capMaxAccumulateList;
    }
