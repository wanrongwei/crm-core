...
public class UionChargeReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.cm.dk.ws.imswrapservice.ReceiptInfo[] receiptInfoList;
    ...
    public UionChargeReq(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapservice.ReceiptInfo[] receiptInfoList) {
           this.acctId = acctId;
           this.amount = amount;
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapservice.ReceiptInfo[] getReceiptInfoList() {
        return receiptInfoList;
    }
     ...
     */
    public void setReceiptInfoList(com.asiainfo.crm.cm.dk.ws.imswrapservice.ReceiptInfo[] receiptInfoList) {
        this.receiptInfoList = receiptInfoList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapservice.ReceiptInfo getReceiptInfoList(int i) {
        return this.receiptInfoList[i];
    }

    public void setReceiptInfoList(int i, com.asiainfo.crm.cm.dk.ws.imswrapservice.ReceiptInfo _value) {
