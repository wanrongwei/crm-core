...
public class DoProductAuthReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.cm.dk.ws.imsservice.SProductOrder[] prodList;
    ...
    public DoProductAuthReq(
           ...
           com.asiainfo.crm.cm.dk.ws.imsservice.SProductOrder[] prodList) {
     ...
     * @return prodList
     */
    public com.asiainfo.crm.cm.dk.ws.imsservice.SProductOrder[] getProdList() {
        return prodList;
    }
     ...
     * @param prodList
     */
    public void setProdList(com.asiainfo.crm.cm.dk.ws.imsservice.SProductOrder[] prodList) {
        this.prodList = prodList;
    }
