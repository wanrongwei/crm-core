...
public class DoQueryOrderInfoResponse  extends com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQryOrderOut[] qryOrderOut;
    ...
    public DoQueryOrderInfoResponse(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQryOrderOut[] qryOrderOut) {
        super(
            responseHead);
     ...
     * @return qryOrderOut
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQryOrderOut[] getQryOrderOut() {
        return qryOrderOut;
    }
     ...
     * @param qryOrderOut
     */
    public void setQryOrderOut(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQryOrderOut[] qryOrderOut) {
        this.qryOrderOut = qryOrderOut;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQryOrderOut getQryOrderOut(int i) {
        return this.qryOrderOut[i];
    }

    public void setQryOrderOut(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQryOrderOut _value) {
