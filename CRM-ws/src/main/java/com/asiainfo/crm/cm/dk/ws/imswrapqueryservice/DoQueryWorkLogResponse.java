...
public class DoQueryWorkLogResponse  extends com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.RechargeLog[] rechargeLogList;

    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.AdjustLog[] adjustLogList;

    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.TransferLog[] transferLogList;

    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.PaymentLog[] paymentLogList;

    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.NegativeBalanceLog[] negativebalLogList;

    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.MaxFreeResourceLog[] maxFreesourceLogList;
    ...
    public DoQueryWorkLogResponse(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.RechargeLog[] rechargeLogList,
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.AdjustLog[] adjustLogList,
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.TransferLog[] transferLogList,
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.PaymentLog[] paymentLogList,
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.NegativeBalanceLog[] negativebalLogList,
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.MaxFreeResourceLog[] maxFreesourceLogList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.RechargeLog[] getRechargeLogList() {
        return rechargeLogList;
    }
     ...
     */
    public void setRechargeLogList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.RechargeLog[] rechargeLogList) {
        this.rechargeLogList = rechargeLogList;
    }
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.AdjustLog[] getAdjustLogList() {
        return adjustLogList;
    }
     ...
     * @param adjustLogList
     */
    public void setAdjustLogList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.AdjustLog[] adjustLogList) {
        this.adjustLogList = adjustLogList;
    }
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.TransferLog[] getTransferLogList() {
        return transferLogList;
    }
     ...
     */
    public void setTransferLogList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.TransferLog[] transferLogList) {
        this.transferLogList = transferLogList;
    }
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.PaymentLog[] getPaymentLogList() {
        return paymentLogList;
    }
     ...
     */
    public void setPaymentLogList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.PaymentLog[] paymentLogList) {
        this.paymentLogList = paymentLogList;
    }
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.NegativeBalanceLog[] getNegativebalLogList() {
        return negativebalLogList;
    }
     ...
     */
    public void setNegativebalLogList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.NegativeBalanceLog[] negativebalLogList) {
        this.negativebalLogList = negativebalLogList;
    }
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.MaxFreeResourceLog[] getMaxFreesourceLogList() {
        return maxFreesourceLogList;
    }
     ...
     */
    public void setMaxFreesourceLogList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.MaxFreeResourceLog[] maxFreesourceLogList) {
        this.maxFreesourceLogList = maxFreesourceLogList;
    }
