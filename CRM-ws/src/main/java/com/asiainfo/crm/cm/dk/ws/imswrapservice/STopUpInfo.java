...
public class STopUpInfo  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.cm.dk.ws.imswrapservice.SRewardAsset[] sRewardAssetList;
    ...
    public STopUpInfo(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapservice.SRewardAsset[] sRewardAssetList) {
           this.userId = userId;
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapservice.SRewardAsset[] getSRewardAssetList() {
        return sRewardAssetList;
    }
     ...
     */
    public void setSRewardAssetList(com.asiainfo.crm.cm.dk.ws.imswrapservice.SRewardAsset[] sRewardAssetList) {
        this.sRewardAssetList = sRewardAssetList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapservice.SRewardAsset getSRewardAssetList(int i) {
        return this.sRewardAssetList[i];
    }

    public void setSRewardAssetList(int i, com.asiainfo.crm.cm.dk.ws.imswrapservice.SRewardAsset _value) {
