...
public class DoCancelOrderReq  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapservice.SOrderInfo orderInfo;

    public DoCancelOrderReq() {
    }

    public DoCancelOrderReq(
           com.asiainfo.crm.cm.dk.ws.imswrapservice.SOrderInfo orderInfo) {
     ...
     * @return orderInfo
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapservice.SOrderInfo getOrderInfo() {
        return orderInfo;
    }
     ...
     * @param orderInfo
     */
    public void setOrderInfo(com.asiainfo.crm.cm.dk.ws.imswrapservice.SOrderInfo orderInfo) {
        this.orderInfo = orderInfo;
    }
