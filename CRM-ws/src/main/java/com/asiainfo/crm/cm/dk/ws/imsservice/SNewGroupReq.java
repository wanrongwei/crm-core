...
public class SNewGroupReq  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imsservice.SGroup groupInfo;

    private com.asiainfo.crm.cm.dk.ws.imsservice.SProductOrder[] product_order_list;

    public SNewGroupReq() {
    }

    public SNewGroupReq(
           com.asiainfo.crm.cm.dk.ws.imsservice.SGroup groupInfo,
           com.asiainfo.crm.cm.dk.ws.imsservice.SProductOrder[] product_order_list) {
     ...
     * @return groupInfo
     */
    public com.asiainfo.crm.cm.dk.ws.imsservice.SGroup getGroupInfo() {
        return groupInfo;
    }
     ...
     * @param groupInfo
     */
    public void setGroupInfo(com.asiainfo.crm.cm.dk.ws.imsservice.SGroup groupInfo) {
        this.groupInfo = groupInfo;
    }
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imsservice.SProductOrder[] getProduct_order_list() {
        return product_order_list;
    }
     ...
     */
    public void setProduct_order_list(com.asiainfo.crm.cm.dk.ws.imsservice.SProductOrder[] product_order_list) {
        this.product_order_list = product_order_list;
    }
