...
public class IImsWrapQueryServiceRemoteLocator extends org.apache.axis.client.Service implements com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.IImsWrapQueryServiceRemote {
	...
	private java.lang.String IImsWrapQueryService_address = getWsUrl();
	...
	public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.IImsWrapQueryServiceWs getIImsWrapQueryService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
		try {
			com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.IImsWrapQueryServiceRemoteSoapBindingStub _stub = new com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.IImsWrapQueryServiceRemoteSoapBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.IImsWrapQueryServiceWs.class.isAssignableFrom(serviceEndpointInterface)) {
				com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.IImsWrapQueryServiceRemoteSoapBindingStub _stub = new com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.IImsWrapQueryServiceRemoteSoapBindingStub(
						new java.net.URL(IImsWrapQueryService_address), this);
				_stub.setPortName(getIImsWrapQueryServiceWSDDServiceName());
				return _stub;
			}
