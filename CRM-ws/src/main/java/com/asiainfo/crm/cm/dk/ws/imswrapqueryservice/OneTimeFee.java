...
public class OneTimeFee  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.FeeItem[] feeList;
    ...
    public OneTimeFee(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.FeeItem[] feeList) {
     ...
     * @return feeList
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.FeeItem[] getFeeList() {
        return feeList;
    }
     ...
     * @param feeList
     */
    public void setFeeList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.FeeItem[] feeList) {
        this.feeList = feeList;
    }
