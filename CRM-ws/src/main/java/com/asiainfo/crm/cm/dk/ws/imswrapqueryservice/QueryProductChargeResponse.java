...
public class QueryProductChargeResponse  extends com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SProdCharge[] prodChargeListOut;
    ...
    public QueryProductChargeResponse(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SProdCharge[] prodChargeListOut,
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SProdCharge[] getProdChargeListOut() {
        return prodChargeListOut;
    }
     ...
     */
    public void setProdChargeListOut(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SProdCharge[] prodChargeListOut) {
        this.prodChargeListOut = prodChargeListOut;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SProdCharge getProdChargeListOut(int i) {
        return this.prodChargeListOut[i];
    }

    public void setProdChargeListOut(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SProdCharge _value) {
