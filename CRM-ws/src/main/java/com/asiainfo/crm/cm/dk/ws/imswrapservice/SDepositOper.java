...
public class SDepositOper  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.cm.dk.ws.imswrapservice.SDeposit sDeposit;
    ...
    public SDepositOper(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapservice.SDeposit sDeposit) {
     ...
     * @return sDeposit
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapservice.SDeposit getSDeposit() {
        return sDeposit;
    }
     ...
     * @param sDeposit
     */
    public void setSDeposit(com.asiainfo.crm.cm.dk.ws.imswrapservice.SDeposit sDeposit) {
        this.sDeposit = sDeposit;
    }
