...
public class SQueryNtCdrReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ServiceType[] serviceIdList;
    ...
    public SQueryNtCdrReq(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ServiceType[] serviceIdList,
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ServiceType[] getServiceIdList() {
        return serviceIdList;
    }
     ...
     * @param serviceIdList
     */
    public void setServiceIdList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ServiceType[] serviceIdList) {
        this.serviceIdList = serviceIdList;
    }
