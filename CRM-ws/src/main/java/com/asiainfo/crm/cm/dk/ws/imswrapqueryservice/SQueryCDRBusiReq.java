...
public class SQueryCDRBusiReq  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SPageInfo pageInfo;

    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ScdrBusiInfo sCDRBusiInfo;

    public SQueryCDRBusiReq() {
    }

    public SQueryCDRBusiReq(
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SPageInfo pageInfo,
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ScdrBusiInfo sCDRBusiInfo) {
     ...
     * @return pageInfo
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SPageInfo getPageInfo() {
        return pageInfo;
    }
     ...
     * @param pageInfo
     */
    public void setPageInfo(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SPageInfo pageInfo) {
        this.pageInfo = pageInfo;
    }
     ...
     * @return sCDRBusiInfo
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ScdrBusiInfo getSCDRBusiInfo() {
        return sCDRBusiInfo;
    }
     ...
     * @param sCDRBusiInfo
     */
    public void setSCDRBusiInfo(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.ScdrBusiInfo sCDRBusiInfo) {
        this.sCDRBusiInfo = sCDRBusiInfo;
    }
