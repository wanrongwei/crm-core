...
public class SMailGroupManageReq  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapservice.MailGroup mailGroup;

    private com.asiainfo.crm.cm.dk.ws.imswrapservice.MailGroupMember[] mailGroupMemberList;

    private com.asiainfo.crm.cm.dk.ws.imswrapservice.MailGroupPost mailGroupPost;

    public SMailGroupManageReq() {
    }

    public SMailGroupManageReq(
           com.asiainfo.crm.cm.dk.ws.imswrapservice.MailGroup mailGroup,
           com.asiainfo.crm.cm.dk.ws.imswrapservice.MailGroupMember[] mailGroupMemberList,
           com.asiainfo.crm.cm.dk.ws.imswrapservice.MailGroupPost mailGroupPost) {
     ...
     * @return mailGroup
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapservice.MailGroup getMailGroup() {
        return mailGroup;
    }
     ...
     * @param mailGroup
     */
    public void setMailGroup(com.asiainfo.crm.cm.dk.ws.imswrapservice.MailGroup mailGroup) {
        this.mailGroup = mailGroup;
    }
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapservice.MailGroupMember[] getMailGroupMemberList() {
        return mailGroupMemberList;
    }
     ...
     */
    public void setMailGroupMemberList(com.asiainfo.crm.cm.dk.ws.imswrapservice.MailGroupMember[] mailGroupMemberList) {
        this.mailGroupMemberList = mailGroupMemberList;
    }
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapservice.MailGroupPost getMailGroupPost() {
        return mailGroupPost;
    }
     ...
     * @param mailGroupPost
     */
    public void setMailGroupPost(com.asiainfo.crm.cm.dk.ws.imswrapservice.MailGroupPost mailGroupPost) {
        this.mailGroupPost = mailGroupPost;
    }
