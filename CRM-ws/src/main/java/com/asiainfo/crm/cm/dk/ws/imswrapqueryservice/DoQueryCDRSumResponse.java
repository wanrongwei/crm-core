...
public class DoQueryCDRSumResponse  extends com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CallDetailSumRecord[] callDetailSumRecordList;
    ...
    public DoQueryCDRSumResponse(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CallDetailSumRecord[] callDetailSumRecordList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CallDetailSumRecord[] getCallDetailSumRecordList() {
        return callDetailSumRecordList;
    }
     ...
     */
    public void setCallDetailSumRecordList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CallDetailSumRecord[] callDetailSumRecordList) {
        this.callDetailSumRecordList = callDetailSumRecordList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CallDetailSumRecord getCallDetailSumRecordList(int i) {
        return this.callDetailSumRecordList[i];
    }

    public void setCallDetailSumRecordList(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CallDetailSumRecord _value) {
