...
public class DoQueryInstallmenInfoResponse  extends com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.InstallmentInfoDtl[] installmentInfoList;
    ...
    public DoQueryInstallmenInfoResponse(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.InstallmentInfoDtl[] installmentInfoList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.InstallmentInfoDtl[] getInstallmentInfoList() {
        return installmentInfoList;
    }
     ...
     */
    public void setInstallmentInfoList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.InstallmentInfoDtl[] installmentInfoList) {
        this.installmentInfoList = installmentInfoList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.InstallmentInfoDtl getInstallmentInfoList(int i) {
        return this.installmentInfoList[i];
    }

    public void setInstallmentInfoList(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.InstallmentInfoDtl _value) {
