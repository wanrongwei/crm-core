...
public class SProductOrderOper  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.cm.dk.ws.imsservice.SProductOrder[] prod_list;
    ...
    public SProductOrderOper(
           ...
           com.asiainfo.crm.cm.dk.ws.imsservice.SProductOrder[] prod_list) {
     ...
     * @return prod_list
     */
    public com.asiainfo.crm.cm.dk.ws.imsservice.SProductOrder[] getProd_list() {
        return prod_list;
    }
     ...
     * @param prod_list
     */
    public void setProd_list(com.asiainfo.crm.cm.dk.ws.imsservice.SProductOrder[] prod_list) {
        this.prod_list = prod_list;
    }
