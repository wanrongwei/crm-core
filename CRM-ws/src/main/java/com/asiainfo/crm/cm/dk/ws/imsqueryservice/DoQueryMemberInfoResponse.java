...
public class DoQueryMemberInfoResponse  extends com.asiainfo.crm.cm.dk.ws.imsqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imsqueryservice.GroupandMemberList[] groupandMemberList;
    ...
    public DoQueryMemberInfoResponse(
           ...
           com.asiainfo.crm.cm.dk.ws.imsqueryservice.GroupandMemberList[] groupandMemberList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imsqueryservice.GroupandMemberList[] getGroupandMemberList() {
        return groupandMemberList;
    }
     ...
     */
    public void setGroupandMemberList(com.asiainfo.crm.cm.dk.ws.imsqueryservice.GroupandMemberList[] groupandMemberList) {
        this.groupandMemberList = groupandMemberList;
    }

    public com.asiainfo.crm.cm.dk.ws.imsqueryservice.GroupandMemberList getGroupandMemberList(int i) {
        return this.groupandMemberList[i];
    }

    public void setGroupandMemberList(int i, com.asiainfo.crm.cm.dk.ws.imsqueryservice.GroupandMemberList _value) {
