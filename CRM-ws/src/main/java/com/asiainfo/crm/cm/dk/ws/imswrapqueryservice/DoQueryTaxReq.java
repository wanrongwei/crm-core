...
public class DoQueryTaxReq  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQueryTaxFee[] sQueryTaxFeeList;

    public DoQueryTaxReq() {
    }

    public DoQueryTaxReq(
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQueryTaxFee[] sQueryTaxFeeList) {
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQueryTaxFee[] getSQueryTaxFeeList() {
        return sQueryTaxFeeList;
    }
     ...
     */
    public void setSQueryTaxFeeList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQueryTaxFee[] sQueryTaxFeeList) {
        this.sQueryTaxFeeList = sQueryTaxFeeList;
    }
