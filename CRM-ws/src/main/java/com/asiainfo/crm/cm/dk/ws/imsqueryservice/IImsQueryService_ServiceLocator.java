...
public class IImsQueryService_ServiceLocator extends org.apache.axis.client.Service implements com.asiainfo.crm.cm.dk.ws.imsqueryservice.IImsQueryService_Service {
    ...
    public com.asiainfo.crm.cm.dk.ws.imsqueryservice.IImsQueryServiceWs getIImsQueryService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.asiainfo.crm.cm.dk.ws.imsqueryservice.IImsQueryServiceSoapBindingStub _stub = new com.asiainfo.crm.cm.dk.ws.imsqueryservice.IImsQueryServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.asiainfo.crm.cm.dk.ws.imsqueryservice.IImsQueryServiceWs.class.isAssignableFrom(serviceEndpointInterface)) {
                com.asiainfo.crm.cm.dk.ws.imsqueryservice.IImsQueryServiceSoapBindingStub _stub = new com.asiainfo.crm.cm.dk.ws.imsqueryservice.IImsQueryServiceSoapBindingStub(new java.net.URL(IImsQueryService_address), this);
                _stub.setPortName(getIImsQueryServiceWSDDServiceName());
                return _stub;
            }
        }
