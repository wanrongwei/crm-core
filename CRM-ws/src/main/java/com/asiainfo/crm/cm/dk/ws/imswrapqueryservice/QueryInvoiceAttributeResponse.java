...
public class QueryInvoiceAttributeResponse  extends com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CaFileStorage[] invoiceUrlList;
    ...
    public QueryInvoiceAttributeResponse(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CaFileStorage[] invoiceUrlList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CaFileStorage[] getInvoiceUrlList() {
        return invoiceUrlList;
    }
     ...
     */
    public void setInvoiceUrlList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CaFileStorage[] invoiceUrlList) {
        this.invoiceUrlList = invoiceUrlList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CaFileStorage getInvoiceUrlList(int i) {
        return this.invoiceUrlList[i];
    }

    public void setInvoiceUrlList(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CaFileStorage _value) {
