...
public class SChangeOwnerReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.cm.dk.ws.imsservice.SProductOrderOper[] prod_list;
    ...
    public SChangeOwnerReq(
           ...
           com.asiainfo.crm.cm.dk.ws.imsservice.SProductOrderOper[] prod_list,
           java.lang.Long days,
     ...
     * @return prod_list
     */
    public com.asiainfo.crm.cm.dk.ws.imsservice.SProductOrderOper[] getProd_list() {
        return prod_list;
    }
     ...
     * @param prod_list
     */
    public void setProd_list(com.asiainfo.crm.cm.dk.ws.imsservice.SProductOrderOper[] prod_list) {
        this.prod_list = prod_list;
    }
