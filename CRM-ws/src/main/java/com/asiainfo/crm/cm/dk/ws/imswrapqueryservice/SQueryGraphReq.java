...
public class SQueryGraphReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQueryGraphQueryTypeList[] queryTypeList;
    ...
    public SQueryGraphReq(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQueryGraphQueryTypeList[] queryTypeList) {
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQueryGraphQueryTypeList[] getQueryTypeList() {
        return queryTypeList;
    }
     ...
     * @param queryTypeList
     */
    public void setQueryTypeList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQueryGraphQueryTypeList[] queryTypeList) {
        this.queryTypeList = queryTypeList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQueryGraphQueryTypeList getQueryTypeList(int i) {
        return this.queryTypeList[i];
    }

    public void setQueryTypeList(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SQueryGraphQueryTypeList _value) {
