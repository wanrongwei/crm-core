...
public class QueryBillDetailResponse  extends com.asiainfo.crm.cm.dk.ws.imsqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imsqueryservice.CodeValue[] paymentMethod;

    private com.asiainfo.crm.cm.dk.ws.imsqueryservice.CodeValue[] mailCode;

    private com.asiainfo.crm.cm.dk.ws.imsqueryservice.CodeValue[] billformat;
    ...
    public QueryBillDetailResponse(
           ...
           com.asiainfo.crm.cm.dk.ws.imsqueryservice.CodeValue[] paymentMethod,
           com.asiainfo.crm.cm.dk.ws.imsqueryservice.CodeValue[] mailCode,
           com.asiainfo.crm.cm.dk.ws.imsqueryservice.CodeValue[] billformat) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imsqueryservice.CodeValue[] getPaymentMethod() {
        return paymentMethod;
    }
     ...
     * @param paymentMethod
     */
    public void setPaymentMethod(com.asiainfo.crm.cm.dk.ws.imsqueryservice.CodeValue[] paymentMethod) {
        this.paymentMethod = paymentMethod;
    }

    public com.asiainfo.crm.cm.dk.ws.imsqueryservice.CodeValue getPaymentMethod(int i) {
        return this.paymentMethod[i];
    }

    public void setPaymentMethod(int i, com.asiainfo.crm.cm.dk.ws.imsqueryservice.CodeValue _value) {
     ...
     * @return mailCode
     */
    public com.asiainfo.crm.cm.dk.ws.imsqueryservice.CodeValue[] getMailCode() {
        return mailCode;
    }
     ...
     * @param mailCode
     */
    public void setMailCode(com.asiainfo.crm.cm.dk.ws.imsqueryservice.CodeValue[] mailCode) {
        this.mailCode = mailCode;
    }

    public com.asiainfo.crm.cm.dk.ws.imsqueryservice.CodeValue getMailCode(int i) {
        return this.mailCode[i];
    }

    public void setMailCode(int i, com.asiainfo.crm.cm.dk.ws.imsqueryservice.CodeValue _value) {
     ...
     * @return billformat
     */
    public com.asiainfo.crm.cm.dk.ws.imsqueryservice.CodeValue[] getBillformat() {
        return billformat;
    }
     ...
     * @param billformat
     */
    public void setBillformat(com.asiainfo.crm.cm.dk.ws.imsqueryservice.CodeValue[] billformat) {
        this.billformat = billformat;
    }

    public com.asiainfo.crm.cm.dk.ws.imsqueryservice.CodeValue getBillformat(int i) {
        return this.billformat[i];
    }

    public void setBillformat(int i, com.asiainfo.crm.cm.dk.ws.imsqueryservice.CodeValue _value) {
