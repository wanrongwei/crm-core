...
public class SOperateMultiSimReq  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imsservice.SimItem[] req;

    public SOperateMultiSimReq() {
    }

    public SOperateMultiSimReq(
           com.asiainfo.crm.cm.dk.ws.imsservice.SimItem[] req) {
           this.req = req;
    }
     ...
     * @return req
     */
    public com.asiainfo.crm.cm.dk.ws.imsservice.SimItem[] getReq() {
        return req;
    }
     ...
     * @param req
     */
    public void setReq(com.asiainfo.crm.cm.dk.ws.imsservice.SimItem[] req) {
        this.req = req;
    }
