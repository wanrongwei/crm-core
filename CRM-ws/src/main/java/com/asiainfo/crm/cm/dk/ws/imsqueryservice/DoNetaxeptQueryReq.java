...
public class DoNetaxeptQueryReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.cm.dk.ws.imsqueryservice.NetaxeptQueryRequest request;
    ...
    public DoNetaxeptQueryReq(
           ...
           com.asiainfo.crm.cm.dk.ws.imsqueryservice.NetaxeptQueryRequest request) {
     ...
     * @return request
     */
    public com.asiainfo.crm.cm.dk.ws.imsqueryservice.NetaxeptQueryRequest getRequest() {
        return request;
    }
     ...
     * @param request
     */
    public void setRequest(com.asiainfo.crm.cm.dk.ws.imsqueryservice.NetaxeptQueryRequest request) {
        this.request = request;
    }
