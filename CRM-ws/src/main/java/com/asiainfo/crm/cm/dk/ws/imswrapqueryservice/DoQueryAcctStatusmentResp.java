...
public class DoQueryAcctStatusmentResp  extends com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.AccountStatusmentBo[] acctStatusmentList;
    ...
    public DoQueryAcctStatusmentResp(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.AccountStatusmentBo[] acctStatusmentList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.AccountStatusmentBo[] getAcctStatusmentList() {
        return acctStatusmentList;
    }
     ...
     */
    public void setAcctStatusmentList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.AccountStatusmentBo[] acctStatusmentList) {
        this.acctStatusmentList = acctStatusmentList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.AccountStatusmentBo getAcctStatusmentList(int i) {
        return this.acctStatusmentList[i];
    }

    public void setAcctStatusmentList(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.AccountStatusmentBo _value) {
