...
public class SAllowanceRec  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.cm.dk.ws.imswrapservice.SAllowanceRecDetail[] detailList;
    ...
    public SAllowanceRec(
           ...
           java.lang.Long opId,
           com.asiainfo.crm.cm.dk.ws.imswrapservice.SAllowanceRecDetail[] detailList) {
           this.acctId = acctId;
     ...
     * @return detailList
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapservice.SAllowanceRecDetail[] getDetailList() {
        return detailList;
    }
     ...
     * @param detailList
     */
    public void setDetailList(com.asiainfo.crm.cm.dk.ws.imswrapservice.SAllowanceRecDetail[] detailList) {
        this.detailList = detailList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapservice.SAllowanceRecDetail getDetailList(int i) {
        return this.detailList[i];
    }

    public void setDetailList(int i, com.asiainfo.crm.cm.dk.ws.imswrapservice.SAllowanceRecDetail _value) {
