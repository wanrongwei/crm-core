...
public class ActualUsage  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SubActualUsage[] subActualUsageList;
    ...
    public ActualUsage(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SubActualUsage[] subActualUsageList,
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SubActualUsage[] getSubActualUsageList() {
        return subActualUsageList;
    }
     ...
     */
    public void setSubActualUsageList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SubActualUsage[] subActualUsageList) {
        this.subActualUsageList = subActualUsageList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SubActualUsage getSubActualUsageList(int i) {
        return this.subActualUsageList[i];
    }

    public void setSubActualUsageList(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SubActualUsage _value) {
