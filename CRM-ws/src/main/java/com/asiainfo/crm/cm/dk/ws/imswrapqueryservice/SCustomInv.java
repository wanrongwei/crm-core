...
public class SCustomInv  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SProductRecurringFee[] feeList;

    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SCustomInvDtl[] cacustomInvDtl;
    ...
    public SCustomInv(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SProductRecurringFee[] feeList,
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SCustomInvDtl[] cacustomInvDtl,
     ...
     * @return feeList
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SProductRecurringFee[] getFeeList() {
        return feeList;
    }
     ...
     * @param feeList
     */
    public void setFeeList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SProductRecurringFee[] feeList) {
        this.feeList = feeList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SProductRecurringFee getFeeList(int i) {
        return this.feeList[i];
    }

    public void setFeeList(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SProductRecurringFee _value) {
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SCustomInvDtl[] getCacustomInvDtl() {
        return cacustomInvDtl;
    }
     ...
     */
    public void setCacustomInvDtl(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SCustomInvDtl[] cacustomInvDtl) {
        this.cacustomInvDtl = cacustomInvDtl;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SCustomInvDtl getCacustomInvDtl(int i) {
        return this.cacustomInvDtl[i];
    }

    public void setCacustomInvDtl(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SCustomInvDtl _value) {
    ...
    /**
     * Gets the sendAccessory value for this SCustomInv.
     * 
    ...
    /**
     * Sets the sendAccessory value for this SCustomInv.
     * 
     * @param sendAccessory
     */
