...
public class DoQueryAcctDetailByCustResponse  extends com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SacctDetailByCustBean[] acctDetailList;
    ...
    public DoQueryAcctDetailByCustResponse(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SacctDetailByCustBean[] acctDetailList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SacctDetailByCustBean[] getAcctDetailList() {
        return acctDetailList;
    }
     ...
     */
    public void setAcctDetailList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SacctDetailByCustBean[] acctDetailList) {
        this.acctDetailList = acctDetailList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SacctDetailByCustBean getAcctDetailList(int i) {
        return this.acctDetailList[i];
    }

    public void setAcctDetailList(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SacctDetailByCustBean _value) {
