...
public class DoVPNGroupRelationResponse  extends com.asiainfo.crm.cm.dk.ws.imsservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imsservice.SProductOrderResult[] sProdResultList;
    ...
    public DoVPNGroupRelationResponse(
           ...
           com.asiainfo.crm.cm.dk.ws.imsservice.SProductOrderResult[] sProdResultList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imsservice.SProductOrderResult[] getSProdResultList() {
        return sProdResultList;
    }
     ...
     */
    public void setSProdResultList(com.asiainfo.crm.cm.dk.ws.imsservice.SProductOrderResult[] sProdResultList) {
        this.sProdResultList = sProdResultList;
    }
