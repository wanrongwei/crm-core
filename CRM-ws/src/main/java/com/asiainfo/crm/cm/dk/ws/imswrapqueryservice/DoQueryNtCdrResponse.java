...
public class DoQueryNtCdrResponse  extends com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SReplyInfo[] sReplyDisInfoList;
    ...
    public DoQueryNtCdrResponse(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SReplyInfo[] sReplyDisInfoList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SReplyInfo[] getSReplyDisInfoList() {
        return sReplyDisInfoList;
    }
     ...
     */
    public void setSReplyDisInfoList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SReplyInfo[] sReplyDisInfoList) {
        this.sReplyDisInfoList = sReplyDisInfoList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SReplyInfo getSReplyDisInfoList(int i) {
        return this.sReplyDisInfoList[i];
    }

    public void setSReplyDisInfoList(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.SReplyInfo _value) {
