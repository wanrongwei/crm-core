...
public class DoQueryInvoiceInfoResponse  extends com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.InvoiceInfoResult[] invoiceInfoList;
    ...
    public DoQueryInvoiceInfoResponse(
           ...
           com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.InvoiceInfoResult[] invoiceInfoList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.InvoiceInfoResult[] getInvoiceInfoList() {
        return invoiceInfoList;
    }
     ...
     */
    public void setInvoiceInfoList(com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.InvoiceInfoResult[] invoiceInfoList) {
        this.invoiceInfoList = invoiceInfoList;
    }

    public com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.InvoiceInfoResult getInvoiceInfoList(int i) {
        return this.invoiceInfoList[i];
    }

    public void setInvoiceInfoList(int i, com.asiainfo.crm.cm.dk.ws.imswrapqueryservice.InvoiceInfoResult _value) {
