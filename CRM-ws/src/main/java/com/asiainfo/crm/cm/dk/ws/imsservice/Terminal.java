...
public class Terminal  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.cm.dk.ws.imsservice.PaymentMethodAction[] paymentMethodActionList;
    ...
    public Terminal(
           ...
           com.asiainfo.crm.cm.dk.ws.imsservice.PaymentMethodAction[] paymentMethodActionList,
     ...
     */
    public com.asiainfo.crm.cm.dk.ws.imsservice.PaymentMethodAction[] getPaymentMethodActionList() {
        return paymentMethodActionList;
    }
     ...
     */
    public void setPaymentMethodActionList(com.asiainfo.crm.cm.dk.ws.imsservice.PaymentMethodAction[] paymentMethodActionList) {
        this.paymentMethodActionList = paymentMethodActionList;
    }

    public com.asiainfo.crm.cm.dk.ws.imsservice.PaymentMethodAction getPaymentMethodActionList(int i) {
        return this.paymentMethodActionList[i];
    }

    public void setPaymentMethodActionList(int i, com.asiainfo.crm.cm.dk.ws.imsservice.PaymentMethodAction _value) {
