...
public class CreditLimit  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SubscriberExempt[] subscriberExemptList;
    ...
    public CreditLimit(
           ...
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SubscriberExempt[] subscriberExemptList,
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SubscriberExempt[] getSubscriberExemptList() {
        return subscriberExemptList;
    }
     ...
     */
    public void setSubscriberExemptList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SubscriberExempt[] subscriberExemptList) {
        this.subscriberExemptList = subscriberExemptList;
    }

    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SubscriberExempt getSubscriberExemptList(int i) {
        return this.subscriberExemptList[i];
    }

    public void setSubscriberExemptList(int i, com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SubscriberExempt _value) {
