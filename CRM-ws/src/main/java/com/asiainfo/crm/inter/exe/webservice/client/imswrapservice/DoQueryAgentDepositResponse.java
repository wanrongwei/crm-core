...
public class DoQueryAgentDepositResponse  extends com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.ImsAgentDepositQueryResult[] agentDepositQueryResultList;
    ...
    public DoQueryAgentDepositResponse(
           ...
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.ImsAgentDepositQueryResult[] agentDepositQueryResultList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.ImsAgentDepositQueryResult[] getAgentDepositQueryResultList() {
        return agentDepositQueryResultList;
    }
     ...
     */
    public void setAgentDepositQueryResultList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.ImsAgentDepositQueryResult[] agentDepositQueryResultList) {
        this.agentDepositQueryResultList = agentDepositQueryResultList;
    }

    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.ImsAgentDepositQueryResult getAgentDepositQueryResultList(int i) {
        return this.agentDepositQueryResultList[i];
    }

    public void setAgentDepositQueryResultList(int i, com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.ImsAgentDepositQueryResult _value) {
