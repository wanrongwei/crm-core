...
public class SQueryGraphReq  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryGraphQueryTypeList[] queryTypeList;
    ...
    public SQueryGraphReq(
           ...
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryGraphQueryTypeList[] queryTypeList) {
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryGraphQueryTypeList[] getQueryTypeList() {
        return queryTypeList;
    }
     ...
     * @param queryTypeList
     */
    public void setQueryTypeList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryGraphQueryTypeList[] queryTypeList) {
        this.queryTypeList = queryTypeList;
    }

    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryGraphQueryTypeList getQueryTypeList(int i) {
        return this.queryTypeList[i];
    }

    public void setQueryTypeList(int i, com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryGraphQueryTypeList _value) {
