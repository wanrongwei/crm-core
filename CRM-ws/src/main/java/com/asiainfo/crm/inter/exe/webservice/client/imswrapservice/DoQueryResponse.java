...
public class DoQueryResponse  extends com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SUser user;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SUserAuth userAuth;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SAccount account;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SCustomer customer;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SBalance[] balance;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.BudgetControl[] budget;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CreditLimit[] credit;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.FreeResourceGroup[] freeResourceGroupList;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.Accumulate[] accumulation;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.Billinfo[] billInfo;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SBusiService[] hybridRule;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.OneTimeFee[] oneTimeCharge;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.Spoints point;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SProductOrder[] prodOrderList;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SBusiService[] busiServiceList;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.RealTimeCallCharge[] realtimeCharge;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.HybridBusiService[] hybridBusiServiceList;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SNegativeBalance[] sNegativeBalanceList;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CapMaxControl[] capMaxControlList;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryFreeTimes queryFreeTimes;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.BillUsage billUsage;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.ActualUsage[] actualUsageList;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SContact[] sContactList;
    ...
    public DoQueryResponse(
           ...
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SUser user,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SUserAuth userAuth,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SAccount account,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SCustomer customer,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SBalance[] balance,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.BudgetControl[] budget,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CreditLimit[] credit,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.FreeResourceGroup[] freeResourceGroupList,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.Accumulate[] accumulation,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.Billinfo[] billInfo,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SBusiService[] hybridRule,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.OneTimeFee[] oneTimeCharge,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.Spoints point,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SProductOrder[] prodOrderList,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SBusiService[] busiServiceList,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.RealTimeCallCharge[] realtimeCharge,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.HybridBusiService[] hybridBusiServiceList,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SNegativeBalance[] sNegativeBalanceList,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CapMaxControl[] capMaxControlList,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryFreeTimes queryFreeTimes,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.BillUsage billUsage,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.ActualUsage[] actualUsageList,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SContact[] sContactList) {
        super(
            responseHead);
        this.user = user;
     ...
     * @return user
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SUser getUser() {
        return user;
    }
     ...
     * @param user
     */
    public void setUser(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SUser user) {
        this.user = user;
    }
     ...
     * @return userAuth
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SUserAuth getUserAuth() {
        return userAuth;
    }
     ...
     * @param userAuth
     */
    public void setUserAuth(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SUserAuth userAuth) {
        this.userAuth = userAuth;
    }
     ...
     * @return account
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SAccount getAccount() {
        return account;
    }
     ...
     * @param account
     */
    public void setAccount(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SAccount account) {
        this.account = account;
    }
     ...
     * @return customer
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SCustomer getCustomer() {
        return customer;
    }
     ...
     * @param customer
     */
    public void setCustomer(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SCustomer customer) {
        this.customer = customer;
    }
     ...
     * @return balance
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SBalance[] getBalance() {
        return balance;
    }
     ...
     * @param balance
     */
    public void setBalance(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SBalance[] balance) {
        this.balance = balance;
    }
     ...
     * @return budget
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.BudgetControl[] getBudget() {
        return budget;
    }
     ...
     * @param budget
     */
    public void setBudget(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.BudgetControl[] budget) {
        this.budget = budget;
    }
     ...
     * @return credit
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CreditLimit[] getCredit() {
        return credit;
    }
     ...
     * @param credit
     */
    public void setCredit(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CreditLimit[] credit) {
        this.credit = credit;
    }
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.FreeResourceGroup[] getFreeResourceGroupList() {
        return freeResourceGroupList;
    }
     ...
     */
    public void setFreeResourceGroupList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.FreeResourceGroup[] freeResourceGroupList) {
        this.freeResourceGroupList = freeResourceGroupList;
    }
     ...
     * @return accumulation
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.Accumulate[] getAccumulation() {
        return accumulation;
    }
     ...
     * @param accumulation
     */
    public void setAccumulation(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.Accumulate[] accumulation) {
        this.accumulation = accumulation;
    }
     ...
     * @return billInfo
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.Billinfo[] getBillInfo() {
        return billInfo;
    }
     ...
     * @param billInfo
     */
    public void setBillInfo(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.Billinfo[] billInfo) {
        this.billInfo = billInfo;
    }
     ...
     * @return hybridRule
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SBusiService[] getHybridRule() {
        return hybridRule;
    }
     ...
     * @param hybridRule
     */
    public void setHybridRule(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SBusiService[] hybridRule) {
        this.hybridRule = hybridRule;
    }
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.OneTimeFee[] getOneTimeCharge() {
        return oneTimeCharge;
    }
     ...
     * @param oneTimeCharge
     */
    public void setOneTimeCharge(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.OneTimeFee[] oneTimeCharge) {
        this.oneTimeCharge = oneTimeCharge;
    }
     ...
     * @return point
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.Spoints getPoint() {
        return point;
    }
     ...
     * @param point
     */
    public void setPoint(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.Spoints point) {
        this.point = point;
    }
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SProductOrder[] getProdOrderList() {
        return prodOrderList;
    }
     ...
     * @param prodOrderList
     */
    public void setProdOrderList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SProductOrder[] prodOrderList) {
        this.prodOrderList = prodOrderList;
    }
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SBusiService[] getBusiServiceList() {
        return busiServiceList;
    }
     ...
     */
    public void setBusiServiceList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SBusiService[] busiServiceList) {
        this.busiServiceList = busiServiceList;
    }
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.RealTimeCallCharge[] getRealtimeCharge() {
        return realtimeCharge;
    }
     ...
     */
    public void setRealtimeCharge(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.RealTimeCallCharge[] realtimeCharge) {
        this.realtimeCharge = realtimeCharge;
    }
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.HybridBusiService[] getHybridBusiServiceList() {
        return hybridBusiServiceList;
    }
     ...
     */
    public void setHybridBusiServiceList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.HybridBusiService[] hybridBusiServiceList) {
        this.hybridBusiServiceList = hybridBusiServiceList;
    }
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SNegativeBalance[] getSNegativeBalanceList() {
        return sNegativeBalanceList;
    }
     ...
     */
    public void setSNegativeBalanceList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SNegativeBalance[] sNegativeBalanceList) {
        this.sNegativeBalanceList = sNegativeBalanceList;
    }
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CapMaxControl[] getCapMaxControlList() {
        return capMaxControlList;
    }
     ...
     */
    public void setCapMaxControlList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CapMaxControl[] capMaxControlList) {
        this.capMaxControlList = capMaxControlList;
    }
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryFreeTimes getQueryFreeTimes() {
        return queryFreeTimes;
    }
     ...
     */
    public void setQueryFreeTimes(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryFreeTimes queryFreeTimes) {
        this.queryFreeTimes = queryFreeTimes;
    }
     ...
     * @return billUsage
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.BillUsage getBillUsage() {
        return billUsage;
    }
     ...
     * @param billUsage
     */
    public void setBillUsage(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.BillUsage billUsage) {
        this.billUsage = billUsage;
    }
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.ActualUsage[] getActualUsageList() {
        return actualUsageList;
    }
     ...
     */
    public void setActualUsageList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.ActualUsage[] actualUsageList) {
        this.actualUsageList = actualUsageList;
    }
     ...
     * @return sContactList
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SContact[] getSContactList() {
        return sContactList;
    }
     ...
     * @param sContactList
     */
    public void setSContactList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SContact[] sContactList) {
        this.sContactList = sContactList;
    }

    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SContact getSContactList(int i) {
        return this.sContactList[i];
    }

    public void setSContactList(int i, com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SContact _value) {
