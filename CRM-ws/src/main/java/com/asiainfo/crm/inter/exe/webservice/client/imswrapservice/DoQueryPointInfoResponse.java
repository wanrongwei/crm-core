...
public class DoQueryPointInfoResponse  extends com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.QryPointOut[] qryPointOutList;
    ...
    public DoQueryPointInfoResponse(
           ...
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.QryPointOut[] qryPointOutList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.QryPointOut[] getQryPointOutList() {
        return qryPointOutList;
    }
     ...
     */
    public void setQryPointOutList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.QryPointOut[] qryPointOutList) {
        this.qryPointOutList = qryPointOutList;
    }

    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.QryPointOut getQryPointOutList(int i) {
        return this.qryPointOutList[i];
    }

    public void setQryPointOutList(int i, com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.QryPointOut _value) {
