...
public class DoQueryLedgerResponse  extends com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryLedgerOut[] ledgerOutList;
    ...
    public DoQueryLedgerResponse(
           ...
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryLedgerOut[] ledgerOutList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryLedgerOut[] getLedgerOutList() {
        return ledgerOutList;
    }
     ...
     * @param ledgerOutList
     */
    public void setLedgerOutList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryLedgerOut[] ledgerOutList) {
        this.ledgerOutList = ledgerOutList;
    }

    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryLedgerOut getLedgerOutList(int i) {
        return this.ledgerOutList[i];
    }

    public void setLedgerOutList(int i, com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryLedgerOut _value) {
