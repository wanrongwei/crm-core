...
public class DoQueryOrderInfoResponse  extends com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQryOrderOut[] qryOrderOut;
    ...
    public DoQueryOrderInfoResponse(
           ...
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQryOrderOut[] qryOrderOut) {
        super(
            responseHead);
     ...
     * @return qryOrderOut
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQryOrderOut[] getQryOrderOut() {
        return qryOrderOut;
    }
     ...
     * @param qryOrderOut
     */
    public void setQryOrderOut(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQryOrderOut[] qryOrderOut) {
        this.qryOrderOut = qryOrderOut;
    }

    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQryOrderOut getQryOrderOut(int i) {
        return this.qryOrderOut[i];
    }

    public void setQryOrderOut(int i, com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQryOrderOut _value) {
