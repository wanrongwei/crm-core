...
public class BillNodeTree  extends com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.BillNodeTree[] children;
    ...
    public BillNodeTree(
           ...
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.BillNodeTree[] children,
     ...
     * @return children
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.BillNodeTree[] getChildren() {
        return children;
    }
     ...
     * @param children
     */
    public void setChildren(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.BillNodeTree[] children) {
        this.children = children;
    }

    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.BillNodeTree getChildren(int i) {
        return this.children[i];
    }

    public void setChildren(int i, com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.BillNodeTree _value) {
