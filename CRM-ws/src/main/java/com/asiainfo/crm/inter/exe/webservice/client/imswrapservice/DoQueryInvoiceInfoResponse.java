...
public class DoQueryInvoiceInfoResponse  extends com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.InvoiceInfoResult[] invoiceInfoList;
    ...
    public DoQueryInvoiceInfoResponse(
           ...
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.InvoiceInfoResult[] invoiceInfoList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.InvoiceInfoResult[] getInvoiceInfoList() {
        return invoiceInfoList;
    }
     ...
     */
    public void setInvoiceInfoList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.InvoiceInfoResult[] invoiceInfoList) {
        this.invoiceInfoList = invoiceInfoList;
    }

    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.InvoiceInfoResult getInvoiceInfoList(int i) {
        return this.invoiceInfoList[i];
    }

    public void setInvoiceInfoList(int i, com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.InvoiceInfoResult _value) {
