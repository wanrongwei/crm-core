...
public class DoQueryGraphResponse  extends com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.HighestTransactionGroup[] highestTransactionGroupList;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.LongestCallingSecondsGroup[] longestCallingSecondsGroupList;
    ...
    public DoQueryGraphResponse(
           ...
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.HighestTransactionGroup[] highestTransactionGroupList,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.LongestCallingSecondsGroup[] longestCallingSecondsGroupList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.HighestTransactionGroup[] getHighestTransactionGroupList() {
        return highestTransactionGroupList;
    }
     ...
     */
    public void setHighestTransactionGroupList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.HighestTransactionGroup[] highestTransactionGroupList) {
        this.highestTransactionGroupList = highestTransactionGroupList;
    }

    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.HighestTransactionGroup getHighestTransactionGroupList(int i) {
        return this.highestTransactionGroupList[i];
    }

    public void setHighestTransactionGroupList(int i, com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.HighestTransactionGroup _value) {
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.LongestCallingSecondsGroup[] getLongestCallingSecondsGroupList() {
        return longestCallingSecondsGroupList;
    }
     ...
     */
    public void setLongestCallingSecondsGroupList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.LongestCallingSecondsGroup[] longestCallingSecondsGroupList) {
        this.longestCallingSecondsGroupList = longestCallingSecondsGroupList;
    }

    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.LongestCallingSecondsGroup getLongestCallingSecondsGroupList(int i) {
        return this.longestCallingSecondsGroupList[i];
    }

    public void setLongestCallingSecondsGroupList(int i, com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.LongestCallingSecondsGroup _value) {
