...
public class IImsServiceRemoteSoapBindingStub extends org.apache.axis.client.Stub implements com.asiainfo.crm.inter.exe.webservice.client.imsservice.IImsServiceWs {
    ...
    private static void _initOperationDesc3(){
        ...
        oper.setReturnClass(com.asiainfo.crm.inter.exe.webservice.client.imsservice.DoPBXNumberRangeSyncResponse.class);
    ...
    private void addBindings0() {
            ...
            cls = com.asiainfo.crm.inter.exe.webservice.client.imsservice.BaseResponse.class;
            ...
            cachedSerQNames.add(qName);
            cls = com.asiainfo.crm.inter.exe.webservice.client.imsservice.CrmBaseResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.asiainfo.crm.inter.exe.webservice.client.imsservice.PbxNumberRange[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = com.asiainfo.crm.inter.exe.webservice.client.imsservice.DoPBXNumberRangeSyncResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    private void addBindings1() {
            ...
            cachedSerQNames.add(qName);
            cls = com.asiainfo.crm.inter.exe.webservice.client.imsservice.RequestHead.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.asiainfo.crm.inter.exe.webservice.client.imsservice.ResponseHead.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    }
    ...
    public com.asiainfo.crm.inter.exe.webservice.client.imsservice.DoPBXNumberRangeSyncResponse doPBXNumberRangeSync(com.asiainfo.crm.inter.exe.webservice.client.imsservice.RequestHead requestHead, com.asiainfo.crm.inter.exe.webservice.client.imsservice.PbxNumberRange[] req) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {requestHead, req});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (com.asiainfo.crm.inter.exe.webservice.client.imsservice.DoPBXNumberRangeSyncResponse) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.asiainfo.crm.inter.exe.webservice.client.imsservice.DoPBXNumberRangeSyncResponse) org.apache.axis.utils.JavaUtils.convert(_resp, com.asiainfo.crm.inter.exe.webservice.client.imsservice.DoPBXNumberRangeSyncResponse.class);
            }
        }
