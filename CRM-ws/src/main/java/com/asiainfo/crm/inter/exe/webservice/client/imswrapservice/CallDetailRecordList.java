...
public class CallDetailRecordList  implements java.io.Serializable {
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CallDetailRecord[] detailList;
    ...
    public CallDetailRecordList(
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CallDetailRecord[] detailList,
     ...
     * @return detailList
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CallDetailRecord[] getDetailList() {
        return detailList;
    }
     ...
     * @param detailList
     */
    public void setDetailList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CallDetailRecord[] detailList) {
        this.detailList = detailList;
    }

    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CallDetailRecord getDetailList(int i) {
        return this.detailList[i];
    }

    public void setDetailList(int i, com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CallDetailRecord _value) {
