...
public class DoQueryMdbDataResponse  extends com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.InnerBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.MdbEntity[] valueMap;
    ...
    public DoQueryMdbDataResponse(
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CbsErrorMsg errorMsg,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SPage sPage,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.MdbEntity[] valueMap,
     ...
     * @return valueMap
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.MdbEntity[] getValueMap() {
        return valueMap;
    }
     ...
     * @param valueMap
     */
    public void setValueMap(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.MdbEntity[] valueMap) {
        this.valueMap = valueMap;
    }

    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.MdbEntity getValueMap(int i) {
        return this.valueMap[i];
    }

    public void setValueMap(int i, com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.MdbEntity _value) {
