...
public class DoQueryTransactionfeeResp  extends com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryFreeTimes[] queryFreeTimesList;
    ...
    public DoQueryTransactionfeeResp(
           ...
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryFreeTimes[] queryFreeTimesList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryFreeTimes[] getQueryFreeTimesList() {
        return queryFreeTimesList;
    }
     ...
     */
    public void setQueryFreeTimesList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryFreeTimes[] queryFreeTimesList) {
        this.queryFreeTimesList = queryFreeTimesList;
    }

    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryFreeTimes getQueryFreeTimesList(int i) {
        return this.queryFreeTimesList[i];
    }

    public void setQueryFreeTimesList(int i, com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryFreeTimes _value) {
