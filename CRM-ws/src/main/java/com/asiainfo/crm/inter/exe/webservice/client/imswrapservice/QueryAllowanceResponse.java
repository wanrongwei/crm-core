...
public class QueryAllowanceResponse  extends com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SAllowanceUsage[] allowanceUsageResp;
    ...
    public QueryAllowanceResponse(
           ...
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SAllowanceUsage[] allowanceUsageResp) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SAllowanceUsage[] getAllowanceUsageResp() {
        return allowanceUsageResp;
    }
     ...
     */
    public void setAllowanceUsageResp(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SAllowanceUsage[] allowanceUsageResp) {
        this.allowanceUsageResp = allowanceUsageResp;
    }

    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SAllowanceUsage getAllowanceUsageResp(int i) {
        return this.allowanceUsageResp[i];
    }

    public void setAllowanceUsageResp(int i, com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SAllowanceUsage _value) {
