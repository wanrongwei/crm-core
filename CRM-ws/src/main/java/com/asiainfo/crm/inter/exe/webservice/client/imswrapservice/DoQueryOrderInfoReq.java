...
public class DoQueryOrderInfoReq  implements java.io.Serializable {
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQryOrderIn qryOrderIn;

    public DoQueryOrderInfoReq() {
    }

    public DoQueryOrderInfoReq(
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQryOrderIn qryOrderIn) {
     ...
     * @return qryOrderIn
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQryOrderIn getQryOrderIn() {
        return qryOrderIn;
    }
     ...
     * @param qryOrderIn
     */
    public void setQryOrderIn(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQryOrderIn qryOrderIn) {
        this.qryOrderIn = qryOrderIn;
    }
