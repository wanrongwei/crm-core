...
public class DoQueryNtCdrResponse  extends com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SReplyInfo[] sReplyDisInfoList;
    ...
    public DoQueryNtCdrResponse(
           ...
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SReplyInfo[] sReplyDisInfoList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SReplyInfo[] getSReplyDisInfoList() {
        return sReplyDisInfoList;
    }
     ...
     */
    public void setSReplyDisInfoList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SReplyInfo[] sReplyDisInfoList) {
        this.sReplyDisInfoList = sReplyDisInfoList;
    }

    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SReplyInfo getSReplyDisInfoList(int i) {
        return this.sReplyDisInfoList[i];
    }

    public void setSReplyDisInfoList(int i, com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SReplyInfo _value) {
