...
public class DoSMngQueryDepositResponse  extends com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SPocket[] pocketList;
    ...
    public DoSMngQueryDepositResponse(
           ...
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SPocket[] pocketList) {
        super(
            responseHead);
     ...
     * @return pocketList
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SPocket[] getPocketList() {
        return pocketList;
    }
     ...
     * @param pocketList
     */
    public void setPocketList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SPocket[] pocketList) {
        this.pocketList = pocketList;
    }
