...
public class DoQueryInstallmenInfoResponse  extends com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.InstallmentInfoDtl[] installmentInfoList;
    ...
    public DoQueryInstallmenInfoResponse(
           ...
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.InstallmentInfoDtl[] installmentInfoList) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.InstallmentInfoDtl[] getInstallmentInfoList() {
        return installmentInfoList;
    }
     ...
     */
    public void setInstallmentInfoList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.InstallmentInfoDtl[] installmentInfoList) {
        this.installmentInfoList = installmentInfoList;
    }

    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.InstallmentInfoDtl getInstallmentInfoList(int i) {
        return this.installmentInfoList[i];
    }

    public void setInstallmentInfoList(int i, com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.InstallmentInfoDtl _value) {
