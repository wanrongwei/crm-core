...
public class DoQueryTermBalanceResponse  extends com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SUserStatus userStatus;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SBalance[] termBalanceList;
    ...
    public DoQueryTermBalanceResponse(
           ...
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SUserStatus userStatus,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SBalance[] termBalanceList) {
        super(
            responseHead);
        this.acctId = acctId;
     ...
     * @return userStatus
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SUserStatus getUserStatus() {
        return userStatus;
    }
     ...
     * @param userStatus
     */
    public void setUserStatus(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SUserStatus userStatus) {
        this.userStatus = userStatus;
    }
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SBalance[] getTermBalanceList() {
        return termBalanceList;
    }
     ...
     */
    public void setTermBalanceList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SBalance[] termBalanceList) {
        this.termBalanceList = termBalanceList;
    }
