...
public class DoQueryTaxReq  implements java.io.Serializable {
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryTaxFee[] sQueryTaxFeeList;

    public DoQueryTaxReq() {
    }

    public DoQueryTaxReq(
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryTaxFee[] sQueryTaxFeeList) {
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryTaxFee[] getSQueryTaxFeeList() {
        return sQueryTaxFeeList;
    }
     ...
     */
    public void setSQueryTaxFeeList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SQueryTaxFee[] sQueryTaxFeeList) {
        this.sQueryTaxFeeList = sQueryTaxFeeList;
    }
