...
public class DoQueryLostBalanceResponce  extends com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SBalance[] balanceList;
    ...
    public DoQueryLostBalanceResponce(
           ...
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SBalance[] balanceList) {
        super(
            responseHead);
     ...
     * @return balanceList
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SBalance[] getBalanceList() {
        return balanceList;
    }
     ...
     * @param balanceList
     */
    public void setBalanceList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SBalance[] balanceList) {
        this.balanceList = balanceList;
    }
