...
public class SQryOrderOut  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SOfferInfo[] offerList;
    ...
    public SQryOrderOut(
           ...
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SOfferInfo[] offerList) {
     ...
     * @return offerList
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SOfferInfo[] getOfferList() {
        return offerList;
    }
     ...
     * @param offerList
     */
    public void setOfferList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SOfferInfo[] offerList) {
        this.offerList = offerList;
    }

    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SOfferInfo getOfferList(int i) {
        return this.offerList[i];
    }

    public void setOfferList(int i, com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SOfferInfo _value) {
