...
public class QueryProductChargeResponse  extends com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CrmBaseResponse  implements java.io.Serializable {
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SProdCharge[] prodChargeListOut;
    ...
    public QueryProductChargeResponse(
           ...
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SProdCharge[] prodChargeListOut) {
        super(
            responseHead);
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SProdCharge[] getProdChargeListOut() {
        return prodChargeListOut;
    }
     ...
     */
    public void setProdChargeListOut(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SProdCharge[] prodChargeListOut) {
        this.prodChargeListOut = prodChargeListOut;
    }

    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SProdCharge getProdChargeListOut(int i) {
        return this.prodChargeListOut[i];
    }

    public void setProdChargeListOut(int i, com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.SProdCharge _value) {
