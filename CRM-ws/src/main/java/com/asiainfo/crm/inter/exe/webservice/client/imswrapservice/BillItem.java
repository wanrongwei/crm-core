...
public class BillItem  implements java.io.Serializable {
    ...
    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.BillDetail[] billDetaillist;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CaBillProd[] caBillProdList;

    private com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CaBillTax[] caBillTaxList;
    ...
    public BillItem(
           ...
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.BillDetail[] billDetaillist,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CaBillProd[] caBillProdList,
           com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CaBillTax[] caBillTaxList) {
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.BillDetail[] getBillDetaillist() {
        return billDetaillist;
    }
     ...
     */
    public void setBillDetaillist(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.BillDetail[] billDetaillist) {
        this.billDetaillist = billDetaillist;
    }
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CaBillProd[] getCaBillProdList() {
        return caBillProdList;
    }
     ...
     */
    public void setCaBillProdList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CaBillProd[] caBillProdList) {
        this.caBillProdList = caBillProdList;
    }
     ...
     */
    public com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CaBillTax[] getCaBillTaxList() {
        return caBillTaxList;
    }
     ...
     * @param caBillTaxList
     */
    public void setCaBillTaxList(com.asiainfo.crm.inter.exe.webservice.client.imswrapservice.CaBillTax[] caBillTaxList) {
        this.caBillTaxList = caBillTaxList;
    }
