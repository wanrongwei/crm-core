...
public class BOCmAccountBean extends DataContainer implements DataContainerInterface,IBOCmAccountValue{

  private static String  m_boName = "com.asiainfo.crm.cm.inner.account.bo.BOCmAccount";
  ...
  public BOCmAccountBean() throws AIException{
      super(S_TYPE);
  }
